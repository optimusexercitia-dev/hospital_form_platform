...
export function OrgAdminAssignForm({
  ...
  // `HospitalCreateForm` renders ABOVE this one on /admin and also uses the form key
  // `organizationId` — the collision behind BUG-A11Y-001, where this section's
  // "Organização" label pointed at the HOSPITAL form's select. The hand-written `id:`
