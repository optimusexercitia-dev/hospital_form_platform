...
/**
 * Error boundary for the sign-off queue. Friendly pt-BR message and a retry —
 * never the raw error. (`notFound()` from the page is handled by the 404
 * boundary, not here.)
 */
export default function SignoffQueueError({
  error,
  reset,
}: {
  ...
  return (
    <div className="mx-auto flex max-w-md flex-col items-center justify-center gap-5 py-24 text-center">
      ...
      <p className="text-muted-foreground text-pretty">
        Não foi possível carregar as assinaturas pendentes. Tente novamente em
        alguns instantes.
      </p>
