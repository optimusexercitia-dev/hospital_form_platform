...
export interface PersonFootprint {
   ...
   *
   * ⛔ THIS IS THE **WRITE** RULE, AND SINCE ADR 0145 IT NO LONGER MATCHES THE READ RULE.
   * The `profiles` / `professional_credentials` SELECT policies test affiliation as
   * EVER-HELD (the `ended_on` conjunct was removed in migration 20261003002200) so that
