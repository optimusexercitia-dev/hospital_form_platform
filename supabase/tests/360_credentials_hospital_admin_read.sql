...
--
-- ⛔ THE ASYMMETRY THIS HEADER USED TO DESCRIBE IS GONE — CORRECTED 2026-08-25, ADR 0148.
...
-- 20261003002900 removed the `ended_on` conjunct from this policy and from both `profiles`
...
-- reinstates the blank-Registro em-dash the widening exists to remove. ADR 0148 §3 changed
-- all three together for exactly that reason. The ever-held behaviour itself is covered by
-- `371_offboarded_person_visibility.sql`, not here.
--
