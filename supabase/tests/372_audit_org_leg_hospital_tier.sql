...
-- ADR 0149 (amends ADR 0051). Migration 20261003003000.
--
...
--
-- ⚠ AMENDED BY ADR 0150 / migration 20261003003100. The bound was right; the claim that
...
-- hospital-tier row never satisfied leg 5 in the first place. Test 373 owns the new half.
--
...
-- ===========================================================================
-- §1 ⭐ THE NEW BEHAVIOUR. Every arm here is RED before migration 20261003003000.
-- ===========================================================================
select test_helpers.claims_for('0ad00146-0000-0000-0000-0000000000a1');
set local role authenticated;
...
-- ⚠ 6.4 WAS `qual NOT LIKE '%hospital_id IS NULL%'` over the WHOLE predicate. ADR 0150 put
