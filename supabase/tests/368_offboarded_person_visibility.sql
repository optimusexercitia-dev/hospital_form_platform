...
-- to a hospital they administer. ADR 0145. Migration 20261003002200.
--
...
-- ===========================================================================
-- §1 ⭐ THE NEW BEHAVIOUR. Every arm here is RED before migration 20261003002200.
-- ===========================================================================
select test_helpers.claims_for('0aff3001-0000-0000-0000-0000000000a1');
set local role authenticated;
...
-- keystone. What ADR 0145 actually establishes is the bounded property below.
select is(
  (select count(*)::int
...
-- green BEFORE and AFTER migration 20261003002200. It proves that the widening added no
