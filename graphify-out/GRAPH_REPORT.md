...
## Corpus Check
- 1541 files · ~2,170,174 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 11198 nodes · 22533 edges · 1547 communities (645 shown, 902 thin omitted)
- Extraction: 100% EXTRACTED · 0% INFERRED · 0% AMBIGUOUS · INFERRED: 91 edges (avg confidence: 0.69)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `bfa49016`
...
## Communities (1547 total, 902 thin omitted)

### Community 0 - "Case Lifecycle Actions"
Cohesion: 0.09
Nodes (30): AssigneeOption, ActionItemRow(), ActionItemsPanel(), isItemOverdue(), STATUS_ORDER, formatDueDate(), ActionItemStatusBadge(), ACTION_ITEM_STATUS_LABEL (+22 more)
...
Cohesion: 0.08
Nodes (48): MyCapaActionControls(), ADR-0076, CapaActionCard(), CapaEvidenceLinkForm(), CapaEvidenceUpload(), CapaEvidenceList(), CancelButton(), ReopenButton() (+40 more)
...
Cohesion: 0.07
Nodes (42): metadata, ActionItemDetailPage(), cnDue(), describeSource(), metadata, metadata, SettingsIndexPage(), metadata (+34 more)
...
Cohesion: 0.06
Nodes (59): AssigneeAvatar(), AnalysisStage(), SubView, Tab(), Fishbone(), ProblemCard(), ProblemStage(), RcaMemberRoleBadge() (+51 more)

### Community 8 - "RCA Problem Stage"
Cohesion: 0.07
Nodes (33): ADR-0002, ManageMembersPage(), metadata, ADR-0061, metadata, MyResponsesPage(), metadata, OrgNspCoordinationPage() (+25 more)
...
Cohesion: 0.04
Nodes (79): react, AuditIntegrityCheck(), LevelOption(), CaseOutcomeSelector(), CaseStatusBadge(), TOKEN_COLOR_VAR, TOKEN_STYLES, CaseTabs() (+71 more)
...
Cohesion: 0.08
Nodes (38): ADR-0005, SectionConditionFields(), PhaseResultValue, RESULTS, TARGETS, CasePhaseModeRow, AnswerMap, answerMatchesValue() (+30 more)

### Community 13 - "NSP Event Pages"
Cohesion: 0.07
Nodes (43): CommissionEventsPage(), metadata, metadata, CapaClosurePanel(), CustodyHistory(), EventStatusChip(), OwnerChip(), STATUS_ICON (+35 more)

### Community 14 - "RCA Analysis Stage"
Cohesion: 0.11
Nodes (45): GET(), SUCCESS_REDIRECT, CatBlock(), CauseCard(), RootCauseTypePill(), CATEGORY_VISUAL, CLASSIFICATION_SELECTED, CLASSIFICATIONS (+37 more)

### Community 15 - "Case Department Field"
Cohesion: 0.12
Nodes (38): ConcludeNarrativeButton(), ADR-0033, ConfirmDeleteButton(), CoordinatorPhaseActions(), DetailPhase, ADR-0033, ADR-0061, ArchiveOutcomeButton() (+30 more)
...
Cohesion: 0.05
Nodes (80): AdminOrganizationsPage(), metadata, metadata, UpdatesSection(), CommissionEditForm(), StaffAdminManager(), LoginForm(), ResetRequestForm() (+72 more)
...
Cohesion: 0.04
Nodes (84): metadata, PhaseAnswersPage(), metadata, ADR-0038, ADR-0061, ADR-0078, GrantExpiry(), ACTIVE_OR_PENDING (+76 more)

### Community 24 - "Auth Callback & Meeting Settings"
Cohesion: 0.08
Nodes (73): LegacyMeetingsSettingsPage(), AgendaItemForm(), AgendaRow(), UploadDialog(), AttendeeRow(), MeetingLifecycleActions(), ActionState, AddAttendeeState (+65 more)

### Community 25 - "Referral Actions & Reply"
Cohesion: 0.12
Nodes (37): ReferralActions(), ComposerMode, ComposerModeKey, ReferralComposer(), ADR-0037, getReferralPatient(), acceptReferral(), addReferralReplyAttachment() (+29 more)
...
Cohesion: 0.11
Nodes (40): CancelCaseButton(), CasePhaseDelete(), CreateCaseDialog(), ActionState, activatePhase(), addAdHocPhase(), AddAdHocPhaseState, authorizeCommission() (+32 more)

### Community 28 - "Meeting Detail & Agenda"
Cohesion: 0.10
Nodes (17): formatDateTime(), metadata, resolveImageUrls(), SubmissionDetailPage(), CorrectSubmissionButton(), formatDateTime(), SectionBody(), SignoffMeta() (+9 more)

### Community 29 - "NSP CAPA/RCA Pages"
Cohesion: 0.14
Nodes (18): CHOICE_OPS, CHOICE_TARGET_TYPES, DraftRow, isChoiceTarget(), isGroup(), nextUid(), OP_LABELS, opsForType() (+10 more)

### Community 30 - "CAPA Evidence & Cards"
Cohesion: 0.05
Nodes (84): isOverdue(), localTodayYmd(), MyCapaActionsPage(), ADR-0076, CapaActionForm(), userLabel(), CapaActionsSection(), CapaActionStatusChip() (+76 more)

### Community 31 - "Case Narrative Editor"
Cohesion: 0.07
Nodes (45): metadata, ProcessTemplatesListPage(), ArchiveTemplateButton(), CreateProcessTemplateDialog(), NarrativeSlotCard(), ADR-0032, NarrativeSlotDialog(), PhaseBlocksEditor() (+37 more)

### Community 32 - "Form Item Editor & Tests"
Cohesion: 0.07
Nodes (38): DEPARTMENTS, CasePatientEditDialog(), CasePatientPanel(), ADR-0038, ADR-0078, TemplateOption, ADR-0038, OutcomeMultiselect() (+30 more)

### Community 33 - "Submission Detail Blocks"
Cohesion: 0.14
Nodes (21): metadata, resolveImageUrls(), ReviewAndSignPage(), ADR-0061, signoffRecordsToMap(), toClientResponseForSignoff(), toSectionSignoff(), ReviewAndSign() (+13 more)
...
Cohesion: 0.09
Nodes (24): HospitalAdminManager(), personLabel(), ADR-0051, NspOrgAdminManager(), personLabel(), ADR-0051, CoordinatorSection(), NspOrgHospitalCuration (+16 more)

### Community 39 - "Forms & Process Templates"
Cohesion: 0.06
Nodes (45): PendingApprovalsLayout(), metadata, OrgAdministratorsPage(), ADR-0051, ADR-0052, OrgCommissionDetailError(), HospitalDetailPage(), metadata (+37 more)

### Community 40 - "Derived Indicator Config"
Cohesion: 0.12
Nodes (25): metadata, ReferralDetailPage(), ADR-0078, formatDateTime(), formatFileSize(), referralTypeChipClass(), ADR-0037, LinkableTargetCase (+17 more)

### Community 41 - "Meeting Attendees & Quorum"
Cohesion: 0.08
Nodes (53): item(), BlockRenderer(), CHOICE_TYPES, computeEffectiveVisibility(), EffectiveVisibility, INPUT_ITEM_TYPES, INPUT_TYPES, isChoiceItem() (+45 more)
...
Cohesion: 0.07
Nodes (32): CommissionLayout(), ADR-0033, ADR-0061, ADR-0078, DocumentsLayout(), IndicatorsLayout(), metadata, MyPhasesPage() (+24 more)

### Community 44 - "Event Notification & Triage"
Cohesion: 0.24
Nodes (8): PhaseCorrectionMode, PhaseCorrectionOptions, resolvePhaseCorrectionOptions(), VOCAB, WizardData, CasePhaseForFill, ResolvedPhaseResultJson, ResolvedPhaseResult
...
### Community 48 - "Page"
Cohesion: 0.05
Nodes (51): BuilderPage(), metadata, resolveImageUrls(), DATE_FMT, metadata, resolveImageUrls(), VersionsPage(), FormCard() (+43 more)

### Community 49 - "IsTerminalMeetingStatus"
Cohesion: 0.06
Nodes (50): metadata, OrgOverviewPage(), CaseDetailMotion(), CHART_COLORS, CommissionOverview(), DashboardCharts(), groupBySection(), SectionEntry (+42 more)
...
Cohesion: 0.05
Nodes (84): PhaseResultBadge(), timelineResultToResolved(), AvatarStack(), CaseTimeline(), DAY_MONTH, DERIVED_PILL, durationSuffix(), formatEventDate() (+76 more)

### Community 52 - "Page"
Cohesion: 0.06
Nodes (68): EditDocumentPage(), metadata, DocumentDetailPage(), asDocStatus(), asDocType(), DOC_STATUSES, DOC_TYPES, DocumentsPage() (+60 more)

### Community 54 - "Section signoff fields"
Cohesion: 0.13
Nodes (24): NspEventDetailPage(), NspConsoleLayout(), ADR-0052, NspPatientsPage(), metadata, NspInboxPage(), ADR-0042, CapaClassificationChip() (+16 more)
...
Cohesion: 0.21
Nodes (13): ConfirmDeleteButton(), HeldWindowFields(), isFuture(), localToIso(), ADR-0062, useHeldWindowState(), ConfirmActionButton(), HeldTransitionButton() (+5 more)
...
### Community 68 - "Page"
Cohesion: 0.15
Nodes (22): NarrativeAssignMenu(), ADR-0032, ADR-0033, ADR-0033, DISPLAY_TYPES, INPUT_TYPES, BlockPreview(), formatScore() (+14 more)
...
### Community 74 - "Page"
Cohesion: 0.09
Nodes (29): deriveFlowMetrics(), metadata, NspReferralsDashboardPage(), ADR-0042, isPqsMemberSelf(), listAllReferrals(), listReferralTypes(), mapReferralListItem() (+21 more)
...
### Community 82 - "Route"
Cohesion: 0.08
Nodes (37): metadata, PhaseResponderPage(), metadata, ResponderPage(), FormsListPage(), metadata, PhaseAnswersReadonly(), DiscardDraftButton() (+29 more)
...
Cohesion: 0.13
Nodes (18): NarrativeTypeDialog(), ArchiveNarrativeTypeButton(), NarrativeTypeManager(), ADR-0032, useNarrativeAction(), AddBlockMenu(), BlockCard(), BlockList() (+10 more)
...
### Community 96 - "Page"
Cohesion: 0.08
Nodes (26): AttendeeInput, CaseMeetingLinkRow, AgendaRow, AttendanceStatus, AttendeeRole, AttendeeRow, CaseLinkRow, ClosedSession (+18 more)
...
Cohesion: 0.05
Nodes (87): metadata, roleFromCapabilities(), StaffCaseDetailPage(), ADR-0033, ADR-0061, NewCommissionEventPage(), SignoffQueuePage(), CaseDetailLayout() (+79 more)
...
Cohesion: 0.06
Nodes (48): metadata, MyCasesPage(), ADR-0033, OutcomeBreakdownRow, FilterChip(), hasOpenAssignment(), isOpenCase(), MyCasesFilter() (+40 more)
...
Cohesion: 0.13
Nodes (25): metadata, PrimeiroAcessoPage(), metadata, OrgDocumentsPage(), metadata, OrgIndicatorsPage(), APPOINT_MESSAGES, assignHospitalAdmin() (+17 more)
...
Cohesion: 0.06
Nodes (44): CaseActionItemForm(), PhaseOption, CaseActionItemsPanel(), STATUS_ORDER, ADR-0033, CaseReferralsModule, ADR-0032, ADR-0038 (+36 more)

### Community 151 - "Architecture Rules (binding)"
Cohesion: 0.12
Nodes (21): OpenAttachmentButton(), ADR-0063, CaseDocumentUpload(), CaseDocumentsPanel(), ADR-0033, ADR-0063, DOC_TYPE_LABEL, AttachmentLinkForm() (+13 more)
...
Cohesion: 0.14
Nodes (18): CaseOutboundReferralsCard(), formatCaseNumber(), formatDate(), formatReferralCode(), LinkCaseDialog(), ResponseExpectedChip(), ReferralDashboardTable(), RowGroup() (+10 more)
...
Cohesion: 0.14
Nodes (27): metadata, metadata, NewDocumentPage(), AddVersionForm(), ApprovalSignForm(), VersionWithUrl, ObsoleteDocumentButton(), PublishDocumentDialog() (+19 more)
...
Cohesion: 0.13
Nodes (20): MODALITY_LABEL, MODALITY_ORDER, SESSION_TYPE_LABEL, SESSION_TYPE_ORDER, SessionForm(), ADR-0070, toDateTimeLocalValue(), MeetingFormDialog() (+12 more)
...
Cohesion: 0.06
Nodes (52): metadata, OrgCommissionsPage(), ADR-0051, AREAS, ManageArea, metadata, OrgManageHomePage(), ADR-0051 (+44 more)
...
Cohesion: 0.09
Nodes (30): HospitalIndicatorScorecard(), IndicatorsPanelAsync(), IndicatorsPanel(), RunChart, RunChartLoader(), DerivedConfig, DerivedDenominatorRef, DerivedNumeratorRef (+22 more)
...
Cohesion: 0.10
Nodes (21): commissionInitials(), CommissionPickerPage(), metadata, ROLE_LABEL, slugifyHeading(), metadata, OrgPickerPage(), ADR-0051 (+13 more)
...
Cohesion: 0.03
Nodes (21): AuditLabelOption, ADR-0051, ADR-0033, PhaseResultOverrideDialog(), AddVersionAction, SupersedeAction, MarkdownRenderer(), Mode (+13 more)
...
Cohesion: 0.13
Nodes (18): AdminLayout(), ADR-0042, OrgAuditPage(), ENTITY_ICON, EntityIcon(), resolveEntityIcon(), AuditEntityType, AuditFilterActor (+10 more)
...
Cohesion: 0.10
Nodes (26): metadata, SubmissionsPage(), formatDateTime(), SubmissionRow(), SubmissionsFiltersAsync(), SupersessionBadgePill(), ADR-0074, ResponseStatus (+18 more)
...
Cohesion: 0.22
Nodes (13): metadata, metadata, metadata, ADR-0051, AuditEmptyState(), AuditFiltersAsync(), AuditCommissionOption, AuditFilters() (+5 more)
...
Cohesion: 0.09
Nodes (27): metadata, ADR-0061, SectionSignoffFields(), AnswerSummary(), formatIsoDate(), OptionChip(), renderValue(), RespondentSignoff() (+19 more)
...
Cohesion: 0.07
Nodes (42): ConditionBuilder(), CONDITION_TARGET_TYPES, isEligibleTarget(), newQuestionConditionTargets(), questionConditionTargets(), sectionConditionTargets(), toTarget(), DefaultCheckboxSet() (+34 more)
...
Cohesion: 0.08
Nodes (34): metadata, NspConfigPage(), ADR-0052, metadata, NspRosterPage(), ADR-0052, metadata, NspTriagePage() (+26 more)
...
Cohesion: 0.15
Nodes (16): IndicatorDetailPage(), metadata, ActionItemFallbackDialog(), CapaAffordance(), CreateManualAction, OpenCapaAction, isPqsOperatorOfIndicatorHospital(), ADR-0057 (+8 more)
...
Cohesion: 0.11
Nodes (21): referralStatusChipClass(), ReferralDirectionChip(), ReferralStatusChip(), STATUS_ICON, ADR-0037, AddReplyAttachmentInput, AddSharedItemInput, ConcludeReferralInput (+13 more)
...
Cohesion: 0.19
Nodes (19): ArchiveResultButton(), ResultVocabManager(), useResultAction(), archivePhaseResult(), authorizeCommission(), commissionOfCasePhase(), commissionOfResult(), createPhaseResult() (+11 more)
...
Cohesion: 0.04
Nodes (44): Appendix A — Polymorphism dialects (three sanctioned; closes hardening D12; ADR 0065), Appendix B — Catalog-vs-enum + freeze conventions (ADR 0065), ARCHITECTURE.md — Hospital Commission Forms Platform, Architecture Rules, ADR 0028 — Accreditation & Quality-Governance Roadmap (Phases 13–21), Consequences, Context, Decision (+36 more)
...
Cohesion: 0.14
Nodes (14): ADR-0025, AttendeeForm(), AttendeeMemberOption, AttendeesPanel(), QuorumSummary(), AttendanceBadge(), ATTENDEE_ROLE_LABEL, describeQuorumRule() (+6 more)
...
Cohesion: 0.21
Nodes (15): MeetingDetailPage(), metadata, ADR-0078, AgendaPanel(), isEditableStatus(), MeetingMinutesEditor(), getMeetingDetail(), getMeetingSettings() (+7 more)
...
Cohesion: 0.14
Nodes (5): 0069 — Anglicize status-enum internal keys (D11), Consequences, Context, Decision, S1 · Substrate — completed-track record (Pre-Pilot Release Scope Expansion, ADR 0071)
...
Cohesion: 0.13
Nodes (20): ADR-0032, ADR-0033, ADR-0038, ADR-0061, CaseAccessButton(), CaseLifecycleActions(), EditCaseMetaDialog(), NotifyEventDialog() (+12 more)
...
Cohesion: 0.02
Nodes (58): ═══════════════════════════════════════════════════════════════════════════, This is NOT the Next.js you know, ADR 0001 — Scaffolding & toolchain bootstrap, Consequences, Context, Decisions, ADR 0006 — Supabase API key scheme vs. env var naming, Consequences (+50 more)
...
Cohesion: 0.18
Nodes (11): CommissionReferralsPage(), metadata, ReferralsHubSections(), SortDir, SortHeader(), SortKey, STATUS_FILTER_ORDER, STATUS_LIFECYCLE_ORDER (+3 more)
...
Cohesion: 0.27
Nodes (8): TitleBadge(), ADR-0051, SignatureBadge(), SignButton(), RosterEntry, SignaturesPanel(), MeetingAttendee, MeetingSignature
...
- **Why does `createClient()` connect `RCA Analysis Stage` to `Case Lifecycle Actions`, `Shared UI & Phase Dialogs`, `Loading`, `3.8 `forms.form_block_default_values``, `Phase Answers & Assignments`, `3.17 `forms.form_matrix_rows``, `Triage Disposition & Pathways`, `RCA Problem Stage`, `Form Builder Actions`, `Error & Not-Found Boundaries`, `Meeting form dialog.test`, `NSP Event Pages`, `Page`, `Quality Indicators`, `NSP Patient Registry`, `Titles`, `Architecture Rules (binding)`, `My Cases List`, `Auth Callback & Meeting Settings`, `ADR 0038 — Case patient identifiers (`case_patient`, the third PHI module)`, `Case & Phase Actions`, `Referral Actions & Reply`, `Meeting Detail & Agenda`, `CAPA Evidence & Cards`, `Case Narrative Editor`, `Submission Detail Blocks`, `Phase Responder & Submissions`, `Case Narrative Cards`, `Phase Result Actions`, `loading.tsx`, `Lead Playbook — orchestration protocol (lead only)`, `Interview & Agenda Forms`, `Forms & Process Templates`, `Derived Indicator Config`, `Narrative Templates`, `ADR 0018 — Custom SQLSTATE class `HC0xx` (was `P00xx`)`, `Page`, `IsTerminalMeetingStatus`, `Page`, `0070 — Interview data-model v2: sessions + reporting / confidentiality columns`, `Page`, `0066 — patient_xref case-module grain re-keyed to the patient participant`, `ADR 0008 — GSAP as the animation dependency`, `27. Example: Simple Action Item`, `Condition builder`, `VersionWithUrl`, `case-narratives.spec.ts`, `ADR 0041 — Multi-Tenancy: organizations + hospitals above commissions`, `ADR 0030 — Patient-Safety PHI Posture Reversal & PQS/NSP Module Architecture (Phase 14)`, `AttachmentLinkForm`, `Wizard runner`, `Page`, `AuditFeed`, `Avatar stack`, `ActionItemRow`, `Route`, `CaseActionItemsPanel`, `Audit icon`, `Page`, `Page`, `Referral patient fields`, `0012 — clone_form_version returns the existing draft (one draft per form)`, `QA Review — Option A: Shared (non-PHI) `action_items` table`, `Page`, `DepartmentDefDialog`, `Answer-Model v2 + form-definition forward-compat — phase record (✅ COMPLETE 2026-07-01)`, `Loading`, `Phase 17 — Controlled-Document Lifecycle (Gestão de Documentos Controlados)`, `Loading`, `Page`, `Format`, `Loading`, `ADR 0028`?**
  _High betweenness centrality (0.054) - this node is a cross-community bridge._
- **Why does `Page` connect `Staff Case Detail` to `phase22-referrals.spec.ts`, `phase8-dashboard.spec.ts`, `Loading`, `phase14b-triage.spec.ts`, `Page`, `recommend-result.spec.ts`, `OrgAuditPage`, `Admin Layout & Claims`, `loading.tsx`, `phase7-cases.spec.ts`, `loading.tsx`, `cases-outcomes-blockers.spec.ts`, `nsp-per-hospital.spec.ts`, `phase14c-rca.spec.ts`, `case-phase-result.spec.ts`, `form-model-normalization.spec.ts`, `phase14d-capa.spec.ts`, `phase15-indicators.spec.ts`, `phi-remediation.spec.ts`, `0070 — Interview data-model v2: sessions + reporting / confidentiality columns`, `0066 — patient_xref case-module grain re-keyed to the patient participant`, `Interview badges`, `Phase B — NSP-per-hospital + `nsp_org_admin` — completed phase record`, `Event type manager`, `form-builder-enhancements.spec.ts`, `Page`, `mem-memberships-collapse.spec.ts`, `Case document delete`, `Result-based phase recommendation — `recommend_when` answer/result groups (✅ COMPLETE 2026-06-26)`, `Page`, `loading.tsx`, `ad-hoc-narratives.spec.ts`, `administrativo.spec.ts`, `member-action-items-overview.spec.ts`, `phase13-audit.spec.ts`, `DepartmentDefDialog`, `loading.tsx`, `ADR 0018 — Custom SQLSTATE class `HC0xx` (was `P00xx`)`, `Page`, `Answer-Model v2 + form-definition forward-compat — phase record (✅ COMPLETE 2026-07-01)`, `Loading`, `Phase 17 — Controlled-Document Lifecycle · QA Review`, `case-patient.spec.ts`, `cases-extras.spec.ts`, `patient-index.spec.ts`, `phase14a-safety-events.spec.ts`?**
  _High betweenness centrality (0.050) - this node is a cross-community bridge._
- **Why does `cn()` connect `Submission Detail (Answer Model)` to `Case Lifecycle Actions`, `Admin & Auth Pages`, `Shared UI & Phase Dialogs`, `3.17 `forms.form_matrix_rows``, `3.8 `forms.form_block_default_values``, `Phase Answers & Assignments`, `Error & Not-Found Boundaries`, `Case Documents`, `Triage Disposition & Pathways`, `Meeting form dialog.test`, `NSP Event Pages`, `RCA Analysis Stage`, `Case Department Field`, `Referral Detail & Formatting`, `Phase 23 — Patient Identity & Cross-Committee Linkage (`patient_index`)`, `QA Review — Phase B: NSP-per-hospital + `nsp_org_admin``, `Quality Indicators`, `Titles`, `My Cases List`, `Architecture Rules (binding)`, `NSP Referrals Dashboard`, `markdown-renderer.tsx`, `0068 — Case-phase result engine: jsonb/array → FK-backed junctions (D3)`, `CAPA Evidence & Cards`, `ADR 0005 — `visible_when` condition shape (v1)`, `Form Item Editor & Tests`, `Case Narrative Editor`, `Forms & Process Templates`, `Derived Indicator Config`, `PHASES.md — Hospital Commission Forms Platform`, `IsTerminalMeetingStatus`, `Page`, `UserLifecycleActions`, `Page`, `Page`, `Phase result options`, `ADR 0008 — GSAP as the animation dependency`, `27. Example: Simple Action Item`, `Section signoff fields`, `4.3 `form_responses.form_answer_options``, `Page`, `CaseActionItemForm`, `add-block-menu.tsx`, `Page`, `CaseActionItemsPanel`, `"Sem processo" — process-less case creation (`processless_cases`)`, `Referral patient fields`, `0012 — clone_form_version returns the existing draft (one draft per form)`, `DepartmentDefDialog`, `Loading`, `Answer-Model v2 + form-definition forward-compat — phase record (✅ COMPLETE 2026-07-01)`, `Audit feed`, `Loading`, `Phase 17 — Controlled-Document Lifecycle (Gestão de Documentos Controlados)`, `Page`, `Loading`, `ADR 0028`?**
...
- **Should `Admin & Auth Pages` be split into smaller, more focused modules?**
  _Cohesion score 0.06576141847155201 - nodes in this community are weakly interconnected._
