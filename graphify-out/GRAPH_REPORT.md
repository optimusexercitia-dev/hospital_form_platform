...
## Corpus Check
- 1543 files · ~2,173,315 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 11201 nodes · 22552 edges · 1537 communities (630 shown, 907 thin omitted)
- Extraction: 100% EXTRACTED · 0% INFERRED · 0% AMBIGUOUS · INFERRED: 91 edges (avg confidence: 0.69)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `8b8e68d5`
...
## Communities (1537 total, 907 thin omitted)

### Community 0 - "Case Lifecycle Actions"
Cohesion: 0.09
Nodes (31): ActionItemStatusBadge(), ACTION_ITEM_STATUS_LABEL, ACTION_ITEM_STATUS_STYLE, ATTACHMENT_KIND_ORDER, ATTENDANCE_LABEL, ATTENDANCE_ORDER, ATTENDANCE_STYLE, ATTENDEE_ROLE_ORDER (+23 more)
...
Cohesion: 0.05
Nodes (66): ActionItemDetailPage(), cnDue(), describeSource(), metadata, ActionItemSourceBadge(), ActionItemStatusBadge(), SOURCE_META, STATUS_META (+58 more)

### Community 3 - "Error & Not-Found Boundaries"
Cohesion: 0.17
Nodes (28): MyCapaActionControls(), ADR-0076, CapaActionCard(), addCapaAction(), addCapaActionEvidence(), addCapaActionTask(), addCapaMeasure(), advanceCapaAction() (+20 more)
...
Cohesion: 0.12
Nodes (24): CancelButton(), ReopenButton(), AnalysisStage(), SubView, Tab(), CatBlock(), CauseCard(), Fishbone() (+16 more)
...
Cohesion: 0.06
Nodes (47): ProblemCard(), ProblemStage(), RcaMemberRoleBadge(), RootCauseTypePill(), STATUS_CLASS, EvidenceCitationForm(), EvidenceLinkForm(), EvidenceUpload() (+39 more)

### Community 8 - "RCA Problem Stage"
Cohesion: 0.09
Nodes (25): ManageMembersPage(), metadata, ADR-0061, CaseOutcomesSettingsPage(), metadata, metadata, metadata, TitlesSettingsPage() (+17 more)
...
Cohesion: 0.05
Nodes (69): ChecklistItem(), ChecklistSection(), REMINDER_TYPE_ORDER, SatelliteConfirmDelete(), SatelliteEmpty(), SatelliteSection(), UpdatesSection(), useSatelliteAction() (+61 more)
...
Cohesion: 0.07
Nodes (46): ADR-0005, ConditionRow(), condToRow(), DraftRow, emptyRow(), initialToRows(), isLegacySingle(), nextUid() (+38 more)

### Community 13 - "NSP Event Pages"
Cohesion: 0.06
Nodes (60): metadata, NspEventDetailPage(), metadata, ADR-0042, CapaClosurePanel(), CapaEffectivenessPanel(), CustodyHistory(), EventStatusChip() (+52 more)
...
Cohesion: 0.15
Nodes (30): ADR-0033, ObsoleteAction, ConfirmDeleteButton(), ConfirmActionButton(), ADR-0070, SessionConfirmButton(), ADR-0070, useInterviewAction() (+22 more)
...
Cohesion: 0.09
Nodes (46): AssigneeAvatar(), activePhases(), blockedBy(), BoardPhase, CaseStatusColumn, currentPhase(), groupByFixedStatus(), hasRecommendedPending() (+38 more)

### Community 24 - "Auth Callback & Meeting Settings"
Cohesion: 0.12
Nodes (58): GET(), SUCCESS_REDIRECT, LegacyMeetingsSettingsPage(), ActionItemRow(), UploadDialog(), addMeetingAttendee(), addReservedItem(), advanceMeetingActionItem() (+50 more)

### Community 25 - "Referral Actions & Reply"
Cohesion: 0.09
Nodes (47): formatCaseNumber(), LinkableTargetCase, LinkCaseDialog(), ReferralActions(), ComposerMode, ComposerModeKey, ReferralComposer(), ADR-0037 (+39 more)

### Community 26 - "NSP Referrals Dashboard"
Cohesion: 0.10
Nodes (32): CaseReferralsModule, ADR-0032, ADR-0038, ADR-0061, CaseOfferedOutcomesEditor(), CasePatientPanel(), CaseOutboundReferralsCard(), EMPTY_REFERRAL_PATIENT_DRAFT (+24 more)

### Community 27 - "Case & Phase Actions"
Cohesion: 0.14
Nodes (35): CancelCaseButton(), CreateCaseDialog(), ActionState, activatePhase(), addAdHocPhase(), AddAdHocPhaseState, authorizeCommission(), cancelCase() (+27 more)

### Community 28 - "Meeting Detail & Agenda"
Cohesion: 0.07
Nodes (37): formatDateTime(), SectionBody(), SignoffMeta(), SubmissionDetailView(), ImageItemEditor(), ImagePreview(), ITEM_TYPE_META, ItemTypeMeta (+29 more)
...
Cohesion: 0.07
Nodes (50): isOverdue(), localTodayYmd(), MyCapaActionsPage(), ADR-0076, CapaActionStatusChip(), CapaSourceBadge(), CapaStrengthPill(), STATUS_ICON (+42 more)

### Community 31 - "Case Narrative Editor"
Cohesion: 0.11
Nodes (21): PhaseResultValue, RESULTS, TARGETS, AnswerRecord, WizardData, RecommendRule, ResultRuleset, ConditionTargetOption (+13 more)

### Community 32 - "Form Item Editor & Tests"
Cohesion: 0.08
Nodes (29): DEPARTMENTS, CasePatientEditDialog(), ADR-0038, ADR-0078, TemplateOption, ADR-0038, OutcomeMultiselect(), casePatientToDraft() (+21 more)

### Community 33 - "Submission Detail Blocks"
Cohesion: 0.12
Nodes (23): metadata, resolveImageUrls(), ReviewAndSignPage(), ADR-0061, inputItem(), response(), section(), tree() (+15 more)
...
Cohesion: 0.12
Nodes (20): HospitalAdminManager(), personLabel(), ADR-0051, CoordinatorSection(), NspOrgHospitalCuration, personLabel(), RosterSection(), ADR-0052 (+12 more)

### Community 39 - "Forms & Process Templates"
Cohesion: 0.05
Nodes (74): metadata, PrimeiroAcessoPage(), metadata, OrgAdministratorsPage(), ADR-0051, ADR-0052, OrgCommissionDetailError(), metadata (+66 more)

### Community 40 - "Derived Indicator Config"
Cohesion: 0.14
Nodes (22): metadata, ReferralDetailPage(), ADR-0078, formatDateTime(), formatFileSize(), ADR-0037, ReferralMessageTypeChip(), ReferralDisposeDialog() (+14 more)

### Community 41 - "Meeting Attendees & Quorum"
Cohesion: 0.08
Nodes (43): item(), SectionConditionBadge(), BlockRenderer(), CHOICE_TYPES, computeEffectiveVisibility(), EffectiveVisibility, INPUT_ITEM_TYPES, INPUT_TYPES (+35 more)
...
Cohesion: 0.05
Nodes (50): AccountLayout(), ADR-0076, CommissionLayout(), ADR-0033, ADR-0061, ADR-0078, DocumentsLayout(), IndicatorsLayout() (+42 more)

### Community 44 - "Event Notification & Triage"
Cohesion: 0.10
Nodes (17): FLAGGED_OPS, FlaggedWhenEditor(), OP_LABELS, CheckboxGroup(), ChoiceGroup(), DateTimeItem(), DropdownItem(), formatBoundsHint() (+9 more)
...
### Community 47 - "Layout"
Cohesion: 0.05
Nodes (60): metadata, metadata, PasswordSetForm(), UserLifecycleActions(), ActionState, appOrigin(), assignStaffAdmin(), authorizeStaffAdminOps() (+52 more)
...
### Community 50 - "Page"
Cohesion: 0.07
Nodes (36): NotificationPreferencesPage(), ADR-0076, NotificationBellClient(), ADR-0076, NotificationPreferencesForm(), ORDER, SURFACE_COPY, ADR-0076 (+28 more)

### Community 51 - "UserLifecycleActions"
Cohesion: 0.05
Nodes (83): CaseTimelinePage(), metadata, PhaseResultBadge(), timelineResultToResolved(), AvatarStack(), CaseTimeline(), DAY_MONTH, DERIVED_PILL (+75 more)

### Community 52 - "Page"
Cohesion: 0.05
Nodes (87): EditDocumentPage(), metadata, DocumentDetailPage(), metadata, asDocStatus(), asDocType(), DOC_STATUSES, DOC_TYPES (+79 more)

### Community 54 - "Section signoff fields"
Cohesion: 0.08
Nodes (46): CapaActionsSection(), CapaClassificationChip(), CapaStatusChip(), activePdcaStage(), allActionsSettled(), allMeasuresHaveResults(), canAdvanceAction(), concludeGate (+38 more)
...
Cohesion: 0.17
Nodes (20): RcaStatusChip(), countDone(), deriveDone(), deriveKeyFactors(), groupFactorsByCategory(), RCA_STAGE_META, RCA_STAGE_ORDER, rcaCanEdit() (+12 more)
...
### Community 60 - "Page"
Cohesion: 0.10
Nodes (22): CasesBoardPage(), metadata, ADR-0038, ADR-0061, ADR-0078, StatCount(), ACTIVE_OR_PENDING, CaseKpis (+14 more)

### Community 61 - "CaseActionItemForm"
Cohesion: 0.08
Nodes (34): MeetingsListPage(), metadata, ADR-0061, ADR-0078, CaseMeetingsPanel(), TitleBadge(), ADR-0051, SessionRow() (+26 more)

### Community 62 - "VersionWithUrl"
Cohesion: 0.06
Nodes (59): AdminAuditPage(), metadata, AdminLayout(), ADR-0042, csvField(), GET(), toCsv(), ADR-0020 (+51 more)
...
Cohesion: 0.09
Nodes (21): activatePhase(), createCase(), insertChoiceOptions(), rpc(), saveAnswer(), signInAs(), slug(), startResponse() (+13 more)

### Community 68 - "Page"
Cohesion: 0.09
Nodes (41): NarrativeAssignMenu(), ADR-0032, ADR-0033, CaseTagsPanel(), ADR-0033, AddBlockMenu(), DISPLAY_TYPES, INPUT_TYPES (+33 more)
...
Cohesion: 0.15
Nodes (24): saveAndExit, saveSection, signSection, submitCasePhaseResponse, submitResponse, WizardRunner(), ActionState, authorizeMember() (+16 more)
...
### Community 74 - "Page"
Cohesion: 0.09
Nodes (34): CommissionReferralsPage(), metadata, deriveFlowMetrics(), metadata, NspReferralsDashboardPage(), ADR-0042, buildCaseReferralsModule(), NOTE: the safety-event PHI pre-fill is intentionally NOT assembled here — the (+26 more)
...
### Community 82 - "Route"
Cohesion: 0.04
Nodes (69): metadata, PhaseResponderPage(), SubmissionsPage(), metadata, NewCommissionEventPage(), CommissionEventsPage(), metadata, metadata (+61 more)

### Community 83 - "ActionItemRow"
Cohesion: 0.06
Nodes (39): metadata, OrgNspCoordinationPage(), ADR-0052, metadata, OrgNspCoordinatorsPage(), OrgNspAdminLayout(), ADR-0052, metadata (+31 more)
...
Cohesion: 0.12
Nodes (19): TitleDefDialog(), DeleteTitleButton(), TitlesManager(), ADR-0051, ADR-0051, useTitleAction(), BlockCard(), BlockPreview() (+11 more)
...
### Community 93 - "Page"
Cohesion: 0.05
Nodes (53): metadata, NarrativeEditorPage(), ADR-0033, CaseNarrativesBuilderPage(), metadata, ADR-0032, metadata, ProcessTemplateBuilderPage() (+45 more)
...
### Community 96 - "Page"
Cohesion: 0.07
Nodes (43): MeetingsSettingsTabPage(), metadata, MeetingDetailPage(), metadata, ADR-0078, ActionItemsPanel(), MeetingMinutesEditor(), MeetingSettingsView() (+35 more)
...
Cohesion: 0.07
Nodes (62): metadata, roleFromCapabilities(), StaffCaseDetailPage(), ADR-0033, ADR-0061, CaseDetailLayout(), ADR-0032, ADR-0033 (+54 more)
...
### Community 105 - "Page"
Cohesion: 0.21
Nodes (24): PhaseSlotCard(), ADR-0032, useBuilderAction(), ActionState, AddPhaseState, addTemplatePhase(), archiveProcessTemplate(), authorizeCommission() (+16 more)
...
Cohesion: 0.04
Nodes (68): metadata, MyCasesPage(), ADR-0033, OutcomeBreakdownRow, CaseRoleChip(), ROLE_META, ADR-0033, CaseStatusBadgeFixed() (+60 more)
...
Cohesion: 0.08
Nodes (36): ConfirmRemoveButton(), TitleAssignControl(), ADR-0051, CAPABILITIES, MemberAdministrativoControls(), ADR-0061, MemberList(), ADR-0051 (+28 more)
...
Cohesion: 0.09
Nodes (38): GrantExpiry(), CaseDocumentDelete(), CaseDocumentUpload(), UploadDialog(), CaseDocumentsPanel(), ADR-0033, ADR-0063, CaseEventForm() (+30 more)
...
### Community 158 - "Page"
Cohesion: 0.14
Nodes (15): formatDate(), ReferralPatientPanel(), ADR-0039, SafetyEventPrefill, CaseSafetyPrefill, AddSharedItemInput, ProvideReferralInfoInput, REFERRAL_PATIENT_SEX_LABELS (+7 more)
...
Cohesion: 0.07
Nodes (34): metadata, metadata, OrgUsersPage(), ADR-0051, ADR-0051, ADR-0052, UserDirectoryList(), UserDirectorySearch() (+26 more)
...
Cohesion: 0.10
Nodes (25): ADR-0002, commissionInitials(), CommissionPickerPage(), metadata, ROLE_LABEL, slugifyHeading(), metadata, OrgPickerPage() (+17 more)
...
Cohesion: 0.03
Nodes (30): react, AuditLabelOption, ADR-0051, AuditIntegrityCheck(), ADR-0051, ADR-0033, PhaseResultOverrideDialog(), DOC_STATUSES (+22 more)
...
Cohesion: 0.09
Nodes (42): OpenAttachmentButton(), ADR-0063, AttachmentsPanel(), AttachmentUpload(), AttachmentsPanel(), ADR-0063, formatDate(), ATTACHMENT_KIND_LABEL (+34 more)
...
Cohesion: 0.20
Nodes (10): ConcludeNarrativeButton(), ConfirmDeleteButton(), CoordinatorPhaseActions(), DetailPhase, ADR-0033, ADR-0061, ArchiveOutcomeButton(), OutcomeManager() (+2 more)
...
Cohesion: 0.06
Nodes (49): metadata, formatDateTime(), metadata, resolveImageUrls(), SubmissionDetailPage(), CorrectSubmissionButton(), formatDateTime(), SubmissionRow() (+41 more)
...
Cohesion: 0.16
Nodes (15): SectionSignoffFields(), formatDate(), RespondentContext(), ReviewAndSign(), ADR-0061, SignSectionPanel(), DATE_FMT, formatSignedAt() (+7 more)
...
Cohesion: 0.10
Nodes (30): metadata, NspConfigPage(), ADR-0052, metadata, NspRosterPage(), ADR-0052, NspConsoleLayout(), ADR-0052 (+22 more)

### Community 439 - "ADR 0008 — GSAP as the animation dependency"
Cohesion: 0.09
Nodes (39): metadata, MyActionItemsPage(), CaseActionItemForm(), PhaseOption, ActionItemRow(), CaseActionItemsPanel(), isItemOverdue(), STATUS_ORDER (+31 more)
...
Cohesion: 0.16
Nodes (15): IndicatorDetailPage(), metadata, isPqsOperatorOfIndicatorHospital(), ADR-0057, RunChart, RunChartLoader(), INDICATOR_DIRECTION_LABELS, INDICATOR_FREQUENCY_LABELS (+7 more)
...
Cohesion: 0.11
Nodes (24): formatReferralCode(), referralStatusChipClass(), referralTypeChipClass(), ReferralDirectionChip(), ReferralStatusChip(), ReferralTypeChip(), ResponseExpectedChip(), STATUS_ICON (+16 more)
...
Cohesion: 0.27
Nodes (7): NarrativeTypeDialog(), ArchiveNarrativeTypeButton(), NarrativeTypeManager(), ADR-0032, useNarrativeAction(), attachTargets(), TemplateBuilderShell()
...
Cohesion: 0.21
Nodes (16): ActionState, declareConflict(), DeclareConflictState, liftRecusal(), mapCoordinatorError(), MESSAGES, recordRecusal(), RecordRecusalState (+8 more)
...
Cohesion: 0.14
Nodes (13): ADR 0041 — Multi-Tenancy: organizations + hospitals above commissions, Alternatives rejected, Consequences, Context, Decision, Implementation amendments (2026-06-25), ADRs, Data-access & action modules (+5 more)
...
Cohesion: 0.08
Nodes (7): ═══════════════════════════════════════════════════════════════════════════, Archive — Decisions (full verbose form), Deferred / Parked Backlog — full detail, S1 · Substrate — completed-track record (Pre-Pilot Release Scope Expansion, ADR 0071), ADR 0078 — Gate 2 (Stage C · F1 · N1) — QA Review, Re-review (2026-07-17) — VERDICT: ✅ **APPROVED**, VERDICT: ⛔ **CHANGES REQUESTED** → **superseded by the Re-review (2026-07-17) below: ✅ APPROVED**
...
Cohesion: 0.06
Nodes (24): ADR 0001 — Scaffolding & toolchain bootstrap, Consequences, Context, Decisions, ADR 0006 — Supabase API key scheme vs. env var naming, Consequences, Context, Decision (+16 more)
...
## Knowledge Gaps
- **5535 isolated node(s):** `semi`, `singleQuote`, `trailingComma`, `plugins`, `$schema` (+5530 more)
...
- **Why does `createClient()` connect `Auth Callback & Meeting Settings` to `Case Lifecycle Actions`, `Shared UI & Phase Dialogs`, `Loading`, `3.17 `forms.form_matrix_rows``, `Error & Not-Found Boundaries`, `Triage Disposition & Pathways`, `Case Documents`, `RCA Problem Stage`, `Form Builder Actions`, `Submission Detail (Answer Model)`, `Meeting form dialog.test`, `NSP Event Pages`, `RCA Analysis Stage`, `Page`, `Quality Indicators`, `NSP Patient Registry`, `Titles`, `Referral Actions & Reply`, `NSP Referrals Dashboard`, `Case & Phase Actions`, `Meeting Detail & Agenda`, `markdown-renderer.tsx`, `CAPA Evidence & Cards`, `Case Narrative Editor`, `Form Item Editor & Tests`, `Submission Detail Blocks`, `Phase Responder & Submissions`, `Case Narrative Cards`, `Phase Result Actions`, `Lead Playbook — orchestration protocol (lead only)`, `Forms & Process Templates`, `Interview & Agenda Forms`, `Derived Indicator Config`, `Narrative Templates`, `ADR 0018 — Custom SQLSTATE class `HC0xx` (was `P00xx`)`, `Layout`, `Page`, `IsTerminalMeetingStatus`, `Page`, `Page`, `ADR 0003 — pgTAP for database tests`, `0066 — patient_xref case-module grain re-keyed to the patient participant`, `ADR 0008 — GSAP as the animation dependency`, `Page`, `CaseActionItemForm`, `VersionWithUrl`, `case-narratives.spec.ts`, `loading.tsx`, `ADR 0041 — Multi-Tenancy: organizations + hospitals above commissions`, `Page`, `Wizard runner`, `Page`, `Phase 14b–14d — Patient-Safety / NSP: Triage, RCA & CAPA`, `Avatar stack`, `ActionItemRow`, `Route`, `CaseActionItemsPanel`, `Result-based phase recommendation — `recommend_when` answer/result groups (✅ COMPLETE 2026-06-26)`, `Audit icon`, `Page`, `Page`, `Referral patient fields`, `0012 — clone_form_version returns the existing draft (one draft per form)`, `Page`, `DepartmentDefDialog`, `Answer-Model v2 + form-definition forward-compat — phase record (✅ COMPLETE 2026-07-01)`, `Loading`, `Loading`, `Page`, `ConfirmDeleteButton`, `ADR 0028`?**
  _High betweenness centrality (0.064) - this node is a cross-community bridge._
- **Why does `Page` connect `Staff Case Detail` to `phase22-referrals.spec.ts`, `phase8-dashboard.spec.ts`, `Loading`, `phase14b-triage.spec.ts`, `Page`, `recommend-result.spec.ts`, `OrgAuditPage`, `Admin Layout & Claims`, `loading.tsx`, `phase7-cases.spec.ts`, `loading.tsx`, `cases-outcomes-blockers.spec.ts`, `nsp-per-hospital.spec.ts`, `phase14c-rca.spec.ts`, `case-phase-result.spec.ts`, `form-model-normalization.spec.ts`, `phase14d-capa.spec.ts`, `phase15-indicators.spec.ts`, `phi-remediation.spec.ts`, `Interview badges`, `Phase B — NSP-per-hospital + `nsp_org_admin` — completed phase record`, `Event type manager`, `form-builder-enhancements.spec.ts`, `Page`, `mem-memberships-collapse.spec.ts`, `ActionItemRow`, `Case document delete`, `Page`, `loading.tsx`, `ad-hoc-narratives.spec.ts`, `administrativo.spec.ts`, `member-action-items-overview.spec.ts`, `phase13-audit.spec.ts`, `DepartmentDefDialog`, `loading.tsx`, `ADR 0018 — Custom SQLSTATE class `HC0xx` (was `P00xx`)`, `Page`, `Answer-Model v2 + form-definition forward-compat — phase record (✅ COMPLETE 2026-07-01)`, `Loading`, `Phase 17 — Controlled-Document Lifecycle · QA Review`, `case-patient.spec.ts`, `cases-extras.spec.ts`, `patient-index.spec.ts`, `phase14a-safety-events.spec.ts`?**
  _High betweenness centrality (0.051) - this node is a cross-community bridge._
- **Why does `cn()` connect `Submission Detail (Answer Model)` to `Case Lifecycle Actions`, `Admin & Auth Pages`, `Shared UI & Phase Dialogs`, `3.17 `forms.form_matrix_rows``, `Phase Answers & Assignments`, `Triage Disposition & Pathways`, `Case Documents`, `RCA Problem Stage`, `Meeting form dialog.test`, `NSP Event Pages`, `Case Department Field`, `Referral Detail & Formatting`, `Phase 23 — Patient Identity & Cross-Committee Linkage (`patient_index`)`, `QA Review — Phase B: NSP-per-hospital + `nsp_org_admin``, `Quality Indicators`, `Titles`, `My Cases List`, `Auth Callback & Meeting Settings`, `NSP Referrals Dashboard`, `0068 — Case-phase result engine: jsonb/array → FK-backed junctions (D3)`, `Meeting Detail & Agenda`, `CAPA Evidence & Cards`, `ADR 0005 — `visible_when` condition shape (v1)`, `Form Item Editor & Tests`, `loading.tsx`, `Derived Indicator Config`, `Narrative Templates`, `Event Notification & Triage`, `PHASES.md — Hospital Commission Forms Platform`, `Page`, `Page`, `UserLifecycleActions`, `Page`, `Page`, `Section signoff fields`, `ADR 0008 — GSAP as the animation dependency`, `4.3 `form_responses.form_answer_options``, `0066 — patient_xref case-module grain re-keyed to the patient participant`, `Condition builder`, `Page`, `CaseActionItemForm`, `Page`, `AuditFeed`, `Route`, `ActionItemRow`, `CaseActionItemsPanel`, `"Sem processo" — process-less case creation (`processless_cases`)`, `Page`, `Referral patient fields`, `0012 — clone_form_version returns the existing draft (one draft per form)`, `QA Review — Option A: Shared (non-PHI) `action_items` table`, `Outcomes actions`, `DepartmentDefDialog`, `Loading`, `Answer-Model v2 + form-definition forward-compat — phase record (✅ COMPLETE 2026-07-01)`, `Loading`, `Page`, `Format`?**
  _High betweenness centrality (0.024) - this node is a cross-community bridge._
- **What connects `semi`, `singleQuote`, `trailingComma` to the rest of the system?**
  _5693 weakly-connected nodes found - possible documentation gaps or missing edges._
...
- **Should `Admin & Auth Pages` be split into smaller, more focused modules?**
  _Cohesion score 0.06632252272472225 - nodes in this community are weakly interconnected._
