...
## Corpus Check
- 1360 files · ~1,777,081 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 9879 nodes · 20507 edges · 1490 communities (601 shown, 889 thin omitted)
- Extraction: 100% EXTRACTED · 0% INFERRED · 0% AMBIGUOUS · INFERRED: 90 edges (avg confidence: 0.69)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `37410035`
...
## Communities (1490 total, 889 thin omitted)

### Community 0 - "Case Lifecycle Actions"
Cohesion: 0.06
Nodes (78): CancelCaseButton(), ConcludeNarrativeButton(), ADR-0033, ConfirmDeleteButton(), DetailPhase, ADR-0033, ADR-0061, NarrativeTypeDialog() (+70 more)

### Community 1 - "Admin & Auth Pages"
Cohesion: 0.05
Nodes (80): AdminOrganizationsPage(), metadata, metadata, CommissionEditForm(), ConfirmRemoveButton(), StaffAdminManager(), LoginForm(), ResetRequestForm() (+72 more)

### Community 2 - "Shared UI & Phase Dialogs"
Cohesion: 0.08
Nodes (63): BannerTone, FormBanner(), toneStyles, ActivatePhaseDialog(), defaultDueDateValue(), AddAdHocNarrativeDialog(), AddAdHocPhaseDialog(), ACCEPT (+55 more)

### Community 3 - "Error & Not-Found Boundaries"
Cohesion: 0.03
Nodes (11): ADR-0033, PhaseResultOverrideDialog(), MarkdownRenderer(), Mode, ModeTab(), SectionTextEditor(), CapaVerdictChip(), GateRow() (+3 more)
...
Cohesion: 0.07
Nodes (43): metadata, NarrativeEditorPage(), ADR-0033, metadata, PhaseAnswersPage(), GrantExpiry(), CaseEventForm(), CaseEventsTimeline() (+35 more)

### Community 6 - "Triage Disposition & Pathways"
Cohesion: 0.07
Nodes (59): DispositionRail(), NON_RCA_PATHWAYS, Pill(), HARM_DEFINITIONS, HarmScale(), ChoiceCard(), CLOSURE_DESCRIPTIONS, CLOSURE_ORDER (+51 more)

### Community 7 - "Case Documents"
Cohesion: 0.11
Nodes (31): AssigneeAvatar(), AnalysisStage(), SubView, Tab(), Fishbone(), RcaMemberRoleBadge(), countDone(), deriveDone() (+23 more)

### Community 8 - "RCA Problem Stage"
Cohesion: 0.12
Nodes (19): CaseNarrativesBuilderPage(), metadata, ADR-0032, CasePhaseList(), ConstrutorTabs(), mergeTemplateLayout(), CaseLayoutItem, CaseNarrativeTypeRow (+11 more)
...
Cohesion: 0.07
Nodes (52): metadata, metadata, ADR-0042, CapaClosurePanel(), CustodyHistory(), EventStatusChip(), OwnerChip(), STATUS_ICON (+44 more)

### Community 14 - "RCA Analysis Stage"
Cohesion: 0.13
Nodes (34): CatBlock(), CauseCard(), ProblemCard(), ProblemStage(), mapRcaError(), addRcaEvidence(), addRcaFactor(), addRcaMember() (+26 more)
...
Cohesion: 0.19
Nodes (16): metadata, ReferralDetailPage(), formatDateTime(), formatFileSize(), ADR-0037, ReferralDisposeDialog(), ReferralReplyView(), ReferralSnapshot() (+8 more)

### Community 17 - "Staff Case Detail"
Cohesion: 0.04
Nodes (33): openQuestionDialog(), signInAs(), signInAs(), signInAs(), signInAs(), ADR-0042, freshOpenCaseId(), getChefeToken() (+25 more)

### Community 18 - "Org Overview Dashboard"
Cohesion: 0.21
Nodes (16): APPOINT_MESSAGES, assignHospitalAdmin(), assignNspCoordinator(), assignNspOrgAdmin(), authorizeNspOrgAdmin(), authorizeOrgAdmin(), COORD_MESSAGES, createCommission() (+8 more)
...
Cohesion: 0.07
Nodes (41): OutcomeBreakdownRow, ADR-0033, CaseStatus, CaseStatusColorToken, allowedFromJunction(), BoardPhaseJson, BoardRowJson, Case (+33 more)

### Community 24 - "Auth Callback & Meeting Settings"
Cohesion: 0.10
Nodes (63): GET(), SUCCESS_REDIRECT, LegacyMeetingsSettingsPage(), UploadDialog(), ActionState, AddAttendeeState, addMeetingAttendee(), advanceMeetingActionItem() (+55 more)
...
Cohesion: 0.05
Nodes (58): SubmissionsPage(), CommissionReferralsPage(), metadata, metadata, OrgNspCoordinationPage(), ADR-0052, deriveFlowMetrics(), metadata (+50 more)

### Community 27 - "Case & Phase Actions"
Cohesion: 0.15
Nodes (33): CreateCaseDialog(), ActionState, activatePhase(), addAdHocPhase(), AddAdHocPhaseState, authorizeCommission(), cancelCase(), closeCase() (+25 more)
...
Cohesion: 0.13
Nodes (35): MyCapaActionControls(), ADR-0076, AcknowledgeButton(), CapaActionCard(), CancelButton(), ReopenButton(), RootCard(), RootsStage() (+27 more)

### Community 31 - "Case Narrative Editor"
Cohesion: 0.08
Nodes (57): metadata, roleFromCapabilities(), StaffCaseDetailPage(), ADR-0033, ADR-0061, CaseDetailLayout(), CaseDetailPage(), metadata (+49 more)

### Community 32 - "Form Item Editor & Tests"
Cohesion: 0.09
Nodes (28): CasePatientEditDialog(), CasePatientPanel(), ADR-0038, TemplateOption, ADR-0038, casePatientToDraft(), EventNotifyForm(), HARM_ORDER (+20 more)

### Community 33 - "Submission Detail Blocks"
Cohesion: 0.08
Nodes (24): BlockConditionNote(), BlockPreview(), formatScore(), buildOptionLabelMap(), buildQuestionLabelMap(), ConditionClause, describeVisibility(), formatValue() (+16 more)

### Community 34 - "Phase Responder & Submissions"
Cohesion: 0.12
Nodes (34): InterviewLifecycleActions(), addInterviewInterviewer(), addInterviewSubject(), ALLOWED_ATTACHMENT_MIME, ATTACHMENT_KINDS, authorizeStaffAdmin(), cancelInterview(), cancelSession() (+26 more)

### Community 35 - "Case Narrative Cards"
Cohesion: 0.06
Nodes (75): CaseActionItemForm(), PhaseOption, STATUS_ORDER, ADR-0033, CaseNarrativeCard(), NarrativeAssignMenu(), ADR-0032, ADR-0033 (+67 more)
...
Cohesion: 0.12
Nodes (25): CaseMeetingsPanel(), formatDateTime(), formatMeetingNumber(), formatSchedule(), MeetingStatusBadge(), SignatureBadge(), MeetingHeader(), ADR-0062 (+17 more)
...
Cohesion: 0.04
Nodes (74): ADR-0005, TOKEN_COLOR_VAR, DraftRow, AGGREGATE_OPS, aggregateKeyFor(), AllowedResultsPicker(), AutomaticEditor(), Criterion (+66 more)

### Community 41 - "Meeting Attendees & Quorum"
Cohesion: 0.06
Nodes (56): CasesBoardPage(), metadata, ADR-0038, ADR-0061, ACTIVE_OR_PENDING, activePhases(), blockedBy(), BoardPhase (+48 more)
...
Cohesion: 0.19
Nodes (25): timelineResultToResolved(), DAY_MONTH, DERIVED_PILL, durationSuffix(), formatEventDate(), formatFull(), formatShort(), FULL (+17 more)

### Community 44 - "Event Notification & Triage"
Cohesion: 0.04
Nodes (58): formatDateTime(), metadata, resolveImageUrls(), SubmissionDetailPage(), metadata, MyResponsesPage(), PhaseAnswersReadonly(), CorrectSubmissionButton() (+50 more)
...
### Community 47 - "Layout"
Cohesion: 0.10
Nodes (21): PendingApprovalsLayout(), OrgCommissionDetailError(), OrgNspAdminLayout(), ADR-0052, metadata, OrgPickerPage(), ADR-0051, HospitalList() (+13 more)

### Community 48 - "Page"
Cohesion: 0.09
Nodes (23): CapaEvidenceLinkForm(), CapaEvidenceUpload(), CapaEvidenceList(), CapaHeader(), CapaPlanCard(), CapaStage(), formatDate(), RcaStatusChip() (+15 more)

### Community 49 - "IsTerminalMeetingStatus"
Cohesion: 0.09
Nodes (33): metadata, OrgCommissionsPage(), ADR-0051, metadata, OrgDocumentsPage(), HospitalDetailPage(), metadata, OrgHospitalsPage() (+25 more)

### Community 50 - "Page"
Cohesion: 0.12
Nodes (19): NotificationPreferencesPage(), ADR-0076, NotificationPreferencesForm(), ORDER, SURFACE_COPY, ADR-0076, Switch(), CommissionSlugRow (+11 more)
...
Cohesion: 0.06
Nodes (69): formatDateTime(), SectionBody(), SignoffMeta(), item(), AnswerSummary(), formatIsoDate(), OptionChip(), renderValue() (+61 more)

### Community 55 - "ListMeetings"
Cohesion: 0.08
Nodes (28): ATTACHMENT_KIND_ORDER, CONFIDENTIALITY_LABEL, CONFIDENTIALITY_ORDER, CONFIDENTIALITY_STYLE, INTERVIEW_CATEGORY_LABEL, INTERVIEW_CATEGORY_ORDER, INTERVIEW_STATUS_LABEL, INTERVIEW_STATUS_ORDER (+20 more)
...
Cohesion: 0.07
Nodes (38): TitleAssignControl(), ADR-0051, TitleBadge(), ADR-0051, CAPABILITIES, MemberAdministrativoControls(), ADR-0061, MemberList() (+30 more)

### Community 58 - "Condition builder"
Cohesion: 0.04
Nodes (66): metadata, metadata, NewCommissionEventPage(), CommissionEventsPage(), metadata, FormsListPage(), metadata, EditDocumentPage() (+58 more)
...
Cohesion: 0.09
Nodes (29): ArchiveNarrativeTypeButton(), NarrativeTypeManager(), useNarrativeAction(), ArchiveTemplateButton(), NarrativeSlotCard(), NarrativeSlotDialog(), PhaseBlocksEditor(), PhaseSlotCard() (+21 more)
...
Cohesion: 0.06
Nodes (49): InterviewDetailPage(), metadata, ManageMembersPage(), metadata, ADR-0061, MeetingsListPage(), metadata, ADR-0061 (+41 more)
...
### Community 65 - "Page"
Cohesion: 0.15
Nodes (16): SectionSignoffFields(), RespondentSignoff(), formatDate(), RespondentContext(), ReviewAndSign(), ADR-0061, SignSectionPanel(), DATE_FMT (+8 more)
...
### Community 68 - "Page"
Cohesion: 0.12
Nodes (30): metadata, AdminLayout(), ADR-0042, CommissionAuditPage(), metadata, metadata, OrgAuditPage(), ADR-0051 (+22 more)
...
### Community 82 - "Route"
Cohesion: 0.24
Nodes (6): formatCaseNumber(), LinkableTargetCase, LinkCaseDialog(), REFERRAL_MESSAGES, ADR-0037, ReplyOutcome
...
### Community 93 - "Page"
Cohesion: 0.14
Nodes (14): ConfirmDeleteButton(), InterviewerRoleBadge(), InterviewerForm(), InterviewerMemberOption, InterviewerRow(), InterviewersPanel(), SubjectForm(), SubjectMemberOption (+6 more)
...
### Community 96 - "Page"
Cohesion: 0.08
Nodes (45): metadata, NspConfigPage(), ADR-0052, NspReferralsDashboardPage(), metadata, NspRosterPage(), ADR-0052, NspEventDetailPage() (+37 more)
...
Cohesion: 0.06
Nodes (44): BuilderPage(), metadata, resolveImageUrls(), toCondition(), CONDITION_TARGET_TYPES, isEligibleTarget(), newQuestionConditionTargets(), questionConditionTargets() (+36 more)
...
Cohesion: 0.35
Nodes (9): formatCaseNumber(), formatInterviewNumber(), interviewTitle(), InterviewModalityChip(), InterviewStatusBadge(), NewInterviewButton(), InterviewHeader(), InterviewsPanel() (+1 more)

### Community 109 - "CaseTagsPanel"
Cohesion: 0.07
Nodes (34): ADR-0032, ADR-0033, ADR-0038, ADR-0061, metadata, CaseAccessButton(), CaseActionItemsPanel(), DEPARTMENTS (+26 more)

### Community 110 - "DepartmentDefDialog"
Cohesion: 0.09
Nodes (35): RootCauseTypePill(), STATUS_CLASS, CATEGORY_VISUAL, CLASSIFICATION_SELECTED, CLASSIFICATIONS, auditClinicalView(), auditRcaView(), getRca() (+27 more)
...
Cohesion: 0.11
Nodes (25): IndicatorsPanelAsync(), IndicatorsPanel(), DerivedConfig, DerivedDenominatorRef, DerivedNumeratorRef, HybridDerivedConfig, Indicator, IndicatorKpis (+17 more)
...
### Community 121 - "Page"
Cohesion: 0.03
Nodes (99): ADR-0025, MeetingDetailPage(), metadata, ActionItemForm(), AssigneeOption, ActionItemRow(), ActionItemsPanel(), isItemOverdue() (+91 more)

### Community 122 - "Page"
Cohesion: 0.13
Nodes (15): OpenAttachmentButton(), ADR-0063, CaseDocumentUpload(), CaseDocumentsPanel(), ADR-0033, ADR-0063, DOC_TYPE_LABEL, AttachmentLinkForm() (+7 more)
...
Cohesion: 0.19
Nodes (16): toDateTimeLocalValue(), HeldWindowFields(), isFuture(), localToIso(), ADR-0062, useHeldWindowState(), MeetingFormDialog(), memberLabel() (+8 more)
...
Cohesion: 0.04
Nodes (36): ADR 0001 — Scaffolding & toolchain bootstrap, Consequences, Context, Decisions, ADR 0009 — Local JWT verification for the auth gate & identity, Consequences, Context, Decision (+28 more)
...
### Community 158 - "Page"
Cohesion: 0.05
Nodes (61): ADR-0002, commissionInitials(), CommissionPickerPage(), metadata, ROLE_LABEL, slugifyHeading(), CommissionLayout(), ADR-0033 (+53 more)
...
Cohesion: 0.15
Nodes (21): CaseTimelinePage(), metadata, CaseTimeline(), TimelineLegend(), ALL_TYPES, buildQuery(), first(), ParamValue (+13 more)
...
### Community 229 - "Page"
Cohesion: 0.11
Nodes (25): formatDate(), formatReferralCode(), referralStatusChipClass(), referralTypeChipClass(), ReferralDirectionChip(), ReferralStatusChip(), ReferralTypeChip(), ResponseExpectedChip() (+17 more)
...
Cohesion: 0.06
Nodes (27): ADR 0020 — Dashboard-countable responses: case-phase exclusion, Consequences, Context, Decision, 0068 — Case-phase result engine: jsonb/array → FK-backed junctions (D3), Consequences, Context, Decision (+19 more)
...
Cohesion: 0.18
Nodes (10): 0066 — patient_xref case-module grain re-keyed to the patient participant, Consequences, Context, Decision, Rationale, Commits (branch `feat/pre-pilot-foundations-plan`, local — not pushed to remote; pre-pilot reset-OK), Deferred (post-pilot), F1 — Case-Participants E0 (Pre-Pilot Foundations Program) — COMPLETE (+2 more)
...
Cohesion: 0.21
Nodes (14): formatIndicatorValue(), formatPeriodLabel(), formatTarget(), IndicatorKindBadge(), MeasurementStatusChip(), STATUS_STYLES, IndicatorList(), MeasurementGrid() (+6 more)
...
Cohesion: 0.12
Nodes (32): UploadDialog(), ALLOWED_MIME, attachmentsEnabled(), createAttachment(), DISPOSAL_REASONS, disposeAttachmentPhi(), MESSAGES, OWNER_TYPES (+24 more)
...
Cohesion: 0.12
Nodes (17): SafetyEventPrefill, CaseSafetyPrefill, AddReplyAttachmentInput, AddSharedItemInput, ConcludeReferralInput, CreateReferralInput, CreateReferralState, DeclineReferralInput (+9 more)
...
Cohesion: 0.21
Nodes (12): AccountLayout(), ADR-0076, ContaNav(), ITEMS, ADR-0076, NotificationBellClient(), NotificationBell(), ADR-0076 (+4 more)
...
Cohesion: 0.22
Nodes (8): PhaseResultBadge(), AvatarStack(), diffPhaseDays(), TimelineEventSheet(), Avatar(), AvatarFallback(), AvatarImage(), TimelinePerson
...
Cohesion: 0.10
Nodes (20): DashboardPage(), metadata, buildCards(), CommissionHomePage(), formatNextMeeting(), metadata, OverviewCardData, StatCount() (+12 more)
...
Cohesion: 0.18
Nodes (11): CHART_COLORS, DistributionChart(), getServerSnapshot(), getSnapshot(), subscribe(), useReducedMotion(), AGING_BUCKETS, CHART_COLORS (+3 more)
...
Cohesion: 0.19
Nodes (9): 0057 — Phase 15/17 revision & pre-pilot re-sequencing (15 → 17 → 16), Consequences, Context, Decisions, 0058 — Derived quality-indicator measurement compute (the parity lock), Alternatives rejected, Consequences, Context (+1 more)
...
## Knowledge Gaps
- **4776 isolated node(s):** `semi`, `singleQuote`, `trailingComma`, `plugins`, `$schema` (+4771 more)
...
- **Why does `createClient()` connect `Auth Callback & Meeting Settings` to `Admin & Auth Pages`, `Triage Disposition & Pathways`, `RCA Problem Stage`, `Form Builder Actions`, `Submission Detail (Answer Model)`, `Meeting form dialog.test`, `NSP Event Pages`, `RCA Analysis Stage`, `Case Department Field`, `Referral Detail & Formatting`, `Page`, `Org Overview Dashboard`, `NSP Patient Registry`, `My Cases List`, `Referral Actions & Reply`, `NSP Referrals Dashboard`, `Case & Phase Actions`, `Meeting Detail & Agenda`, `NSP CAPA/RCA Pages`, `Page`, `Case Narrative Editor`, `0068 — Case-phase result engine: jsonb/array → FK-backed junctions (D3)`, `CAPA Evidence & Cards`, `Phase Responder & Submissions`, `Case Narrative Cards`, `Phase Result Actions`, `loading.tsx`, `flagged-aggregate-result.spec.ts`, `Admin Layout & Claims`, `loading.tsx`, `Meeting Attendees & Quorum`, `Forms & Process Templates`, `Derived Indicator Config`, `loading.tsx`, `run-chart-loader.tsx`, `Event Notification & Triage`, `Layout`, `result-actions.ts`, `Page`, `IsTerminalMeetingStatus`, `Page`, `Page`, `0066 — patient_xref case-module grain re-keyed to the patient participant`, `TitleAssignControl`, `Condition builder`, `Page`, `case-narratives.spec.ts`, `UploadDialog`, `ADR 0030 — Patient-Safety PHI Posture Reversal & PQS/NSP Module Architecture (Phase 14)`, `Page`, `Wizard runner`, `Page`, `ActionItemRow`, `CaseActionItemsPanel`, `Gantt axis`, `Audit icon`, `Page`, `Page`, `Referral patient fields`, `Actions`, `ADR 0021 — Due dates for case phases`, `Outcomes actions`, `QA Review — Form Builder Enhancements (mini-phase)`, `CaseTagsPanel`, `DepartmentDefDialog`, `Browser`, `Loading`, `Page`, `Page`, `Format`, `Loading`, `ADR 0028`?**
  _High betweenness centrality (0.065) - this node is a cross-community bridge._
- **Why does `Page` connect `Staff Case Detail` to `phase22-referrals.spec.ts`, `phase8-dashboard.spec.ts`, `4.4 `form_responses.form_repeating_group_instances``, `phase14b-triage.spec.ts`, `Page`, `recommend-result.spec.ts`, `My Cases List`, `NSP Referrals Dashboard`, `Page`, `OrgAuditPage`, `ADR 0032 — Case Narratives (per-case prose interleaved with phases)`, `phase7-cases.spec.ts`, `cases-outcomes-blockers.spec.ts`, `nsp-per-hospital.spec.ts`, `phase14c-rca.spec.ts`, `phase14d-capa.spec.ts`, `form-model-normalization.spec.ts`, `phase15-indicators.spec.ts`, `phi-remediation.spec.ts`, `Event Notification & Triage`, `Interview badges`, `ADR 0041 — Multi-Tenancy: organizations + hospitals above commissions`, `Phase B — NSP-per-hospital + `nsp_org_admin` — completed phase record`, `Case tags panel`, `Event type manager`, `form-builder-enhancements.spec.ts`, `Case document delete`, `ad-hoc-narratives.spec.ts`, `administrativo.spec.ts`, `member-action-items-overview.spec.ts`, `phase13-audit.spec.ts`, `Page`, `Increment Archive — Case Access Control & "Meus Casos"`, `Loading`, `Page`, `case-patient.spec.ts`, `cases-extras.spec.ts`, `cases-meetings-minor.spec.ts`, `patient-index.spec.ts`, `phase14a-safety-events.spec.ts`?**
  _High betweenness centrality (0.050) - this node is a cross-community bridge._
- **Why does `cn()` connect `QA Review — Phase B: NSP-per-hospital + `nsp_org_admin`` to `3.14 `forms.block_library_items``, `Case Lifecycle Actions`, `Shared UI & Phase Dialogs`, `Error & Not-Found Boundaries`, `Loading`, `Phase Answers & Assignments`, `Admin & Auth Pages`, `Case Documents`, `RCA Problem Stage`, `Triage Disposition & Pathways`, `CAPA Badges`, `NSP Event Pages`, `RCA Analysis Stage`, `loading.tsx`, `0068 — Case-phase result engine: jsonb/array → FK-backed junctions (D3)`, `NSP CAPA/RCA Pages`, `Meeting Detail & Agenda`, `CAPA Evidence & Cards`, `Page`, `Case Narrative Cards`, `Admin Layout & Claims`, `flagged-aggregate-result.spec.ts`, `Interview & Agenda Forms`, `Derived Indicator Config`, `Meeting Attendees & Quorum`, `Forms & Process Templates`, `Narrative Templates`, `Event Notification & Triage`, `Layout`, `Page`, `Page`, `Phase result options`, `Page`, `loading.tsx`, `Section signoff fields`, `ListMeetings`, `TitleAssignControl`, `Condition builder`, `CaseActionItemForm`, `Page`, `Page`, `Page`, `Loading`, `CaseActionItemsPanel`, `Page`, `Page`, `ADR 0021 — Due dates for case phases`, `Page`, `Page`, `Audit motion`, `CaseTagsPanel`, `case-patient.md`, `DepartmentDefDialog`, `loading.tsx`, `Page`, `Page`?**
...
- **Should `Case Lifecycle Actions` be split into smaller, more focused modules?**
  _Cohesion score 0.0565359477124183 - nodes in this community are weakly interconnected._
- **Should `Admin & Auth Pages` be split into smaller, more focused modules?**
  _Cohesion score 0.04675014907573047 - nodes in this community are weakly interconnected._
- **Should `Shared UI & Phase Dialogs` be split into smaller, more focused modules?**
  _Cohesion score 0.07904856857997436 - nodes in this community are weakly interconnected._