...
## Corpus Check
- 1469 files · ~2,057,468 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 10908 nodes · 22094 edges · 1519 communities (624 shown, 895 thin omitted)
- Extraction: 100% EXTRACTED · 0% INFERRED · 0% AMBIGUOUS · INFERRED: 90 edges (avg confidence: 0.69)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `28a5ad79`
...
## Communities (1519 total, 895 thin omitted)

### Community 0 - "Case Lifecycle Actions"
Cohesion: 0.17
Nodes (14): ManageMembersPage(), metadata, ADR-0061, AddMemberDialog(), AdministrativoAppointment, CommissionRole, listAddableMembers(), listAdministrativos() (+6 more)
...
Cohesion: 0.15
Nodes (13): CapaStatusChip(), CapaHeader(), CapaPlanCard(), CapaStage(), formatDate(), RcaStatusChip(), ProgressReadout(), RcaHeader() (+5 more)

### Community 3 - "Error & Not-Found Boundaries"
Cohesion: 0.13
Nodes (34): MyCapaActionControls(), ADR-0076, CapaActionCard(), CapaActionForm(), userLabel(), CapaEvidenceLinkForm(), CapaEvidenceUpload(), CapaEvidenceList() (+26 more)
...
Cohesion: 0.07
Nodes (43): AnalysisStage(), SubView, Tab(), Fishbone(), RcaMemberRoleBadge(), STATUS_CLASS, CLASSIFICATION_SELECTED, padSteps() (+35 more)

### Community 8 - "RCA Problem Stage"
Cohesion: 0.13
Nodes (31): CapaActionsSection(), activePdcaStage(), allActionsSettled(), allMeasuresHaveResults(), canAdvanceAction(), concludeGate, countPdcaDone(), derivePdca() (+23 more)

### Community 9 - "Form Builder Actions"
Cohesion: 0.08
Nodes (56): ADR-0011, ActionState, addItem(), addSection(), ALL_ITEM_TYPES, ALLOWED_IMAGE_MIME, authorizeCommission(), CHOICE_TYPES (+48 more)

### Community 10 - "Submission Detail (Answer Model)"
Cohesion: 0.04
Nodes (65): BuilderPage(), metadata, resolveImageUrls(), DATE_FMT, metadata, resolveImageUrls(), VersionsPage(), FormsListPage() (+57 more)
...
Cohesion: 0.06
Nodes (52): ADR-0005, DraftRow, AGGREGATE_OPS, aggregateKeyFor(), AllowedResultsPicker(), AutomaticEditor(), Criterion, criterionForKey() (+44 more)

### Community 13 - "NSP Event Pages"
Cohesion: 0.05
Nodes (69): metadata, NspEventDetailPage(), metadata, NspTriagePage(), NspOrgRollups(), NspOrgRosterSummary(), CapaClosurePanel(), CustodyHistory() (+61 more)
...
Cohesion: 0.05
Nodes (87): CancelCaseButton(), ConcludeNarrativeButton(), ADR-0033, ConfirmDeleteButton(), DetailPhase, ADR-0033, ADR-0061, NarrativeTypeDialog() (+79 more)

### Community 16 - "Referral Detail & Formatting"
Cohesion: 0.12
Nodes (21): metadata, ProcessTemplatesListPage(), CreateProcessTemplateDialog(), ProcessTemplateCard(), STATUS_LABEL, STATUS_STYLES, TemplateStatusBadge(), RecommendRule (+13 more)

### Community 17 - "Staff Case Detail"
Cohesion: 0.04
Nodes (47): openQuestionDialog(), signInAs(), assertAbsentFromMeusCasos(), assertCaseDenied(), assertCaseReadable(), assertPresentInMeusCasos(), AuditRow, auditRowsFor() (+39 more)
...
Cohesion: 0.05
Nodes (79): LoginPage(), metadata, CommissionEditForm(), ConfirmRemoveButton(), StaffAdminManager(), LoginForm(), CaseDepartmentField(), DEPARTMENTS (+71 more)
...
Cohesion: 0.07
Nodes (56): AssigneeAvatar(), activePhases(), blockedBy(), BoardPhase, CaseStatusColumn, currentPhase(), groupByFixedStatus(), hasRecommendedPending() (+48 more)

### Community 24 - "Auth Callback & Meeting Settings"
Cohesion: 0.12
Nodes (59): GET(), SUCCESS_REDIRECT, LegacyMeetingsSettingsPage(), UploadDialog(), MeetingLifecycleActions(), addMeetingAttendee(), advanceMeetingActionItem(), AgendaItemInput (+51 more)

### Community 25 - "Referral Actions & Reply"
Cohesion: 0.09
Nodes (44): LinkableTargetCase, ReferralActions(), ComposerMode, ComposerModeKey, ReferralComposer(), ADR-0037, getReferralPatient(), acceptReferral() (+36 more)

### Community 26 - "NSP Referrals Dashboard"
Cohesion: 0.09
Nodes (29): referralStatusChipClass(), ReferralDirectionChip(), ReferralMessageTypeChip(), ReferralStatusChip(), STATUS_ICON, ADR-0037, ReferralThread(), ADR-0037 (+21 more)

### Community 27 - "Case & Phase Actions"
Cohesion: 0.09
Nodes (47): CasePatientEditDialog(), ADR-0038, ADR-0078, CasePhaseDelete(), CreateCaseDialog(), ActionState, activatePhase(), addAdHocPhase() (+39 more)

### Community 28 - "Meeting Detail & Agenda"
Cohesion: 0.06
Nodes (40): CaseNarrativeCard(), CasePhaseList(), ADR-0032, ADR-0033, ADR-0061, ArchiveNarrativeTypeButton(), useNarrativeAction(), ArchiveTemplateButton() (+32 more)
...
Cohesion: 0.07
Nodes (52): isOverdue(), localTodayYmd(), MyCapaActionsPage(), ADR-0076, CapaActionStatusChip(), CapaStrengthPill(), STATUS_ICON, STRENGTH_ICON (+44 more)
...
Cohesion: 0.11
Nodes (29): casePatientToDraft(), EventNotifyForm(), HARM_ORDER, ADR-0038, EMPTY_PATIENT_DRAFT, PatientDraft, patientDraftHasData(), patientDraftToInput() (+21 more)

### Community 33 - "Submission Detail Blocks"
Cohesion: 0.12
Nodes (17): metadata, MyCasesPage(), ADR-0033, CaseStatusBadgeFixed(), MyCaseCard(), MyCaseItemAction(), MyCaseItemRow(), ADR-0033 (+9 more)
...
Cohesion: 0.17
Nodes (35): CaseNarrativeDelete(), caseAccessEnabled(), addAdHocNarrative(), addTemplateNarrative(), archiveNarrativeType(), assignNarrative(), authorizeCommission(), CaseLayoutOrderItem (+27 more)
...
Cohesion: 0.03
Nodes (10): ADR-0033, MarkdownRenderer(), Mode, ModeTab(), SectionTextEditor(), CapaVerdictChip(), GateRow(), CapaEffectivenessPanel() (+2 more)
...
Cohesion: 0.11
Nodes (30): metadata, ReferralDetailPage(), ADR-0078, formatCaseNumber(), formatDate(), formatDateTime(), formatFileSize(), formatReferralCode() (+22 more)

### Community 41 - "Meeting Attendees & Quorum"
Cohesion: 0.03
Nodes (100): MeetingsSettingsTabPage(), metadata, MeetingDetailPage(), metadata, OpenAttachmentButton(), ADR-0063, CaseMeetingsPanel(), SessionRow() (+92 more)
...
Cohesion: 0.53
Nodes (5): inputItem(), response(), section(), tree(), toAnswerState()

### Community 44 - "Event Notification & Triage"
Cohesion: 0.08
Nodes (37): AdminOrganizationsPage(), metadata, metadata, OrgCommissionsPage(), ADR-0051, metadata, OrgHospitalsPage(), AREAS (+29 more)
...
### Community 46 - "Page"
Cohesion: 0.04
Nodes (52): 10.1 Referral read access, 10.2 Message insertion, 10.3 Internal notes, 10.4 Documents, 10.5 Linked cases, 10. Row-Level Security Strategy, 11.1 Submit referral transaction, 11.2 Send message transaction (+44 more)
...
Cohesion: 0.18
Nodes (21): countDone(), deriveDone(), deriveKeyFactors(), groupFactorsByCategory(), RCA_STAGE_META, RCA_STAGE_ORDER, rcaCanEdit(), RcaStageId (+13 more)
...
### Community 52 - "Page"
Cohesion: 0.08
Nodes (36): metadata, PrimeiroAcessoPage(), OrgCommissionDetailError(), metadata, OrgNspCoordinationPage(), ADR-0052, HospitalDetailPage(), metadata (+28 more)

### Community 54 - "Section signoff fields"
Cohesion: 0.06
Nodes (51): PhaseAnswersReadonly(), formatDateTime(), SectionBody(), SignoffMeta(), SubmissionDetailView(), item(), SECTION, SectionConditionBadge() (+43 more)
...
Cohesion: 0.14
Nodes (18): metadata, NarrativeEditorPage(), ADR-0033, canEditNarrative(), ADR-0033, NarrativeEditor(), ActionState, authorizeCommission() (+10 more)

### Community 58 - "Condition builder"
Cohesion: 0.11
Nodes (23): OrganizationCreateForm(), slugify(), ActionState, appOrigin(), assignStaffAdmin(), authorizeStaffAdminOps(), createCommission(), MESSAGES (+15 more)
...
Cohesion: 0.04
Nodes (92): ChecklistSection(), REMINDER_TYPE_ORDER, SatelliteConfirmDelete(), SatelliteEmpty(), SatelliteSection(), UpdatesSection(), useSatelliteAction(), AuditLabelOption (+84 more)

### Community 62 - "VersionWithUrl"
Cohesion: 0.08
Nodes (49): AdminAuditPage(), metadata, csvField(), GET(), toCsv(), ADR-0020, ADR-0029, RFC-4180 (+41 more)
...
### Community 68 - "Page"
Cohesion: 0.05
Nodes (59): CaseActionItemForm(), PhaseOption, ActionItemRow(), isItemOverdue(), STATUS_ORDER, ADR-0033, NarrativeAssignMenu(), ADR-0032 (+51 more)
...
### Community 74 - "Page"
Cohesion: 0.09
Nodes (36): CommissionReferralsPage(), metadata, deriveFlowMetrics(), metadata, NspReferralsDashboardPage(), ADR-0042, buildCaseReferralsModule(), NOTE: the safety-event PHI pre-fill is intentionally NOT assembled here — the (+28 more)
...
### Community 82 - "Route"
Cohesion: 0.13
Nodes (14): ImagePreview(), ImageContentRenderer(), BlockRenderer(), ItemHandlers, SectionStep(), ImageContent, SectionTextContent, CompositeTypes (+6 more)

### Community 83 - "ActionItemRow"
Cohesion: 0.06
Nodes (46): metadata, OrgAdministratorsPage(), ADR-0051, ADR-0052, metadata, OrgNspCoordinatorsPage(), OrgNspAdminLayout(), ADR-0052 (+38 more)

### Community 84 - "CaseActionItemsPanel"
Cohesion: 0.25
Nodes (20): EventTypeManager(), SentinelCriterionManager(), draftFromTriage(), TriageWorkstation(), mapTriageError(), archiveEventType(), archiveSentinelCriterion(), confirmTriage() (+12 more)
...
Cohesion: 0.05
Nodes (65): ActionItemDetailPage(), cnDue(), describeSource(), metadata, ActionItemSourceBadge(), ActionItemStatusBadge(), SOURCE_META, STATUS_META (+57 more)
...
### Community 93 - "Page"
Cohesion: 0.10
Nodes (16): metadata, metadata, metadata, metadata, PasswordSetForm(), ResetRequestForm(), appOrigin(), AuthState (+8 more)
...
### Community 96 - "Page"
Cohesion: 0.17
Nodes (24): timelineResultToResolved(), AvatarStack(), DAY_MONTH, DERIVED_PILL, durationSuffix(), formatEventDate(), formatFull(), formatShort() (+16 more)
...
Cohesion: 0.07
Nodes (64): metadata, roleFromCapabilities(), StaffCaseDetailPage(), ADR-0033, ADR-0061, NewCommissionEventPage(), CommissionEventsPage(), metadata (+56 more)
...
Cohesion: 0.06
Nodes (45): OutcomeBreakdownRow, CaseStatus, CaseStatusColorToken, allowedFromJunction(), BoardPhaseJson, BoardRowJson, Case, CaseAccessGrantRow (+37 more)
...
Cohesion: 0.11
Nodes (22): GrantExpiry(), CaseDocumentUpload(), CaseDocumentsPanel(), ADR-0033, ADR-0063, CaseEventForm(), CaseEventsTimeline(), ACTION_ITEM_STATUS_LABEL (+14 more)
...
Cohesion: 0.08
Nodes (35): TitleAssignControl(), ADR-0051, CAPABILITIES, MemberAdministrativoControls(), ADR-0061, MemberList(), ADR-0051, ADR-0061 (+27 more)
...
### Community 158 - "Page"
Cohesion: 0.09
Nodes (25): CasesBoardPage(), metadata, ADR-0038, ADR-0061, metadata, MyActionItemsPage(), ACTIVE_OR_PENDING, computeCaseKpis() (+17 more)
...
Cohesion: 0.13
Nodes (14): ADR-0032, ADR-0033, ADR-0038, ADR-0061, CaseNarrativesBuilderPage(), metadata, ADR-0032, CaseAccessButton() (+6 more)
...
Cohesion: 0.07
Nodes (33): AccountLayout(), ADR-0076, DocumentsLayout(), IndicatorsLayout(), PendingApprovalsLayout(), metadata, PendingApprovalsPage(), metadata (+25 more)
...
Cohesion: 0.07
Nodes (35): react, ADR-0033, CaseAccessPanel(), ExpiryPreset, GrantDialog(), isoDaysFromNow(), isoTomorrow(), LevelOption() (+27 more)
...
Cohesion: 0.11
Nodes (20): ADR-0025, TitleBadge(), ADR-0051, ActionItemRow(), isItemOverdue(), AgendaItemForm(), AgendaPanel(), AgendaRow() (+12 more)
...
Cohesion: 0.11
Nodes (34): AttachmentsPanel(), ALLOWED_MIME, attachmentsEnabled(), createAttachment(), DISPOSAL_REASONS, disposeAttachmentPhi(), MESSAGES, openAttachment() (+26 more)
...
Cohesion: 0.06
Nodes (58): metadata, resolveImageUrls(), ReviewAndSignPage(), ADR-0061, OrphanWarningDialog(), PhaseResultPanel(), ResultChoiceGroup(), RespondentSignoff() (+50 more)
...
Cohesion: 0.17
Nodes (12): EMPTY_REFERRAL_PATIENT_DRAFT, ReferralPatientDraft, referralPatientDraftHasData(), referralPatientDraftToInput(), ReferralPatientFields(), SEX_ORDER, ADR-0037, ReferralSendWizard() (+4 more)
...
Cohesion: 0.05
Nodes (54): metadata, PhaseResponderPage(), metadata, metadata, ResponderPage(), FormsListPage(), metadata, metadata (+46 more)
...
Cohesion: 0.18
Nodes (10): clampCalloutCenter(), OPTIONS, TimelineDensity, TimelineDensitySwitch(), AxisHeader(), GanttRow(), Marker(), Pin() (+2 more)
...
Cohesion: 0.21
Nodes (17): CaseDocumentDelete(), UploadDialog(), ActionState, ALLOWED_DOC_MIME, authorizeCommission(), commissionOfCase(), createCaseEvent(), deleteCaseDocument() (+9 more)
...
Cohesion: 0.13
Nodes (23): CaseActionItemsPanel(), CaseReferralsModule, ADR-0032, ADR-0038, ADR-0061, CaseOfferedOutcomesEditor(), CaseRoleChip(), ROLE_META (+15 more)

### Community 475 - "Result-based phase recommendation — `recommend_when` answer/result groups (✅ COMPLETE 2026-06-26)"
Cohesion: 0.24
Nodes (8): PhaseCorrectionMode, PhaseCorrectionOptions, VOCAB, dayPart(), diffDaysUtc(), durationDays(), endDay(), TimelinePhaseResult
...
Cohesion: 0.05
Nodes (38): ADR 0041 — Multi-Tenancy: organizations + hospitals above commissions, Alternatives rejected, Consequences, Context, Decision, Implementation amendments (2026-06-25), ADR 0051 — Hospital-admin tier, 4-tier audit chain & committee member titles, Alternatives rejected (+30 more)
...
Cohesion: 0.10
Nodes (21): 4.10 `form_responses.form_answer_revisions`, 4.3 `form_responses.form_answer_options`, 4.4 `form_responses.form_repeating_group_instances`, 4.7 `form_responses.form_answer_matrix_cells`, 4. Answer Storage Layer, Design Reasoning, Design Reasoning, Design Reasoning (+13 more)
...
Cohesion: 0.03
Nodes (52): 0011 — Position reorder via deferrable constraints + SQL swap RPCs, Consequences, Context, Decision, Options considered, ADR 0020 — Dashboard-countable responses: case-phase exclusion, Consequences, Context (+44 more)
...
Cohesion: 0.07
Nodes (33): CommissionLayout(), ADR-0033, metadata, SignoffQueuePage(), ADR-0061, metadata, MyPhasesPage(), ADR-0033 (+25 more)
...
### Community 1505 - "4.9 `form_responses.form_answer_references`"
Cohesion: 0.40
...
### Community 1518 - "ADR 0001 — Scaffolding & toolchain bootstrap"
Cohesion: 0.40
...
### Community 1542 - "32. Implementation Phases"
Cohesion: 0.50
...
### Community 1543 - "Feature — `case_phase_results` (per-phase categorical result + manual override)"
Cohesion: 0.50
...
## Knowledge Gaps
- **5416 isolated node(s):** `semi`, `singleQuote`, `trailingComma`, `plugins`, `$schema` (+5411 more)
...
- **Why does `createClient()` connect `Auth Callback & Meeting Settings` to `Case Lifecycle Actions`, `Loading`, `Error & Not-Found Boundaries`, `3.8 `forms.form_block_default_values``, `Triage Disposition & Pathways`, `Case Documents`, `Form Builder Actions`, `Submission Detail (Answer Model)`, `Meeting form dialog.test`, `NSP Event Pages`, `RCA Analysis Stage`, `Referral Detail & Formatting`, `Page`, `Quality Indicators`, `NSP Patient Registry`, `Org Overview Dashboard`, `Referral Actions & Reply`, `markdown-renderer.tsx`, `Case & Phase Actions`, `Meeting Detail & Agenda`, `NSP CAPA/RCA Pages`, `Page`, `CAPA Evidence & Cards`, `loading.tsx`, `Submission Detail Blocks`, `Phase Responder & Submissions`, `Case Narrative Cards`, `Case Narrative Editor`, `Form Item Editor & Tests`, `Lead Playbook — orchestration protocol (lead only)`, `Forms & Process Templates`, `Derived Indicator Config`, `Meeting Attendees & Quorum`, `form-builder-enhancements.md`, `Event Notification & Triage`, `ADR 0018 — Custom SQLSTATE class `HC0xx` (was `P00xx`)`, `PHASES.md — Hospital Commission Forms Platform`, `Page`, `11. Domain Services and Transaction Boundaries`, `Page`, `Phase result options`, `ADR 0003 — pgTAP for database tests`, `UserLifecycleActions`, `TitleAssignControl`, `Condition builder`, `CaseActionItemForm`, `VersionWithUrl`, `case-narratives.spec.ts`, `UploadDialog`, `Wizard runner`, `Page`, `AuditFeed`, `Avatar stack`, `ActionItemRow`, `CaseActionItemsPanel`, `Gantt axis`, `Lead notes`, `"Sem processo" — process-less case creation (`processless_cases`)`, `Page`, `Referral patient fields`, `0012 — clone_form_version returns the existing draft (one draft per form)`, `Page`, `Outcomes actions`, `loading.tsx`, `Audit motion`, `DepartmentDefDialog`, `ADR 0042 — NSP-per-org: per-org PQS roster + org-bound PHI doors`, `Loading`, `Answer-Model v2 + form-definition forward-compat — phase record (✅ COMPLETE 2026-07-01)`, `Page`, `ConfirmDeleteButton`, `Format`, `Loading`, `ADR 0028`?**
  _High betweenness centrality (0.053) - this node is a cross-community bridge._
- **Why does `Page` connect `Staff Case Detail` to `phase22-referrals.spec.ts`, `phase8-dashboard.spec.ts`, `Loading`, `Org Overview Dashboard`, `phase14b-triage.spec.ts`, `Page`, `recommend-result.spec.ts`, `10. Row-Level Security Strategy`, `OrgAuditPage`, `Admin Layout & Claims`, `ARCHITECTURE.md — Hospital Commission Forms Platform`, `loading.tsx`, `phase7-cases.spec.ts`, `loading.tsx`, `cases-outcomes-blockers.spec.ts`, `nsp-per-hospital.spec.ts`, `phase14c-rca.spec.ts`, `phase14d-capa.spec.ts`, `form-model-normalization.spec.ts`, `phase15-indicators.spec.ts`, `phi-remediation.spec.ts`, `Meeting Attendees & Quorum`, `0066 — patient_xref case-module grain re-keyed to the patient participant`, `Interview badges`, `ADR 0041 — Multi-Tenancy: organizations + hospitals above commissions`, `Phase B — NSP-per-hospital + `nsp_org_admin` — completed phase record`, `Event type manager`, `form-builder-enhancements.spec.ts`, `Page`, `ActionItemRow`, `Case document delete`, `ad-hoc-narratives.spec.ts`, `administrativo.spec.ts`, `member-action-items-overview.spec.ts`, `phase13-audit.spec.ts`, `DepartmentDefDialog`, `Page`, `Loading`, `Phase 17 — Controlled-Document Lifecycle · QA Review`, `case-patient.spec.ts`, `cases-extras.spec.ts`, `patient-index.spec.ts`, `phase14a-safety-events.spec.ts`?**
  _High betweenness centrality (0.052) - this node is a cross-community bridge._
- **Why does `cn()` connect `CaseActionItemForm` to `Admin & Auth Pages`, `Shared UI & Phase Dialogs`, `Error & Not-Found Boundaries`, `3.8 `forms.form_block_default_values``, `Phase Answers & Assignments`, `Triage Disposition & Pathways`, `Case Documents`, `RCA Problem Stage`, `Submission Detail (Answer Model)`, `Meeting form dialog.test`, `CAPA Badges`, `NSP Event Pages`, `RCA Analysis Stage`, `Case Department Field`, `Referral Detail & Formatting`, `Org Overview Dashboard`, `Quality Indicators`, `QA Review — Phase B: NSP-per-hospital + `nsp_org_admin``, `My Cases List`, `markdown-renderer.tsx`, `NSP Referrals Dashboard`, `NSP CAPA/RCA Pages`, `CAPA Evidence & Cards`, `loading.tsx`, `Submission Detail Blocks`, `Phase Result Actions`, `Interview & Agenda Forms`, `Forms & Process Templates`, `Derived Indicator Config`, `Meeting Attendees & Quorum`, `ADR 0018 — Custom SQLSTATE class `HC0xx` (was `P00xx`)`, `case-phase-result.spec.ts`, `Page`, `result-actions.ts`, `Page`, `IsTerminalMeetingStatus`, `Page`, `ADR 0003 — pgTAP for database tests`, `Section signoff fields`, `decisions-log.md`, `Page`, `VersionWithUrl`, `ADR 0053 — Audit-access entitlement guard (C-4): dispatch to the entity's own read predicate, not a revoke`, `Page`, `ActionItemRow`, `4. Answer Storage Layer`, `Gantt axis`, `"Sem processo" — process-less case creation (`processless_cases`)`, `Page`, `Page`, `Referral patient fields`, `Loading`, `Answer-Model v2 + form-definition forward-compat — phase record (✅ COMPLETE 2026-07-01)`, `Loading`, `Page`, `Format`?**
...
- **Should `Admin & Auth Pages` be split into smaller, more focused modules?**
  _Cohesion score 0.05460956312349501 - nodes in this community are weakly interconnected._
