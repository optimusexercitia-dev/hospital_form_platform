...
## Corpus Check
- 1316 files · ~1,711,490 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 9663 nodes · 20052 edges · 1468 communities (580 shown, 888 thin omitted)
- Extraction: 100% EXTRACTED · 0% INFERRED · 0% AMBIGUOUS · INFERRED: 90 edges (avg confidence: 0.69)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `4f0fe906`
...
## Communities (1468 total, 888 thin omitted)

### Community 0 - "Case Lifecycle Actions"
Cohesion: 0.20
Nodes (19): ADR-0033, ObsoleteAction, ArchiveTemplateButton(), NarrativeSlotCard(), ADR-0032, PublishTemplateButton(), REASON_LABELS, REASON_ORDER (+11 more)

### Community 1 - "Admin & Auth Pages"
Cohesion: 0.05
Nodes (70): AdminOrganizationsPage(), metadata, metadata, CommissionEditForm(), StaffAdminManager(), LoginForm(), ResetRequestForm(), AddVersionAction (+62 more)

### Community 2 - "Shared UI & Phase Dialogs"
Cohesion: 0.07
Nodes (67): BannerTone, FormBanner(), toneStyles, ActivatePhaseDialog(), defaultDueDateValue(), AddAdHocNarrativeDialog(), AddAdHocPhaseDialog(), ACCEPT (+59 more)

### Community 3 - "Error & Not-Found Boundaries"
Cohesion: 0.03
Nodes (6): ADR-0033, MarkdownRenderer(), Mode, SectionTextEditor(), VERDICT_ORDER, Button()

### Community 4 - "Condition & Result Rule Editor"
Cohesion: 0.07
Nodes (51): ADR-0005, ConditionRow(), condToRow(), DraftRow, emptyRow(), initialToRows(), isLegacySingle(), nextUid() (+43 more)

### Community 5 - "Phase Answers & Assignments"
Cohesion: 0.06
Nodes (52): metadata, PhaseAnswersPage(), AssigneeAvatar(), GrantExpiry(), activePhases(), currentPhase(), groupByFixedStatus(), hasRecommendedPending() (+44 more)
...
Cohesion: 0.07
Nodes (43): CancelButton(), ReopenButton(), CapaTaskList(), AnalysisStage(), SubView, Tab(), CatBlock(), CauseCard() (+35 more)

### Community 8 - "RCA Problem Stage"
Cohesion: 0.08
Nodes (31): ADR-0033, CaseAccessPanel(), ExpiryPreset, GrantDialog(), isoDaysFromNow(), isoTomorrow(), LevelOption(), ADR-0033 (+23 more)
...
Cohesion: 0.08
Nodes (41): metadata, PhaseResponderPage(), metadata, ResponderPage(), metadata, resolveImageUrls(), ReviewAndSignPage(), ADR-0061 (+33 more)
...
Cohesion: 0.08
Nodes (51): metadata, roleFromCapabilities(), StaffCaseDetailPage(), ADR-0033, ADR-0061, CaseDetailPage(), metadata, ADR-0033 (+43 more)

### Community 13 - "NSP Event Pages"
Cohesion: 0.05
Nodes (73): CommissionEventsPage(), metadata, metadata, NspEventDetailPage(), NspOrgRollups(), NspOrgRosterSummary(), CapaHeader(), CustodyHistory() (+65 more)
...
Cohesion: 0.19
Nodes (16): metadata, ReferralDetailPage(), formatDateTime(), formatFileSize(), LinkableTargetCase, ReferralDisposeDialog(), ReferralReplyView(), ReferralSnapshot() (+8 more)
...
Cohesion: 0.05
Nodes (52): metadata, MyCasesPage(), ADR-0033, CaseStatusColumn, OutcomeBreakdownRow, FilterChip(), hasOpenAssignment(), isOpenCase() (+44 more)

### Community 24 - "Auth Callback & Meeting Settings"
Cohesion: 0.06
Nodes (98): ADR-0025, InterviewFormDialog(), ActionItemRow(), AgendaItemForm(), AgendaRow(), UploadDialog(), AttendeeForm(), AttendeeMemberOption (+90 more)
...
Cohesion: 0.09
Nodes (31): CommissionReferralsPage(), deriveFlowMetrics(), metadata, ADR-0042, buildCaseReferralsModule(), NOTE: the safety-event PHI pre-fill is intentionally NOT assembled here — the, isPqsMemberSelf(), listAllReferrals() (+23 more)

### Community 27 - "Case & Phase Actions"
Cohesion: 0.11
Nodes (40): CancelCaseButton(), CreateCaseDialog(), ActionState, activatePhase(), addAdHocPhase(), AddAdHocPhaseState, authorizeCommission(), cancelCase() (+32 more)

### Community 28 - "Meeting Detail & Agenda"
Cohesion: 0.09
Nodes (31): ActionItemStatusBadge(), AttendanceBadge(), MeetingStatusBadge(), ADR-0062, ACTION_ITEM_STATUS_LABEL, ACTION_ITEM_STATUS_STYLE, ATTACHMENT_KIND_ORDER, ATTENDANCE_LABEL (+23 more)

### Community 29 - "NSP CAPA/RCA Pages"
Cohesion: 0.06
Nodes (77): CapaActionsSection(), CapaActionStatusChip(), CapaClassificationChip(), CapaSourceBadge(), CapaStatusChip(), CapaStrengthPill(), STATUS_ICON, STRENGTH_ICON (+69 more)

### Community 30 - "CAPA Evidence & Cards"
Cohesion: 0.12
Nodes (36): CapaActionCard(), MeasureRow(), addCapaAction(), addCapaActionEvidence(), addCapaActionTask(), addCapaMeasure(), advanceCapaAction(), ALLOWED_EVIDENCE_MIME (+28 more)
...
Cohesion: 0.12
Nodes (28): AcknowledgeButton(), casePatientToDraft(), EventNotifyForm(), HARM_ORDER, ADR-0038, EMPTY_PATIENT_DRAFT, PatientDraft, patientDraftHasData() (+20 more)

### Community 33 - "Submission Detail Blocks"
Cohesion: 0.07
Nodes (24): formatDateTime(), SectionBody(), SignoffMeta(), ImageItemEditor(), ImagePreview(), SECTION, ITEM_TYPE_META, ItemTypeMeta (+16 more)
...
Cohesion: 0.14
Nodes (39): FormsListPage(), metadata, CreateFormDialog(), caseAccessEnabled(), ActionState, addAdHocNarrative(), AddAdHocNarrativeState, addTemplateNarrative() (+31 more)
...
Cohesion: 0.09
Nodes (23): metadata, NarrativeEditorPage(), ADR-0033, CaseDetailLayout(), ADR-0032, ADR-0033, ADR-0038, ADR-0061 (+15 more)
...
Cohesion: 0.08
Nodes (37): CasesBoardPage(), metadata, ADR-0038, ADR-0061, ACTIVE_OR_PENDING, blockedBy(), BoardPhase, CaseKpis (+29 more)
...
Cohesion: 0.12
Nodes (22): formatDateTime(), metadata, resolveImageUrls(), SubmissionDetailPage(), SubmissionDetailView(), SubmissionsFiltersAsync(), buildAnswerMaps(), ResponseStatus (+14 more)
...
### Community 47 - "Layout"
Cohesion: 0.08
Nodes (32): OrgCommissionDetailError(), OrgManageLayout(), ADR-0051, metadata, OrgNspCoordinatorsPage(), OrgNspAdminLayout(), ADR-0052, metadata (+24 more)
...
Cohesion: 0.11
Nodes (26): metadata, OrgCommissionsPage(), ADR-0051, HospitalDetailPage(), metadata, AREAS, ManageArea, metadata (+18 more)

### Community 50 - "Page"
Cohesion: 0.10
Nodes (23): NarrativeTypeDialog(), ArchiveNarrativeTypeButton(), NarrativeTypeManager(), ADR-0032, useNarrativeAction(), BlockCard(), BlockPreview(), formatScore() (+15 more)
...
Cohesion: 0.10
Nodes (26): ConfirmRemoveButton(), TitleAssignControl(), ADR-0051, CAPABILITIES, MemberAdministrativoControls(), ADR-0061, MemberList(), ADR-0051 (+18 more)

### Community 58 - "Condition builder"
Cohesion: 0.06
Nodes (42): commissionInitials(), CommissionPickerPage(), metadata, ROLE_LABEL, slugifyHeading(), metadata, SubmissionsPage(), metadata (+34 more)
...
Cohesion: 0.11
Nodes (23): metadata, ProcessTemplatesListPage(), CreateProcessTemplateDialog(), ProcessTemplateCard(), STATUS_LABEL, STATUS_STYLES, TemplateStatusBadge(), CHOICE_ITEM_TYPES (+15 more)

### Community 62 - "VersionWithUrl"
Cohesion: 0.07
Nodes (55): asDocStatus(), asDocType(), DOC_STATUSES, DOC_TYPES, DocumentsPage(), metadata, ApproverDocumentPage(), metadata (+47 more)

### Community 63 - "UploadDialog"
Cohesion: 0.07
Nodes (43): InterviewDetailPage(), metadata, InterviewerRoleBadge(), ATTACHMENT_KIND_ORDER, INTERVIEW_STATUS_LABEL, INTERVIEW_STATUS_ORDER, INTERVIEW_STATUS_STYLE, INTERVIEWER_ROLE_LABEL (+35 more)
...
### Community 65 - "Page"
Cohesion: 0.07
Nodes (48): BlockRenderer(), OrphanWarningDialog(), choiceItem(), Harness(), section(), wizardData(), RespondentSignoff(), ReviewScreen() (+40 more)

### Community 66 - "Case tags panel"
Cohesion: 0.12
Nodes (29): CaseActionItemForm(), PhaseOption, ActionItemRow(), isItemOverdue(), STATUS_ORDER, ADR-0033, ACTION_ITEM_STATUS_LABEL, ACTION_ITEM_STATUS_STYLE (+21 more)
...
### Community 68 - "Page"
Cohesion: 0.10
Nodes (39): metadata, csvField(), GET(), toCsv(), ADR-0029, RFC-4180, CommissionAuditPage(), metadata (+31 more)
...
### Community 74 - "Page"
Cohesion: 0.09
Nodes (31): metadata, NspTriagePage(), listMeetings(), isNspCoordinatorOfHospital(), isPqsMemberOfHospital(), listNspCoordinators(), PQS_INBOX_CURSOR_SCHEMA, pqsInbox() (+23 more)
...
### Community 77 - "Page"
Cohesion: 0.06
Nodes (41): DashboardPage(), metadata, metadata, OrgOverviewPage(), CHART_COLORS, CommissionOverview(), DashboardCharts(), groupBySection() (+33 more)
...
### Community 82 - "Route"
Cohesion: 0.12
Nodes (33): EditDocumentPage(), metadata, DocumentDetailPage(), metadata, AddVersionForm(), ApprovalSignForm(), ObsoleteDocumentButton(), PublishDocumentDialog() (+25 more)

### Community 83 - "ActionItemRow"
Cohesion: 0.10
Nodes (22): DefaultValue, initialDefaultValue(), supportsDefaultValue(), FLAGGED_OPS, FlaggedWhenEditor(), OP_LABELS, ALLOW_OTHER_TYPES, BOUNDED_TYPES (+14 more)
...
### Community 93 - "Page"
Cohesion: 0.10
Nodes (32): metadata, NspConfigPage(), ADR-0052, NspReferralsDashboardPage(), metadata, NspRosterPage(), ADR-0052, NspConsoleLayout() (+24 more)
...
Cohesion: 0.09
Nodes (34): ProblemCard(), ProblemStage(), RcaStatusChip(), countDone(), deriveDone(), deriveKeyFactors(), groupFactorsByCategory(), RCA_STAGE_META (+26 more)
...
Cohesion: 0.14
Nodes (21): metadata, ADR-0061, CaseMeetingsPanel(), formatCaseNumber(), formatInterviewNumber(), interviewTitle(), InterviewModalityChip(), InterviewStatusBadge() (+13 more)

### Community 109 - "CaseTagsPanel"
Cohesion: 0.18
Nodes (17): CaseActionItemsPanel(), CaseReferralsModule, ADR-0032, ADR-0038, ADR-0061, CaseOfferedOutcomesEditor(), PickableDocument, PickableNarrative (+9 more)

### Community 110 - "DepartmentDefDialog"
Cohesion: 0.14
Nodes (40): GET(), SUCCESS_REDIRECT, assignMemberTitle(), createMemberTitle(), deleteMemberTitle(), MESSAGES, renameMemberTitle(), reorderMemberTitles() (+32 more)
...
Cohesion: 0.06
Nodes (61): IndicatorDetailPage(), metadata, IndicatorsPage(), metadata, ActionItemFallbackDialog(), CapaAffordance(), CreateManualAction, OpenCapaAction (+53 more)
...
### Community 121 - "Page"
Cohesion: 0.07
Nodes (43): MeetingDetailPage(), metadata, ActionItemsPanel(), AgendaPanel(), SignatureBadge(), MeetingMinutesEditor(), SignButton(), RosterEntry (+35 more)
...
Cohesion: 0.10
Nodes (16): createMeeting, MEMBERS, seedExpectedAttendees, seedSelectedAttendees, TYPES, updateMeeting, describeQuorumRule(), QUORUM_RULE_LABEL (+8 more)
...
### Community 146 - "Page"
Cohesion: 0.12
Nodes (18): ADR-0002, AdminLayout(), ADR-0042, metadata, OrgPickerPage(), ADR-0051, isCommissionAdmin(), CommissionAccess (+10 more)
...
Cohesion: 0.14
Nodes (24): CaseNarrativeCard(), NarrativeAssignMenu(), ADR-0032, ADR-0033, ADR-0033, AddBlockMenu(), DISPLAY_TYPES, INPUT_TYPES (+16 more)
...
### Community 229 - "Page"
Cohesion: 0.09
Nodes (30): metadata, CaseOutboundReferralsCard(), formatCaseNumber(), formatDate(), formatReferralCode(), referralStatusChipClass(), referralTypeChipClass(), ADR-0037 (+22 more)
...
Cohesion: 0.15
Nodes (16): CaseDocumentUpload(), CaseDocumentsPanel(), ADR-0033, ADR-0063, CaseEventForm(), CaseEventsTimeline(), DOC_TYPE_LABEL, EVENT_KIND_LABEL (+8 more)

### Community 246 - "Loading"
Cohesion: 0.12
Nodes (19): DocumentsLayout(), IndicatorsLayout(), PendingApprovalsLayout(), metadata, PendingApprovalsPage(), metadata, OrgDocumentsPage(), metadata (+11 more)
...
Cohesion: 0.27
Nodes (8): TOKEN_COLOR_VAR, TagReportCardAsync(), TagReportCard(), CaseTagReportRow, CaseTagRow, DateRange, getCaseTagReport(), TagReportRow

### Community 259 - "Loading"
Cohesion: 0.36
Nodes (5): AGING_BUCKETS, CHART_COLORS, daysSince(), ReferralFlowCharts(), RESOLVED_REFERRAL_STATUSES
...
Cohesion: 0.17
Nodes (13): OpenAttachmentButton(), ADR-0063, AttachmentLinkForm(), AttachmentUpload(), AttachmentsPanel(), ADR-0063, ATTACHMENT_KIND_LABEL, AttachmentUpload() (+5 more)
...
Cohesion: 0.17
Nodes (12): 🏗️ ACTIVE — S0 · Design & Sequencing Gate (Pre-Pilot Release Scope Expansion, ADR 0071), Ad-hoc (out-of-phase) — Case "Reuniões" panel · ✅ complete — merged to `main` `fbe215f` (2026-07-12), Bug Log, Completed work (archived to docs/progress/), Current Phase Tasks, Decisions, Follow-ups / Deferred Items, No active phase — F-cleanup ✅ complete (2026-07-12; on branch `f-cleanup`, awaiting human merge) (+4 more)
...
Cohesion: 0.04
Nodes (78): react, CaseOutcomeSelector(), CaseStatusBadge(), TOKEN_STYLES, MyCaseCard(), NarrativeStatus, NarrativeStatusPill(), STATUS_META (+70 more)
...
Cohesion: 0.14
Nodes (14): AddReplyAttachmentInput, AddSharedItemInput, ConcludeReferralInput, CreateReferralInput, CreateReferralState, DeclineReferralInput, LinkReferralCaseInput, ReferralActionState (+6 more)
...
Cohesion: 0.08
Nodes (24): CaseDepartmentField(), DEPARTMENTS, ADR-0061, TemplateOption, ADR-0038, NarrativeSlotDialog(), initialResultValue(), PhaseSlotDialog() (+16 more)
...
Cohesion: 0.22
Nodes (13): metadata, MyActionItemsPage(), ActionState, authorizeCommission(), CaseAccessLevel, commissionOfCase(), grantCaseAccess(), mapError() (+5 more)
...
Cohesion: 0.24
Nodes (7): ArchiveResultButton(), ResultVocabManager(), useResultAction(), PhaseSlotCard(), ADR-0032, useBuilderAction(), PhaseResult
...
Cohesion: 0.16
Nodes (10): ADR 0041 — Multi-Tenancy: organizations + hospitals above commissions, Alternatives rejected, Consequences, Context, Decision, Implementation amendments (2026-06-25), Batch context, Gate outcome (§6) (+2 more)
...
Cohesion: 0.16
Nodes (15): CommissionLayout(), ADR-0033, metadata, SignoffQueuePage(), ADR-0061, metadata, MyPhasesPage(), ADR-0033 (+7 more)

### Community 544 - "loading.tsx"
Cohesion: 0.52
Nodes (4): ConfirmDeleteButton(), ConfirmActionButton(), useInterviewAction(), AlertDialogAction()
...
Cohesion: 0.13
Nodes (15): A. Groundwork findings (verified 2026-07-13, this branch), AI (satellites + cross-link) — authored 2026-07-13, B. SQLSTATE block allocation (ratified — high-water `HC099`), C. Feature-flag plan (ratified), D. Cross-cutting conventions (recorded once — bind every track), E. Collision contracts (locked — per-track reviews are conformance checks, not re-litigation), ETH·E1 (access spine) — authored 2026-07-13 · **M2 posture = the regulatory sign-off keystone**, ETH·E2 (procedure) — authored 2026-07-13 (+7 more)
...
Cohesion: 0.07
Nodes (26): Appendix A — Polymorphism dialects (three sanctioned; closes hardening D12; ADR 0065), Appendix B — Catalog-vs-enum + freeze conventions (ADR 0065), ARCHITECTURE.md — Hospital Commission Forms Platform, Architecture Rules, This is NOT the Next.js you know, ADR 0028 — Accreditation & Quality-Governance Roadmap (Phases 13–21), Consequences, Context (+18 more)
...
## Knowledge Gaps
- **4666 isolated node(s):** `semi`, `singleQuote`, `trailingComma`, `plugins`, `$schema` (+4661 more)
...
- **Why does `createClient()` connect `DepartmentDefDialog` to `Admin & Auth Pages`, `Loading`, `Triage Disposition & Pathways`, `RCA Problem Stage`, `Form Builder Actions`, `Submission Detail (Answer Model)`, `CAPA Badges`, `NSP Event Pages`, `RCA Analysis Stage`, `Case Department Field`, `Referral Detail & Formatting`, `Org Overview Dashboard`, `Quality Indicators`, `NSP Patient Registry`, `Form Builder Page`, `Page`, `My Cases List`, `Auth Callback & Meeting Settings`, `Referral Actions & Reply`, `markdown-renderer.tsx`, `Case & Phase Actions`, `Meeting Detail & Agenda`, `NSP CAPA/RCA Pages`, `Page`, `Case Narrative Editor`, `loading.tsx`, `NSP Referrals Dashboard`, `Phase Responder & Submissions`, `Case Narrative Cards`, `Phase Result Actions`, `Admin Layout & Claims`, `Form Item Editor & Tests`, `Forms & Process Templates`, `Derived Indicator Config`, `Meeting Attendees & Quorum`, `loading.tsx`, `Event Notification & Triage`, `case-phase-result.spec.ts`, `Layout`, `loading.tsx`, `result-actions.ts`, `IsTerminalMeetingStatus`, `Page`, `Page`, `0066 — patient_xref case-module grain re-keyed to the patient participant`, `TitleAssignControl`, `Condition builder`, `CaseActionItemForm`, `case-narratives.spec.ts`, `VersionWithUrl`, `UploadDialog`, `ADR 0030 — Patient-Safety PHI Posture Reversal & PQS/NSP Module Architecture (Phase 14)`, `Case tags panel`, `Page`, `Wizard runner`, `Page`, `Page`, `Route`, `CaseActionItemsPanel`, `Audit icon`, `Page`, `Page`, `Referral patient fields`, `0012 — clone_form_version returns the existing draft (one draft per form)`, `Outcomes actions`, `CaseTagsPanel`, `loading.tsx`, `loading.tsx`, `CAPA Evidence & Cards`, `Loading`, `Loading`, `Browser`, `Page`, `ADR 0028`?**
  _High betweenness centrality (0.063) - this node is a cross-community bridge._
- **Why does `cn()` connect `QA Review — Phase B: NSP-per-hospital + `nsp_org_admin`` to `3.14 `forms.block_library_items``, `Case Lifecycle Actions`, `Shared UI & Phase Dialogs`, `Loading`, `Admin & Auth Pages`, `Phase Answers & Assignments`, `Error & Not-Found Boundaries`, `Condition & Result Rule Editor`, `RCA Problem Stage`, `4.4 `form_responses.form_repeating_group_instances``, `Case Documents`, `Triage Disposition & Pathways`, `CAPA Badges`, `NSP Event Pages`, `loading.tsx`, `My Cases List`, `Auth Callback & Meeting Settings`, `Phase 14b–14d — Patient-Safety / NSP: Triage, RCA & CAPA`, `Meeting Detail & Agenda`, `NSP CAPA/RCA Pages`, `loading.tsx`, `Submission Detail Blocks`, `loading.tsx`, `Forms & Process Templates`, `Meeting Attendees & Quorum`, `Narrative Templates`, `Layout`, `Page`, `TitleAssignControl`, `Condition builder`, `CaseActionItemForm`, `VersionWithUrl`, `UploadDialog`, `Page`, `Case tags panel`, `Page`, `Page`, `Loading`, `Avatar stack`, `ActionItemRow`, `CaseActionItemsPanel`, `Page`, `0012 — clone_form_version returns the existing draft (one draft per form)`, `Actions`, `Page`, `Page`, `Audit motion`, `loading.tsx`, `Page`, `Loading`, `Browser`, `Loading`, `Page`, `ADR 0028`?**
  _High betweenness centrality (0.042) - this node is a cross-community bridge._
- **Why does `Page` connect `Staff Case Detail` to `phase22-referrals.spec.ts`, `phase8-dashboard.spec.ts`, `4.10 `form_responses.form_answer_revisions``, `phase14b-triage.spec.ts`, `Page`, `recommend-result.spec.ts`, `My Cases List`, `NSP Referrals Dashboard`, `Page`, `flagged-aggregate-result.spec.ts`, `phase7-cases.spec.ts`, `cases-outcomes-blockers.spec.ts`, `nsp-per-hospital.spec.ts`, `phase14c-rca.spec.ts`, `phase14d-capa.spec.ts`, `form-model-normalization.spec.ts`, `phase15-indicators.spec.ts`, `phi-remediation.spec.ts`, `Event Notification & Triage`, `Interview badges`, `Page`, `case-meetings-panel.spec.ts`, `Event type manager`, `form-builder-enhancements.spec.ts`, `Page`, `Case document delete`, `ad-hoc-narratives.spec.ts`, `administrativo.spec.ts`, `member-action-items-overview.spec.ts`, `phase13-audit.spec.ts`, `Loading`, `Increment Archive — Case Access Control & "Meus Casos"`, `Format`, `Loading`, `Page`, `case-patient.spec.ts`, `cases-extras.spec.ts`, `cases-meetings-minor.spec.ts`, `patient-index.spec.ts`, `phase14a-safety-events.spec.ts`?**
  _High betweenness centrality (0.040) - this node is a cross-community bridge._
- **What connects `semi`, `singleQuote`, `trailingComma` to the rest of the system?**
  _4826 weakly-connected nodes found - possible documentation gaps or missing edges._
...
- **Should `Shared UI & Phase Dialogs` be split into smaller, more focused modules?**
  _Cohesion score 0.07339243631466727 - nodes in this community are weakly interconnected._
