# Graph Report - hospital_form_platform  (2026-07-14)

## Corpus Check
- 1372 files · ~1,794,653 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 9949 nodes · 20744 edges · 1472 communities (585 shown, 887 thin omitted)
- Extraction: 100% EXTRACTED · 0% INFERRED · 0% AMBIGUOUS · INFERRED: 90 edges (avg confidence: 0.69)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `c3cbd0fd`
...
- `signOut()` --references--> `Page`  [EXTRACTED]
  e2e/administrativo.spec.ts → src/lib/types/pagination.ts
- `signInAs()` --references--> `Page`  [EXTRACTED]
  e2e/case-access.spec.ts → src/lib/types/pagination.ts
...
## Communities (1472 total, 887 thin omitted)

### Community 0 - "Case Lifecycle Actions"
Cohesion: 0.13
Nodes (31): ADR-0033, ObsoleteAction, ConfirmDeleteButton(), ConfirmActionButton(), ADR-0070, SessionConfirmButton(), ADR-0070, useInterviewAction() (+23 more)

### Community 1 - "Admin & Auth Pages"
Cohesion: 0.05
Nodes (70): AdminOrganizationsPage(), metadata, metadata, metadata, metadata, metadata, CommissionEditForm(), StaffAdminManager() (+62 more)

### Community 2 - "Shared UI & Phase Dialogs"
Cohesion: 0.08
Nodes (60): BannerTone, FormBanner(), toneStyles, ActivatePhaseDialog(), defaultDueDateValue(), ACCEPT, DOC_TYPES, EVENT_KINDS (+52 more)

### Community 3 - "Error & Not-Found Boundaries"
Cohesion: 0.33
Nodes (4): ProblemCard(), ProblemStage(), updateRca(), UpdateRcaInput
...
Cohesion: 0.13
Nodes (17): ArchiveResultButton(), ResultVocabManager(), useResultAction(), AddBlockMenu(), BlockCard(), BlockList(), BuilderHeader(), BuilderShell() (+9 more)

### Community 6 - "Triage Disposition & Pathways"
Cohesion: 0.08
Nodes (55): DispositionRail(), NON_RCA_PATHWAYS, Pill(), VerdictBlock(), HARM_DEFINITIONS, HarmScale(), REACH_DEFINITIONS, ReachSpectrum() (+47 more)

### Community 7 - "Case Documents"
Cohesion: 0.09
Nodes (31): CONDITION_TARGET_TYPES, isEligibleTarget(), newQuestionConditionTargets(), questionConditionTargets(), sectionConditionTargets(), toTarget(), DefaultValue, DefaultValueEditor() (+23 more)
...
Cohesion: 0.12
Nodes (22): metadata, resolveImageUrls(), ReviewAndSignPage(), ADR-0061, inputItem(), response(), section(), tree() (+14 more)
...
Cohesion: 0.05
Nodes (62): ADR-0005, SectionConditionFields(), AGGREGATE_OPS, aggregateKeyFor(), AllowedResultsPicker(), AutomaticEditor(), Criterion, criterionForKey() (+54 more)

### Community 13 - "NSP Event Pages"
Cohesion: 0.07
Nodes (40): metadata, CapaClosurePanel(), CapaEffectivenessPanel(), CustodyHistory(), EventStatusChip(), OwnerChip(), STATUS_ICON, SuspectedHarmChip() (+32 more)

### Community 14 - "RCA Analysis Stage"
Cohesion: 0.12
Nodes (31): CatBlock(), CauseCard(), RootCard(), RootsStage(), padSteps(), WhyChainCard(), mapRcaError(), addRcaEvidence() (+23 more)
...
Cohesion: 0.12
Nodes (16): AnswerSummary(), formatIsoDate(), renderValue(), CheckboxGroup(), ChoiceGroup(), formatBoundsHint(), InputItem, NumberItem() (+8 more)

### Community 17 - "Staff Case Detail"
Cohesion: 0.04
Nodes (41): createForm(), enterWizardByTitle(), openAddBlock(), publishForm(), purge(), signInAs(), sql(), ADR-0045 (+33 more)

### Community 18 - "Org Overview Dashboard"
Cohesion: 0.04
Nodes (41): Appendix A — Polymorphism dialects (three sanctioned; closes hardening D12; ADR 0065), Appendix B — Catalog-vs-enum + freeze conventions (ADR 0065), ARCHITECTURE.md — Hospital Commission Forms Platform, Architecture Rules, This is NOT the Next.js you know, ADR 0009 — Local JWT verification for the auth gate & identity, Consequences, Context (+33 more)

### Community 19 - "Quality Indicators"
Cohesion: 0.10
Nodes (25): DerivedConfigPicker(), allowedSources(), BuilderFields(), COMPARATORS, ControlledState, CreateAction, DIRECTIONS, FREQUENCIES (+17 more)
...
Cohesion: 0.09
Nodes (29): CommissionEventsPage(), metadata, metadata, OrgNspCoordinationPage(), ADR-0052, metadata, ADR-0042, metadata (+21 more)
...
Cohesion: 0.05
Nodes (55): metadata, NarrativeEditorPage(), ADR-0033, CaseNarrativeCard(), CasePhaseList(), ADR-0032, ADR-0033, ADR-0061 (+47 more)

### Community 24 - "Auth Callback & Meeting Settings"
Cohesion: 0.11
Nodes (60): GET(), SUCCESS_REDIRECT, LegacyMeetingsSettingsPage(), ActionItemRow(), UploadDialog(), MeetingLifecycleActions(), addMeetingAttendee(), advanceMeetingActionItem() (+52 more)

### Community 25 - "Referral Actions & Reply"
Cohesion: 0.10
Nodes (42): ReferralActions(), ComposerMode, ComposerModeKey, ReferralComposer(), ADR-0037, getReferralPatient(), acceptReferral(), addReferralReplyAttachment() (+34 more)

### Community 26 - "NSP Referrals Dashboard"
Cohesion: 0.08
Nodes (38): deriveFlowMetrics(), metadata, NspReferralsDashboardPage(), ADR-0042, AGING_BUCKETS, CHART_COLORS, daysSince(), ReferralFlowCharts() (+30 more)

### Community 27 - "Case & Phase Actions"
Cohesion: 0.14
Nodes (34): AddAdHocPhaseDialog(), CreateCaseDialog(), ActionState, activatePhase(), addAdHocPhase(), AddAdHocPhaseState, authorizeCommission(), cancelCase() (+26 more)

### Community 28 - "Meeting Detail & Agenda"
Cohesion: 0.19
Nodes (11): metadata, AddVersionForm(), ApprovalSignForm(), DocumentVersionsList(), VersionWithUrl, ObsoleteDocumentButton(), PublishDocumentDialog(), SubmitForApprovalForm() (+3 more)

### Community 29 - "NSP CAPA/RCA Pages"
Cohesion: 0.14
Nodes (14): CancelCaseButton(), ADR-0032, ConcludeNarrativeButton(), ConfirmDeleteButton(), CoordinatorPhaseActions(), DetailPhase, ADR-0033, ADR-0061 (+6 more)

### Community 30 - "CAPA Evidence & Cards"
Cohesion: 0.03
Nodes (140): isOverdue(), localTodayYmd(), MyCapaActionsPage(), ADR-0076, ADR-0033, AddVersionAction, MarkdownRenderer(), Mode (+132 more)

### Community 31 - "Case Narrative Editor"
Cohesion: 0.09
Nodes (53): metadata, roleFromCapabilities(), StaffCaseDetailPage(), ADR-0033, ADR-0061, CaseDetailLayout(), CaseDetailPage(), metadata (+45 more)
...
Cohesion: 0.10
Nodes (21): CasesBoardPage(), metadata, ADR-0038, ADR-0061, metadata, ProcessTemplatesListPage(), computeOutcomeBreakdown(), CasesViewMode (+13 more)

### Community 34 - "Phase Responder & Submissions"
Cohesion: 0.12
Nodes (43): UploadDialog(), InterviewLifecycleActions(), isTerminalSession(), SessionActions(), ActionState, AddInterviewerState, addInterviewInterviewer(), addInterviewLink() (+35 more)

### Community 35 - "Case Narrative Cards"
Cohesion: 0.15
Nodes (37): metadata, MyActionItemsPage(), AddAdHocNarrativeDialog(), caseAccessEnabled(), addAdHocNarrative(), addTemplateNarrative(), archiveNarrativeType(), assignNarrative() (+29 more)
...
Cohesion: 0.09
Nodes (28): metadata, ProcessTemplateBuilderPage(), CaseOutcomesSettingsPage(), metadata, metadata, metadata, PhaseResultsSettingsPage(), metadata (+20 more)

### Community 38 - "Interview & Agenda Forms"
Cohesion: 0.10
Nodes (33): metadata, PrimeiroAcessoPage(), OrgCommissionDetailError(), HospitalDetailPage(), metadata, OrgNspAdminLayout(), ADR-0052, Home() (+25 more)
...
Cohesion: 0.05
Nodes (62): StatCount(), ACTIVE_OR_PENDING, activePhases(), blockedBy(), BoardPhase, CaseKpis, CaseStatusColumn, computeCaseKpis() (+54 more)
...
Cohesion: 0.07
Nodes (60): CaseTimelinePage(), metadata, timelineResultToResolved(), AvatarStack(), CaseTimeline(), DAY_MONTH, DERIVED_PILL, durationSuffix() (+52 more)

### Community 44 - "Event Notification & Triage"
Cohesion: 0.11
Nodes (24): CommissionReferralsPage(), isNspCoordinatorOfHospital(), isPqsMemberOfHospital(), listNspCoordinators(), PQS_INBOX_CURSOR_SCHEMA, PqsInboxCursor, PqsInboxRow, NOTE: the no-arg `is_pqs_member_self()` (in `referrals.ts`) is KEPT as the (+16 more)
...
### Community 48 - "Page"
Cohesion: 0.10
Nodes (35): CaseActionItemForm(), PhaseOption, STATUS_ORDER, ADR-0033, ADR-0032, ADR-0033, ADR-0033, DISPLAY_TYPES (+27 more)

### Community 49 - "IsTerminalMeetingStatus"
Cohesion: 0.10
Nodes (29): metadata, OrgCommissionsPage(), ADR-0051, AREAS, ManageArea, metadata, OrgManageHomePage(), ADR-0051 (+21 more)
...
### Community 53 - "Page"
Cohesion: 0.18
Nodes (17): RootCauseTypePill(), STATUS_CLASS, CATEGORY_VISUAL, CLASSIFICATION_SELECTED, CLASSIFICATIONS, setRcaRootCauseClassification(), updateRcaRootCause(), FISHBONE_CATEGORY_LABELS (+9 more)

### Community 54 - "Section signoff fields"
Cohesion: 0.09
Nodes (41): item(), BlockRenderer(), CHOICE_TYPES, computeEffectiveVisibility(), EffectiveVisibility, INPUT_ITEM_TYPES, INPUT_TYPES, isChoiceItem() (+33 more)

### Community 55 - "ListMeetings"
Cohesion: 0.09
Nodes (37): InterviewModalityChip(), SessionStatusBadge(), SessionTypeChip(), InterviewFormDialog(), NewInterviewButton(), ATTACHMENT_KIND_ORDER, CONFIDENTIALITY_LABEL, CONFIDENTIALITY_ORDER (+29 more)
...
Cohesion: 0.07
Nodes (38): ManageMembersPage(), metadata, ADR-0061, ConfirmRemoveButton(), TitleAssignControl(), ADR-0051, AddMemberDialog(), CAPABILITIES (+30 more)
...
### Community 60 - "Page"
Cohesion: 0.16
Nodes (16): ADR-0025, AgendaItemForm(), AgendaPanel(), AgendaRow(), AttendeeForm(), AttendeeMemberOption, AttendeeRow(), AttendeesPanel() (+8 more)

### Community 61 - "CaseActionItemForm"
Cohesion: 0.05
Nodes (50): AssigneeAvatar(), LevelOption(), NarrativeAssignMenu(), initials(), ResultDefDialog(), TagDefDialog(), TagManager(), TitleBadge() (+42 more)

### Community 62 - "VersionWithUrl"
Cohesion: 0.07
Nodes (28): formatDateTime(), SectionBody(), SignoffMeta(), SubmissionDetailView(), BlockConditionNote(), BlockPreview(), formatScore(), buildOptionLabelMap() (+20 more)
...
### Community 65 - "Page"
Cohesion: 0.13
Nodes (20): SectionSignoffFields(), RespondentSignoff(), ReviewScreen(), ReviewSection(), WizardData, formatDate(), RespondentContext(), SectionBody() (+12 more)

### Community 66 - "Case tags panel"
Cohesion: 0.10
Nodes (24): react, ADR-0033, CaseAccessPanel(), ExpiryPreset, GrantDialog(), isoDaysFromNow(), isoTomorrow(), ADR-0033 (+16 more)
...
### Community 77 - "Page"
Cohesion: 0.18
Nodes (23): CapaStage(), countDone(), deriveDone(), deriveKeyFactors(), groupFactorsByCategory(), RCA_STAGE_META, RCA_STAGE_ORDER, rcaCanEdit() (+15 more)
...
Cohesion: 0.13
Nodes (16): ConditionRow(), condToRow(), DraftRow, emptyRow(), initialToRows(), isLegacySingle(), nextUid(), RecommendWhenEditor() (+8 more)
...
### Community 82 - "Route"
Cohesion: 0.07
Nodes (36): GrantExpiry(), CaseDocumentUpload(), CaseDocumentsPanel(), ADR-0033, ADR-0063, DOC_TYPE_LABEL, CasePatientPanel(), CasePhaseArticle() (+28 more)
...
### Community 93 - "Page"
Cohesion: 0.12
Nodes (26): asDocStatus(), asDocType(), DOC_STATUSES, DOC_TYPES, DocumentsPage(), metadata, DocStatus, DocType (+18 more)
...
### Community 96 - "Page"
Cohesion: 0.12
Nodes (28): metadata, NspConfigPage(), ADR-0052, metadata, NspRosterPage(), ADR-0052, NspEventDetailPage(), NspConsoleLayout() (+20 more)
...
Cohesion: 0.07
Nodes (48): metadata, PhaseResponderPage(), metadata, NewCommissionEventPage(), metadata, ResponderPage(), FormsListPage(), metadata (+40 more)
...
Cohesion: 0.19
Nodes (13): csvField(), GET(), toCsv(), ADR-0020, ADR-0029, RFC-4180, AuditAccessAction, auditClinicalView() (+5 more)

### Community 105 - "Page"
Cohesion: 0.14
Nodes (16): ReviewOverdueChip(), STATUS_CLASSES, DOC_STATUSES, DOC_TYPES, DocumentFilterBar(), ReviewDueList(), APPROVAL_DECISION_LABELS, ApprovalDecision (+8 more)

### Community 106 - "Outcomes actions"
Cohesion: 0.18
Nodes (13): OpenAttachmentButton(), ADR-0063, AttachmentLinkForm(), AttachmentUpload(), AttachmentsPanel(), ADR-0063, ATTACHMENT_KIND_LABEL, AttachmentsPanel() (+5 more)
...
Cohesion: 0.17
Nodes (11): CaseNarrativesBuilderPage(), metadata, ADR-0032, FormsListPage(), metadata, ConstrutorTabs(), CreateFormDialog(), FormCard() (+3 more)

### Community 110 - "DepartmentDefDialog"
Cohesion: 0.11
Nodes (22): referralStatusChipClass(), referralTypeChipClass(), ReferralDirectionChip(), ReferralMessageTypeChip(), ReferralStatusChip(), ReferralTypeChip(), ResponseExpectedChip(), STATUS_ICON (+14 more)
...
Cohesion: 0.13
Nodes (19): ADR-0032, ADR-0033, ADR-0038, ADR-0061, CaseAccessButton(), CaseLifecycleActions(), EditCaseMetaDialog(), NotifyEventDialog() (+11 more)
...
### Community 121 - "Page"
Cohesion: 0.06
Nodes (51): MeetingsSettingsTabPage(), metadata, MeetingDetailPage(), metadata, ActionItemsPanel(), AttachmentUpload(), ADR-0063, CaseLinker() (+43 more)
...
Cohesion: 0.07
Nodes (38): CaseDepartmentField(), DEPARTMENTS, ADR-0061, CasePatientEditDialog(), ADR-0038, TemplateOption, ADR-0038, OutcomeMultiselect() (+30 more)

### Community 125 - "Format"
Cohesion: 0.21
Nodes (13): SessionForm(), toDateTimeLocalValue(), HeldWindowFields(), isFuture(), localToIso(), ADR-0062, useHeldWindowState(), MeetingFormDialog() (+5 more)
...
Cohesion: 0.07
Nodes (43): BuilderPage(), metadata, resolveImageUrls(), DATE_FMT, metadata, resolveImageUrls(), VersionsPage(), PublishedReadOnly() (+35 more)
...
Cohesion: 0.04
Nodes (27): 0010 — Denormalize email onto public.profiles, Consequences, Context, Decision, Options considered, ADR 0021 — Due dates for case phases, Consequences, Context (+19 more)
...
### Community 158 - "Page"
Cohesion: 0.10
Nodes (22): CommissionLayout(), ADR-0033, metadata, SignoffQueuePage(), ADR-0061, metadata, MyCasesPage(), ADR-0033 (+14 more)

### Community 159 - "OrgAuditPage"
Cohesion: 0.12
Nodes (13): ADR-0026, addSubjectRpc(), callRPC(), completeSessionRpc(), confirmLifecycle(), createInterviewRpc(), goToCaseDetail(), goToInterview() (+5 more)
...
Cohesion: 0.07
Nodes (29): ADR-0002, commissionInitials(), CommissionPickerPage(), metadata, ROLE_LABEL, slugifyHeading(), metadata, SubmissionsPage() (+21 more)
...
Cohesion: 0.22
Nodes (9): buildCards(), CommissionHomePage(), formatNextMeeting(), metadata, OverviewCardData, getMemberOverview(), MemberOverview, MemberOverviewJson (+1 more)
...
Cohesion: 0.05
Nodes (52): formatDateTime(), metadata, resolveImageUrls(), SubmissionDetailPage(), CorrectSubmissionButton(), formatDateTime(), SubmissionRow(), SubmissionsFiltersAsync() (+44 more)
...
### Community 229 - "Page"
Cohesion: 0.12
Nodes (27): metadata, ReferralDetailPage(), formatCaseNumber(), formatDate(), formatDateTime(), formatFileSize(), formatReferralCode(), ADR-0037 (+19 more)
...
Cohesion: 0.12
Nodes (13): 0068 — Case-phase result engine: jsonb/array → FK-backed junctions (D3), Consequences, Context, Decision, 0069 — Anglicize status-enum internal keys (D11), Consequences, Context, Decision (+5 more)
...
Cohesion: 0.08
Nodes (46): ActionItemRow(), isItemOverdue(), CaseDocumentDelete(), UploadDialog(), CaseEventForm(), CaseEventsTimeline(), ACTION_ITEM_STATUS_LABEL, ACTION_ITEM_STATUS_STYLE (+38 more)
...
Cohesion: 0.07
Nodes (37): AccountLayout(), ADR-0076, DocumentsLayout(), IndicatorsLayout(), PendingApprovalsLayout(), metadata, PendingApprovalsPage(), metadata (+29 more)
...
Cohesion: 0.18
Nodes (14): IndicatorsPage(), metadata, formatPeriodLabel(), IndicatorKindBadge(), MeasurementStatusChip(), STATUS_STYLES, IndicatorList(), ChartDataTable() (+6 more)
...
Cohesion: 0.21
Nodes (11): OrgAuditPage(), AuditListRow, AuditLogEntry, listAuditForHospital(), listAuditForOrg(), mapAuditRow(), ADR-0030, ADR-0038 (+3 more)
...
Cohesion: 0.15
Nodes (13): 🏗️ ACTIVE — S2 · Pilot cores + E1 prerequisites (Pre-Pilot Release Scope Expansion, ADR 0071), Ad-hoc (out-of-phase) — Case "Reuniões" panel · ✅ complete — merged to `main` `fbe215f` (2026-07-12), Bug Log, ✅ COMPLETE — S1 substrate & ✅ SIGNED OFF — S0 gate (records rotated out), Completed work (archived to docs/progress/), Current Phase Tasks, Decisions, Follow-ups / Deferred Items (+5 more)
...
Cohesion: 0.09
Nodes (28): TOKEN_COLOR_VAR, TOKEN_STYLES, TOKEN_NAME, TOKENS, OutcomeDefDialog(), blankOption(), COLOR_TOKENS, hasMetadata() (+20 more)
...
Cohesion: 0.14
Nodes (18): EMPTY_REFERRAL_PATIENT_DRAFT, ReferralPatientDraft, referralPatientDraftHasData(), referralPatientDraftToInput(), ReferralPatientFields(), SEX_ORDER, ADR-0037, NOTE: removal is a hub-draft affordance in v1; here we only ADD. Toggling (+10 more)
...
Cohesion: 0.17
Nodes (15): IndicatorDetailPage(), metadata, isPqsOperatorOfIndicatorHospital(), ADR-0057, formatTarget(), RunChart, RunChartLoader(), DATA_SOURCE_LABELS (+7 more)

### Community 489 - "21. Recommended Dashboard Views"
Cohesion: 0.20
Nodes (17): DocumentDetailPage(), ApproverDocumentPage(), metadata, ApprovalDecisionBadge(), ApprovalsPanel(), DocumentStatusChip(), DocumentTypeBadge(), DocumentRegisterList() (+9 more)
...
Cohesion: 0.05
Nodes (44): ADR 0030 — Patient-Safety PHI Posture Reversal & PQS/NSP Module Architecture (Phase 14), Consequences, Context, Decision, ADR 0031 — Event Custody Ledger, Access-Follows-Custody RLS & PHI Isolation (Phase 14a), Alternatives considered, Consequences, Context (+36 more)
...
Cohesion: 0.28
Nodes (7): AdminLayout(), ADR-0042, metadata, OrgPickerPage(), ADR-0051, OrganizationRef, requireUser()
...
Cohesion: 0.31
Nodes (8): csvField(), GET(), toCsv(), ADR-0029, RFC-4180, AUDIT_ACTION_LABELS, AuditFilters, listAudit()
...
Cohesion: 0.28
Nodes (6): AnalysisStage(), SubView, Tab(), Fishbone(), WhysPanel(), FISHBONE_CATEGORY_ORDER
...
Cohesion: 0.17
Nodes (18): CaseActionItemsPanel(), CaseReferralsModule, ADR-0032, ADR-0038, ADR-0061, CaseOfferedOutcomesEditor(), CaseOutcomeSelector(), CaseOutboundReferralsCard() (+10 more)
...
Cohesion: 0.22
Nodes (6): CreateAction, DOC_TYPES, UpdateAction, ActionState, AddVersionState, CreateDocumentState
...
Cohesion: 0.29
Nodes (7): EvidenceCitationForm(), EvidenceLinkForm(), EvidenceUpload(), EvidenceRow(), RcaEvidencePanel(), deleteRcaEvidence(), EVIDENCE_KIND_LABELS

### Community 707 - "0066 — patient_xref case-module grain re-keyed to the patient participant"
Cohesion: 0.12
Nodes (20): metadata, OrgAdministratorsPage(), ADR-0051, ADR-0052, metadata, OrgHospitalsPage(), HospitalList(), OrgCommissionList() (+12 more)
...
### Community 943 - "32. Implementation Phases"
Cohesion: 0.13
...
### Community 945 - ""Sem processo" — process-less case creation (`processless_cases`)"
Cohesion: 0.40
Nodes (5): 5.4 `referral_assignments`, Columns, Design rationale, Suggested assignment roles, Suggested assignment statuses

### Community 946 - "Result-based phase recommendation — `recommend_when` answer/result groups (✅ COMPLETE 2026-06-26)"
Cohesion: 0.33
...
### Community 947 - "sup-supersession.spec.ts"
Cohesion: 0.38
Nodes (5): MyCaseCard(), FilterChip(), hasOpenAssignment(), isOpenCase(), MyCasesFilter()

### Community 948 - "ADR 0005 — `visible_when` condition shape (v1)"
Cohesion: 0.40
...
### Community 1439 - "ADR 0015 — Response-fill RPCs (atomic section save + get-or-resume)"
Cohesion: 0.29
Nodes (6): ActionItemFallbackDialog(), CapaAffordance(), CreateManualAction, OpenCapaAction, IndicatorMeasurement, CAPA_STATUS_LABELS
...
### Community 1441 - "ADR 0017 — Multi-Phase Cases"
Cohesion: 0.33
...
### Community 1444 - "ADR 0032 — Case Narratives (per-case prose interleaved with phases)"
Cohesion: 0.33
...
Cohesion: 0.53
Nodes (4): EditDocumentPage(), metadata, selectSignableVersion(), selectWorkingDraft()

### Community 1449 - "Phase B — NSP-per-hospital + `nsp_org_admin` — completed phase record"
Cohesion: 0.53
Nodes (5): AuditFeed(), getServerSnapshot(), getSnapshot(), subscribe(), useClientNow()

### Community 1450 - "loading.tsx"
Cohesion: 0.40
Nodes (4): VocabDefDialog(), VocabEntry, ArchiveVocabButton(), ManagedVocabEntry
...
### Community 1456 - "ADR 0019 — The default (anchor) section may carry a title"
Cohesion: 0.40
Nodes (4): ADR 0019 — The default (anchor) section may carry a title, Consequences, Context, Decision

### Community 1457 - "11. Domain Services and Transaction Boundaries"
Cohesion: 0.40
...
### Community 1458 - "17. Suggested Repository and Service Boundaries"
Cohesion: 0.40
...
### Community 1459 - "loading.tsx"
Cohesion: 0.50
Nodes (4): ENTITY_ICON, EntityIcon(), resolveEntityIcon(), AuditEntityType

### Community 1460 - "rca-team-panel.tsx"
Cohesion: 0.50
Nodes (4): RcaMemberRoleBadge(), MemberRow(), RcaTeamPanel(), removeRcaMember()

### Community 1461 - "0044 — Process-less cases ("Sem processo")"
Cohesion: 0.50
Nodes (4): 0044 — Process-less cases ("Sem processo"), Consequences, Context, Decisions

### Community 1462 - "Phase 22 — Inter-Committee Case Referrals (`case_referrals`)"
Cohesion: 0.50
Nodes (4): Lead notes, Phase 22 — Inter-Committee Case Referrals (`case_referrals`), Summary, Tasks

### Community 1464 - "loading.tsx"
Cohesion: 0.67
...
### Community 1466 - "27. Example: Simple Action Item"
Cohesion: 0.67
...
### Community 1474 - "28. Example: Complex Action Item"
Cohesion: 0.18
...
Cohesion: 0.03
Nodes (8): AcknowledgeButton(), CapaTaskList(), RcaConfirmDelete(), RcaTimelinePanel(), TimelineEntryDialog(), toLocalInput(), useSafetyAction(), Button()

### Community 1478 - "not-found.tsx"
Cohesion: 0.50
Nodes (4): 13.1 `interview_statements`, 13. Statements, Design rationale, Provenance requirement

### Community 1479 - "Phase 22 — Inter-Committee Case Referrals (`case_referrals`)"
Cohesion: 0.67
Nodes (3): 27. Example: Simple Action Item, Scenario, Tables Used

## Knowledge Gaps
- **4791 isolated node(s):** `semi`, `singleQuote`, `trailingComma`, `plugins`, `$schema` (+4786 more)
  These have ≤1 connection - possible missing edges or undocumented components.
- **887 thin communities (<3 nodes) omitted from report** — run `graphify query` to explore isolated nodes.

## Suggested Questions
_Questions this graph is uniquely positioned to answer:_

- **Why does `createClient()` connect `Auth Callback & Meeting Settings` to `Admin & Auth Pages`, `Error & Not-Found Boundaries`, `Triage Disposition & Pathways`, `RCA Problem Stage`, `Form Builder Actions`, `Submission Detail (Answer Model)`, `CAPA Badges`, `RCA Analysis Stage`, `Case Department Field`, `NSP Patient Registry`, `Form Builder Page`, `My Cases List`, `Referral Actions & Reply`, `NSP Referrals Dashboard`, `loading.tsx`, `Case & Phase Actions`, `0068 — Case-phase result engine: jsonb/array → FK-backed junctions (D3)`, `CAPA Evidence & Cards`, `Case Narrative Editor`, `Form Item Editor & Tests`, `Submission Detail Blocks`, `Phase Responder & Submissions`, `Case Narrative Cards`, `Phase Result Actions`, `Admin Layout & Claims`, `Interview & Agenda Forms`, `loading.tsx`, `Forms & Process Templates`, `loading.tsx`, `Event Notification & Triage`, `Layout`, `loading.tsx`, `IsTerminalMeetingStatus`, `Page`, `Page`, `Page`, `TitleAssignControl`, `UploadDialog`, `Page`, `Wizard runner`, `Page`, `ActionItemRow`, `CaseActionItemsPanel`, `Page`, `Page`, `Referral patient fields`, `Actions`, `Outcomes actions`, `loading.tsx`, `CaseTagsPanel`, `Browser`, `Page`, `Page`, `ConfirmDeleteButton`, `ADR 0028`, `Meeting form dialog.test`, `Page`, `Page`, `Phase result options`, `0058 — Derived quality-indicator measurement compute (the parity lock)`, `0066 — patient_xref case-module grain re-keyed to the patient participant`, `AuditFeed`, `Avatar stack`, `Audit icon`, `Page`, `Loading`, `Loading`, `flagged-aggregate-result.spec.ts`, `case-phase-result.spec.ts`, `result-actions.ts`, `case-narratives.spec.ts`, `QA Review — Form Builder Enhancements (mini-phase)`, `QA Review — Phase B: NSP-per-hospital + `nsp_org_admin``, `Lead Playbook — orchestration protocol (lead only)`, `Quality-Track Context — Accreditation & Quality Governance (Phases 13–21)`, `rca-team-panel.tsx`, `0066 — patient_xref case-module grain re-keyed to the patient participant`, `0013 — Fix form_versions INSERT RLS self-reference`, `ADR 0030 — Patient-Safety PHI Posture Reversal & PQS/NSP Module Architecture (Phase 14)`, `0012 — clone_form_version returns the existing draft (one draft per form)`, `ADR 0033 — Case Access Control (per-case read/write grants, attribution-driven access & "Meus Casos")`, `21. Recommended Dashboard Views`?**
  _High betweenness centrality (0.077) - this node is a cross-community bridge._
- **Why does `Page` connect `Staff Case Detail` to `phase22-referrals.spec.ts`, `phase8-dashboard.spec.ts`, `phase14b-triage.spec.ts`, `Page`, `recommend-result.spec.ts`, `My Cases List`, `NSP Referrals Dashboard`, `Page`, `OrgAuditPage`, `phase7-cases.spec.ts`, `cases-outcomes-blockers.spec.ts`, `nsp-per-hospital.spec.ts`, `phase14c-rca.spec.ts`, `phase14d-capa.spec.ts`, `form-model-normalization.spec.ts`, `phase15-indicators.spec.ts`, `phi-remediation.spec.ts`, `Event Notification & Triage`, `Interview badges`, `ADR 0041 — Multi-Tenancy: organizations + hospitals above commissions`, `Phase B — NSP-per-hospital + `nsp_org_admin` — completed phase record`, `Event type manager`, `form-builder-enhancements.spec.ts`, `loading.tsx`, `Case document delete`, `Audit icon`, `ad-hoc-narratives.spec.ts`, `administrativo.spec.ts`, `member-action-items-overview.spec.ts`, `phase13-audit.spec.ts`, `F-cleanup — residual DB-hardening (durable record)`, `Page`, `Increment Archive — Case Access Control & "Meus Casos"`, `Loading`, `Page`, `case-patient.spec.ts`, `cases-extras.spec.ts`, `cases-meetings-minor.spec.ts`, `patient-index.spec.ts`, `phase14a-safety-events.spec.ts`?**
  _High betweenness centrality (0.051) - this node is a cross-community bridge._
- **Why does `cn()` connect `CaseActionItemForm` to `Case Lifecycle Actions`, `Admin & Auth Pages`, `Shared UI & Phase Dialogs`, `Error & Not-Found Boundaries`, `Phase Answers & Assignments`, `Triage Disposition & Pathways`, `Case Documents`, `Meeting form dialog.test`, `CAPA Badges`, `NSP Event Pages`, `RCA Analysis Stage`, `Case Department Field`, `Referral Detail & Formatting`, `Page`, `QA Review — Phase B: NSP-per-hospital + `nsp_org_admin``, `Form Builder Page`, `Auth Callback & Meeting Settings`, `NSP CAPA/RCA Pages`, `CAPA Evidence & Cards`, `loading.tsx`, `Submission Detail Blocks`, `loading.tsx`, `flagged-aggregate-result.spec.ts`, `Admin Layout & Claims`, `Interview & Agenda Forms`, `Meeting Attendees & Quorum`, `loading.tsx`, `Narrative Templates`, `loading.tsx`, `Forms & Process Templates`, `case-phase-result.spec.ts`, `loading.tsx`, `Page`, `result-actions.ts`, `Page`, `sup-supersession.spec.ts`, `Page`, `Page`, `Section signoff fields`, `ListMeetings`, `rca-team-panel.tsx`, `0013 — Fix form_versions INSERT RLS self-reference`, `Condition builder`, `Phase result options`, `Page`, `UploadDialog`, `Page`, `Case tags panel`, `0058 — Derived quality-indicator measurement compute (the parity lock)`, `Page`, `error.tsx`, `Page`, `Page`, `Route`, `CaseActionItemsPanel`, `Audit icon`, `Page`, `Referral patient fields`, `Page`, `ADR 0021 — Due dates for case phases`, `Page`, `21. Recommended Dashboard Views`, `Audit motion`, `CaseTagsPanel`, `DepartmentDefDialog`, `Page`, `Page`, `ConfirmDeleteButton`, `ADR 0028`?**
  _High betweenness centrality (0.033) - this node is a cross-community bridge._
- **What connects `semi`, `singleQuote`, `trailingComma` to the rest of the system?**
  _4949 weakly-connected nodes found - possible documentation gaps or missing edges._
- **Should `Case Lifecycle Actions` be split into smaller, more focused modules?**
  _Cohesion score 0.13442622950819672 - nodes in this community are weakly interconnected._
- **Should `Admin & Auth Pages` be split into smaller, more focused modules?**
  _Cohesion score 0.051675094816687736 - nodes in this community are weakly interconnected._
- **Should `Shared UI & Phase Dialogs` be split into smaller, more focused modules?**
  _Cohesion score 0.08380809595202399 - nodes in this community are weakly interconnected._