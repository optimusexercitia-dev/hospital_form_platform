# Graph Report - hospital_form_platform  (2026-08-07)

## Corpus Check
- 2191 files · ~3,340,406 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 15656 nodes · 32675 edges · 1714 communities (811 shown, 903 thin omitted)
- Extraction: 100% EXTRACTED · 0% INFERRED · 0% AMBIGUOUS · INFERRED: 120 edges (avg confidence: 0.68)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `05fa56dd`
...
1. `createClient()` - 735 edges
2. `cn()` - 486 edges
3. `Button()` - 315 edges
4. `commissionHref()` - 201 edges
5. `Page` - 186 edges
6. `cachedSignIn()` - 170 edges
7. `getCommissionAccessByOrg` - 138 edges
8. `FormBanner()` - 137 edges
9. `getSessionContext` - 114 edges
10. `useFieldIds()` - 101 edges
...
- `openAddBlock()` --references--> `Page`  [EXTRACTED]
  e2e/answer-model-v2.spec.ts → src/lib/types/pagination.ts
- `publishForm()` --references--> `Page`  [EXTRACTED]
  e2e/answer-model-v2.spec.ts → src/lib/types/pagination.ts
...
## Communities (1714 total, 903 thin omitted)

### Community 0 - "Case Lifecycle Actions"
Cohesion: 0.03
Nodes (152): AddAdHocNarrativeDialog(), AddAdHocPhaseDialog(), ADR-0085, CancelCaseButton(), ADR-0032, ConcludeNarrativeButton(), ADR-0033, DetailPhase (+144 more)

### Community 1 - "Admin & Auth Pages"
Cohesion: 0.03
Nodes (99): STATUS_OPTIONS, ADR-0093, LinkEvidenceDialog(), LOW_CARDINALITY_KINDS, BannerTone, FormBanner(), toneStyles, ActivatePhaseDialog() (+91 more)

### Community 2 - "Shared UI & Phase Dialogs"
Cohesion: 0.06
Nodes (50): AdminLayout(), ADR-0042, commissionInitials(), CommissionPickerPage(), metadata, ROLE_LABEL, slugifyHeading(), metadata (+42 more)

### Community 3 - "Error & Not-Found Boundaries"
Cohesion: 0.04
Nodes (94): isOverdue(), localTodayYmd(), MyCapaActionsPage(), ADR-0076, CapaActionForm(), userLabel(), CapaActionsSection(), CapaActionStatusChip() (+86 more)
...
Cohesion: 0.11
Nodes (23): ActionItemSourceBadge(), ActionItemStatusBadge(), SOURCE_META, STATUS_META, ActionItemsTable(), compareItems(), Filters(), ItemRow() (+15 more)

### Community 6 - "Triage Disposition & Pathways"
Cohesion: 0.06
Nodes (66): metadata, NspTriagePage(), DispositionRail(), NON_RCA_PATHWAYS, Pill(), HARM_DEFINITIONS, HarmScale(), ChoiceCard() (+58 more)

### Community 7 - "Case Documents"
Cohesion: 0.02
Nodes (163): metadata, PrimeiroAcessoPage(), metadata, OrgAccreditationPage(), metadata, OrgAdministratorsPage(), ADR-0051, ADR-0052 (+155 more)

### Community 8 - "RCA Problem Stage"
Cohesion: 0.11
Nodes (33): metadata, ReferralDetailPage(), ADR-0078, ADR-0094, metadata, TechnicalDirectionReferralPage(), ADR-0094, formatCaseNumber() (+25 more)

### Community 9 - "Form Builder Actions"
Cohesion: 0.08
Nodes (56): ADR-0011, ADR-0079, addSection(), ALLOWED_IMAGE_MIME, authorizeCommission(), Block, CHOICE_TYPES, COLOR_OPTION_TYPES (+48 more)

### Community 10 - "Submission Detail (Answer Model)"
Cohesion: 0.16
Nodes (30): MyCapaActionControls(), ADR-0076, CapaActionCard(), MeasureRow(), CapaTaskList(), addCapaAction(), addCapaActionEvidence(), addCapaActionTask() (+22 more)
...
Cohesion: 0.05
Nodes (66): SectionConditionFields(), ConditionRow(), condToRow(), DraftRow, emptyRow(), initialToRows(), isLegacySingle(), nextUid() (+58 more)

### Community 13 - "NSP Event Pages"
Cohesion: 0.06
Nodes (67): metadata, NspEventDetailPage(), CapaClassificationChip(), CapaStatusChip(), CapaEffectivenessPanel(), CapaHeader(), CapaPlanCard(), CapaStage() (+59 more)

### Community 14 - "RCA Analysis Stage"
Cohesion: 0.11
Nodes (21): CaseDocumentUpload(), ADR-0033, ADR-0063, ADR-0100, ACTION_ITEM_STATUS_LABEL, ACTION_ITEM_STATUS_STYLE, DOC_TYPE_LABEL, EVENT_KIND_LABEL (+13 more)

### Community 15 - "Case Department Field"
Cohesion: 0.03
Nodes (78): actionItemsSection(), createMeetingActionItemUI(), itemRow(), openEditDialog(), openSatellites(), openSatellitesByKeyboard(), reopenSatellites(), signInAs() (+70 more)

### Community 16 - "Referral Detail & Formatting"
Cohesion: 0.04
Nodes (71): DefaultConfig, DefaultValue, DefaultValueEditor(), DynamicSourcePicker(), initialDefaultConfig(), initialDefaultValue(), LiteralValueEditor(), MODE_OPTIONS (+63 more)

### Community 17 - "Staff Case Detail"
Cohesion: 0.02
Nodes (71): openQuestionDialog(), signInAs(), signInAs(), ADR-0078, AGENDA_UNRESOLVED_TITLES, SERVICE_HEADERS, signInAs(), ADR-0080 (+63 more)
...
Cohesion: 0.04
Nodes (87): AdminOrganizationsPage(), metadata, metadata, LoginPage(), metadata, metadata, metadata, CommissionEditForm() (+79 more)
...
Cohesion: 0.02
Nodes (182): metadata, PhaseAnswersPage(), ADR-0074, ADR-0085, GrantExpiry(), CaseActionItemsPanel(), CaseCorrectionsList(), CaseCustomFieldChips() (+174 more)

### Community 24 - "Auth Callback & Meeting Settings"
Cohesion: 0.08
Nodes (71): LegacyMeetingsSettingsPage(), AgendaItemForm(), AgendaRow(), UploadDialog(), AttendeeRow(), AttendeesPanel(), ConfirmActionButton(), MeetingLifecycleActions() (+63 more)

### Community 25 - "Referral Actions & Reply"
Cohesion: 0.06
Nodes (57): AssessmentRow, CCIH_FORM_HIGIENE, cloneFrameworkRpc(), createFrameworkRpc(), EvidenceLinkRow, filterIds(), FrameworkRow, getToken() (+49 more)
...
Cohesion: 0.12
Nodes (41): CasePhaseDelete(), ActionState, activatePhase(), addAdHocPhase(), AddAdHocPhaseState, authorizeCommission(), cancelCase(), closeCase() (+33 more)

### Community 28 - "Meeting Detail & Agenda"
Cohesion: 0.10
Nodes (22): EMPTY_REFERRAL_PATIENT_DRAFT, ReferralPatientDraft, referralPatientDraftHasData(), referralPatientDraftToInput(), ReferralPatientFields(), SEX_ORDER, ADR-0037, nowLocalInput() (+14 more)

### Community 29 - "NSP CAPA/RCA Pages"
Cohesion: 0.12
Nodes (24): TOKEN_COLOR_VAR, RiskBandsEditor(), TOKEN_NAME, TOKENS, ADR-0089, AxisDraft, BandDraft, bandForScore() (+16 more)

### Community 30 - "CAPA Evidence & Cards"
Cohesion: 0.09
Nodes (50): DeadlineDialog(), isoToLocalInput(), LinkableTargetCase, nowLocalInput(), ReferralActions(), ReferralComposer(), getReferralPatient(), acceptReferral() (+42 more)
...
Cohesion: 0.04
Nodes (80): EthicsDashboardPage(), metadata, ADR-0064, ADR-0073, metadata, SubmissionsPage(), CommissionReferralsPage(), metadata (+72 more)

### Community 34 - "Phase Responder & Submissions"
Cohesion: 0.03
Nodes (146): InterviewDetailPage(), metadata, AttachmentLinkForm(), AttachmentUpload(), UploadDialog(), ADR-0063, formatCaseNumber(), formatInterviewNumber() (+138 more)

### Community 35 - "Case Narrative Cards"
Cohesion: 0.08
Nodes (26): DashboardPage(), metadata, ADR-0051, metadata, QualityBoardPage(), ADR-0041, ADR-0100, TagReportCardAsync() (+18 more)

### Community 36 - "Phase Result Actions"
Cohesion: 0.13
Nodes (23): getDraftTemplateVersion(), getProcessTemplateVersion(), getProcessTemplateWithVersion(), getPublishedTemplateVersion(), listTemplateVersions(), mapCustomFieldDef(), mapNarrative(), mapPhase() (+15 more)
...
Cohesion: 0.05
Nodes (53): metadata, resolveImageUrls(), ReviewAndSignPage(), ADR-0061, PhaseAnswersReadonly(), ADR-0087, ADR-0091, SubmissionDetailView() (+45 more)
...
Cohesion: 0.20
Nodes (9): ComposerMode, ComposerModeKey, ADR-0037, ADR-0037, ADR-0078, ADR-0094, CreateReferralState, ReferralActionState (+1 more)

### Community 41 - "Meeting Attendees & Quorum"
Cohesion: 0.03
Nodes (156): SectionBody(), AnswerSummary(), CollectedAnswers, collectInstances(), collectScope(), InstanceAnswers, ScopeState, topLevelItems() (+148 more)
...
Cohesion: 0.05
Nodes (38): 0104 — PDF document printing module: record-semantics minting, single registry, template pipeline, QR verification, Alternatives rejected (summary), Consequences, Context, D10 — QR verification: dedicated token, anemic public answer, D11 — Authorization matrix, D12 — Audit ledger (Rule 11, no parallel log), D13 — Signatures render as ATTESTATION BLOCKS (+30 more)
...
### Community 47 - "Layout"
Cohesion: 0.06
Nodes (40): TitleAssignControl(), ADR-0051, TitleBadge(), ADR-0051, CAPABILITIES, MemberAdministrativoControls(), ADR-0061, MemberList() (+32 more)

### Community 48 - "Page"
Cohesion: 0.03
Nodes (59): WalkEntry, FLAGGED_OPS, FlaggedWhenEditor(), OP_LABELS, formatIsoDate(), renderValue(), ADR-0090, ADR-0091 (+51 more)
...
Cohesion: 0.07
Nodes (57): PhaseResultBadge(), timelineResultToResolved(), AvatarStack(), CaseTimeline(), DAY_MONTH, DERIVED_PILL, durationSuffix(), formatEventDate() (+49 more)

### Community 52 - "Page"
Cohesion: 0.09
Nodes (26): metadata, NewDocumentVersionPage(), metadata, ReviseDocumentVersionPage(), ADR-0081, asDocType(), DOC_TYPES, metadata (+18 more)

### Community 54 - "Section signoff fields"
Cohesion: 0.03
Nodes (83): DetailBlock(), formatDateTime(), SignoffMeta(), ADR-0087, ADR-0089, ADR-0091, AddBlockMenu(), BlockCard() (+75 more)
...
Cohesion: 0.03
Nodes (151): ADR-0065, StaffAdminManager(), CaseStatusBadge(), ADR-0033, DecideAdmissibilityDialog(), EthicsAdmissibilityPanel(), IntakeDialog(), toLocalInput() (+143 more)

### Community 58 - "Condition builder"
Cohesion: 0.09
Nodes (37): CharterFormState, FREQUENCIES, saveCharter(), CharterPage(), formatDateOnly(), formatTimestamp(), metadata, ADR-0080 (+29 more)
...
### Community 60 - "Page"
Cohesion: 0.05
Nodes (68): AcreditacaoPage(), metadata, ADR-0093, AssessmentForm(), CloneFrameworkDialogTrigger(), EvidenceCountBadge(), EvidenceList(), formatLinkedAt() (+60 more)

### Community 61 - "CaseActionItemForm"
Cohesion: 0.10
Nodes (32): CancelButton(), formatApplyCounts(), ConcludeBar(), previewCounts(), isNextControlFlowError(), useMinutesAction(), cancelAudioJob(), ActionState (+24 more)

### Community 62 - "VersionWithUrl"
Cohesion: 0.14
Nodes (31): CloneFrameworkDialog(), EvidenceCombobox(), SimpleCandidateSelect(), ActionState, cloneFramework(), CloneFrameworkState, createFramework(), CreateFrameworkState (+23 more)

### Community 63 - "UploadDialog"
Cohesion: 0.10
Nodes (29): CaseReferralsModule, CaseOutboundReferralsCard(), ADR-0094, formatDate(), formatReferralCode(), ReferralOverdueChip(), ResponseExpectedChip(), ReferralDashboardTable() (+21 more)

### Community 64 - "Layout"
Cohesion: 0.25
Nodes (8): 1.1 `case_phases` carries status/assignee/recommended only — never answers, 1.2 Coordinator board reads (`list_cases_board` / `get_case_detail`), 1.3 `case_phase_answer_map` is submitted-only, 1.4 `recompute_recommendations` is submitted-only end-to-end, 1.5 `responses_select` / `answers_select` not broadened, 1.6 RLS check in the E2E suite, 1.7 Service-role key not reachable client-side, 1. Security invariant audit (the Phase-7 in_progress-answers invariant)
...
Cohesion: 0.03
Nodes (98): formatDateTime(), metadata, resolveImageUrls(), SubmissionDetailPage(), CorrectSubmissionButton(), formatDateTime(), SubmissionRow(), SubmissionsFiltersAsync() (+90 more)
...
### Community 74 - "Page"
Cohesion: 0.21
Nodes (11): SessionForm(), toDateTimeLocalValue(), HeldWindowFields(), isFuture(), localToIso(), ADR-0062, useHeldWindowState(), MeetingFormDialog() (+3 more)
...
### Community 82 - "Route"
Cohesion: 0.22
Nodes (8): BannerTone, preservedCasesSentence(), DRAFT_PROPS, ADR-0096, TONES, ADR-0096, VersionWorkflowBanner(), TemplateVersionStatus

### Community 83 - "ActionItemRow"
Cohesion: 0.11
Nodes (35): CaseTypeDialog(), CaseTypeManager(), EMPTY, ADR-0064, ADR-0064, ActionState, authorizeOrg(), CaseTypeInput (+27 more)

### Community 84 - "CaseActionItemsPanel"
Cohesion: 0.18
Nodes (24): metadata, NspConfigPage(), ADR-0052, SafetyMotion(), EventTypeManager(), RcaWindowForm(), SentinelCriterionManager(), VocabManager() (+16 more)
...
### Community 93 - "Page"
Cohesion: 0.16
Nodes (34): CaseNarrativeDelete(), addAdHocNarrative(), addTemplateNarrative(), archiveNarrativeType(), assignNarrative(), authorizeCommission(), CaseLayoutOrderItem, commissionOfCase() (+26 more)
...
### Community 96 - "Page"
Cohesion: 0.03
Nodes (113): ADR-0025, MeetingDetailPage(), metadata, ADR-0078, ADR-0080, ADR-0099, CaseMeetingsPanel(), CarryForwardPanel() (+105 more)
...
Cohesion: 0.05
Nodes (46): CommissionLayout(), ADR-0033, ADR-0061, ADR-0078, ADR-0100, metadata, SignoffQueuePage(), ADR-0061 (+38 more)
...
Cohesion: 0.04
Nodes (104): CancelButton(), ReopenButton(), AnalysisStage(), SubView, Tab(), CatBlock(), CauseCard(), Fishbone() (+96 more)
...
Cohesion: 0.11
Nodes (26): ReferenceConfigEditor(), ADR-0091, isCaseScopedOnlyLane(), LaneCopy, reachesCaseScopedLane(), REFERENCE_LANE_COPY, referenceKindLabel(), ADR-0091 (+18 more)
...
Cohesion: 0.11
Nodes (23): DocumentDetailPage(), metadata, ApproverDocumentPage(), metadata, AddVersionForm(), ApprovalSignForm(), ApprovalDecisionBadge(), ApprovalsPanel() (+15 more)
...
### Community 122 - "Page"
Cohesion: 0.11
Nodes (24): PhaseBlocksEditor(), initialResultValue(), PhaseSlotDialog(), ADR-0096, PhaseWithTargets, AGGREGATE_OPS, aggregateKeyFor(), AllowedResultsPicker() (+16 more)
...
Cohesion: 0.12
Nodes (21): isAssignmentOverdue(), metadata, MyReferralAssignmentsPage(), referralStatusChipClass(), ReferralAssignmentPanel(), PRIORITY_ICON, ReferralDirectionChip(), ReferralPriorityChip() (+13 more)

### Community 125 - "Format"
Cohesion: 0.03
Nodes (157): NarrativeEditorPage(), metadata, roleFromCapabilities(), StaffCaseDetailPage(), ADR-0033, ADR-0061, ADR-0085, ADR-0096 (+149 more)

### Community 127 - "ADR 0028"
Cohesion: 0.07
Nodes (54): allowedRuleTypes(), blankDraft(), dateRangeInputType(), DATETIME_ORDER_OP_LABELS, datetimeOrderTargets(), itemAcceptsValidations(), nextKey(), regexCompilesInJs() (+46 more)
...
### Community 146 - "Page"
Cohesion: 0.27
Nodes (17): ActionState, archiveCaseOutcome(), authorizeCommission(), commissionOfCase(), commissionOfOutcome(), commissionOfTemplateVersion(), createCaseOutcome(), mapOutcomeError() (+9 more)
...
Cohesion: 0.05
Nodes (43): ADR-0001, ADR-0004, ADR-0006, ADR-0007, AudioJobClientFailure, AudioJobResult, call(), getAudioJobStatus() (+35 more)

### Community 151 - "Architecture Rules (binding)"
Cohesion: 0.08
Nodes (40): addAgendaItem(), addAttendee(), buildDoneCallback(), buildErrorCallback(), callRPC(), createHeldMeeting(), deleteMeeting(), DoneCallbackRefs (+32 more)
...
Cohesion: 0.18
Nodes (10): 10. Rebuild notes / gotchas, 1. Purpose & scope, 2. Design system (inherited — do not reinvent), 3. Data model, 4. Component inventory, 5. App shell, routing & state (`docs-app.jsx`), 6. Screen — Document register (library) · `docs-library.jsx`, 8. Screen — Document detail · `docs-detail.jsx` (+2 more)
...
Cohesion: 0.13
Nodes (15): metadata, ADR-0096, CaseTemplateProvenance(), PUBLISHED, ADR-0096, ADR-0096, CreateProcessTemplateDialog(), ProcessTemplateCard() (+7 more)
...
Cohesion: 0.10
Nodes (32): AcknowledgeButton(), casePatientToDraft(), EventNotifyForm(), HARM_ORDER, ADR-0038, EMPTY_PATIENT_DRAFT, PatientDraft, patientDraftHasData() (+24 more)
...
Cohesion: 0.18
Nodes (11): 0. Scope at a glance, 1. Design-system translation (doc `mm.css` → platform tokens), 4. Notifications workstream (Phase-20 substrate — currently zero doc integration), 5. Sequencing & file ownership, 6. Test plan (Phase Gate §6), 7. Open micro-decisions (resolve at build start; low-stakes), 8. Deferred / explicitly out of scope, 9. Risks & keystone cautions (from project memory / ADR 0078 lessons) (+3 more)

### Community 243 - "Loading"
Cohesion: 0.06
Nodes (32): ADRs, Data-access & action modules, Deferred (carried as a follow-up, not gate-blocking), Migrations, Phase 14a — NSP Foundation, Event Intake & Hand-off (archived task detail), Tests / Gate, What shipped, Batch context (+24 more)
...
Cohesion: 0.12
Nodes (21): metadata, ReviewDuePage(), DocStatus, DocType, ApprovalRow, ApproverCandidateRow, DocumentListFilters, DocumentRow (+13 more)
...
Cohesion: 0.15
Nodes (15): OrgAuditPage(), AuditLabelOption, ADR-0051, AuditFilterActor, AuditListRow, AuditLogEntry, listAuditForHospital(), listAuditForOrg() (+7 more)
...
Cohesion: 0.05
Nodes (49): AccountLayout(), ADR-0076, AcreditacaoLayout(), DocumentsLayout(), IndicatorsLayout(), PendingApprovalsLayout(), metadata, PendingApprovalsPage() (+41 more)

### Community 255 - "Loading"
Cohesion: 0.09
Nodes (27): postSignedCallback(), accepted(), POST(), featureEnabled, handleMeetingMinutesCallback, post(), signedHeaders(), ADR-0099 (+19 more)

### Community 256 - "Loading"
Cohesion: 0.06
Nodes (39): ScopeOption(), LevelOption(), CaseOutcomeSelector(), SortHeader(), FilterChip(), PhaseResultOverrideDialog(), TagManager(), initials() (+31 more)
...
Cohesion: 0.09
Nodes (39): metadata, NspCapaPage(), metadata, NspRcaPage(), auditClinicalView(), getCapaEffectiveness(), getCapaPlan(), listCapaActionEvidence() (+31 more)
...
Cohesion: 0.08
Nodes (38): displaySpeakerLabel(), formatAttachResolutionLabel(), MINUTES_UI, truncateLabelPart(), ADR-0099, MinutesListBadge(), ADR-0099, ActionsReview() (+30 more)

### Community 263 - "Loading"
Cohesion: 0.03
Nodes (92): metadata, PhaseResponderPage(), ADR-0085, metadata, CommissionEventsPage(), metadata, metadata, ResponderPage() (+84 more)
...
Cohesion: 0.16
Nodes (11): metadata, QualityDashboardsPage(), toAggregatesOnly(), ADR-0041, ADR-0100, QualityDashboardFilters(), ADR-0100, COPY (+3 more)
...
Cohesion: 0.07
Nodes (18): signInAs(), ADR-0097, ADR-0098, checkDigits(), ADR-0097, uniqueCpf(), signInAs(), ADR-0051 (+10 more)

### Community 303 - "form-model-normalization.spec.ts"
Cohesion: 0.06
Nodes (34): createForm(), enterWizardByTitle(), openAddBlock(), publishForm(), purge(), signInAs(), ADR-0045, ADR-0092 (+26 more)

### Community 304 - "PHASES.md — Hospital Commission Forms Platform"
Cohesion: 0.04
Nodes (65): react, CaseDepartmentField(), DEPARTMENTS, TOKEN_STYLES, ColorTokenPicker(), TOKEN_NAME, TOKENS, CreateCaseDialog() (+57 more)
...
Cohesion: 0.21
Nodes (9): caseCountLabel(), DATE_FMT, ADR-0096, VERSIONS, timingLabel(), ADR-0096, VersionHistoryPanel(), ProcessTemplateVersion (+1 more)
...
Cohesion: 0.08
Nodes (43): OpenAttachmentButton(), ADR-0063, AttachmentsPanel(), AttachmentUpload(), AttachmentsPanel(), ADR-0063, ConfirmDeleteButton(), formatDate() (+35 more)

### Community 319 - "dashboard-charts.tsx"
Cohesion: 0.04
Nodes (75): QualityOfficeLayout(), ADR-0041, ADR-0100, CaseActionItemForm(), PhaseOption, STATUS_ORDER, ADR-0033, CaseKpis (+67 more)
...
Cohesion: 0.04
Nodes (61): getReferralDetail(), mapReferralListItem(), MyReferralAssignmentJson, REFERRAL_CURSOR_SCHEMA, ReferralCursor, ReferralDetailJson, ReferralInternalNoteJson, ReferralListRow (+53 more)
...
Cohesion: 0.12
Nodes (27): FrameworkLayout(), metadata, StandardDetailPage(), FrameworkOverviewPage(), ADR-0093, getStandardAssessmentDetail(), buildChapterRollup(), buildLevelRollups() (+19 more)
...
Cohesion: 0.13
Nodes (24): CaseTimelinePage(), metadata, first(), parseDensity(), parseTypes(), parseView(), CaseMeetingLink, CasePhaseTimelineRow (+16 more)
...
Cohesion: 0.04
Nodes (49): ADR index (decisions that shape the backend), AFF — Hospital affiliation, CPF person identity, org people directory (2026-08-06; ADR 0097 + 0098; migrations `20260909000100`–`…001300`; NO flag, structural), AI — Action-Items Satellites + reminder→N scan arm (2026-07-14; ADR 0050; migrations `20260720000950`–`…000970`; flags `action_items`/`cases_extras` ON), backend-state.md — Living Backend Capability Map, CH — Committee Charters & Cadence (S4, 2026-07-20; ADR 0080; migrations `20260818000000`–`…000200`; flag `charters` seed-ON / prod-OFF) → `main`, Data-access & action modules (Rule 9 — no inline supabase-js in UI), DOC-REDESIGN — Controlled-Document Redesign (Phase 17 v2, 2026-07-21; ADR 0081; migrations `20260819000000`–`…000400`; flag `controlled_docs` unchanged, prod-OFF till pilot) → `main`, DOOR-PARITY RULE - read before adding ANY door or policy (+41 more)
...
Cohesion: 0.07
Nodes (40): MeetingMinutesEditor(), ADR-0099, MinutesAudioSlot(), formatElapsed(), isAudioServiceConfigured(), MeetingMinutesResult, ALLOWED_AUDIO_MIME_TYPES, AUDIO_ACCEPT_ATTRIBUTE (+32 more)
...
Cohesion: 0.05
Nodes (38): ⬛ AFF — Hospital affiliation, person identity & the org people directory · **COMPLETE 2026-08-06**, ▶ AUTHZ Gate-2 deferred (PO-noted 2026-07-17, non-blocking — Gate 2 shipped), Bug Log, Closed → [bug-log-archive.md](docs/progress/bug-log-archive.md), Completed work (archived to docs/progress/), Current Phase Tasks, Decisions, ▶ ETH·E1 → ETH·E2 inheritance (PO-directed 2026-07-14: "log for E2, don't act now") (+30 more)
...
Cohesion: 0.05
Nodes (27): completePhase(), createCase(), editAndResubmit(), insertChoiceOptions(), rpc(), signInAs(), signOut(), slug() (+19 more)
...
Cohesion: 0.04
Nodes (74): metadata, ADR-0033, ADR-0100, CaseCorrectionsData, EMPTY, ADR-0085, CorrectionRequestItem(), CaseNarrativeCard() (+66 more)
...
Cohesion: 0.23
Nodes (10): CaseAccessPanel(), ExpiryPreset, GrantDialog(), isoDaysFromNow(), isoTomorrow(), ADR-0033, ADR-0050, ymdFromIso() (+2 more)
...
Cohesion: 0.11
Nodes (23): DerivedConfigPicker(), BuilderFields(), COMPARATORS, ControlledState, CreateAction, DIRECTIONS, FREQUENCIES, KINDS (+15 more)
...
Cohesion: 0.26
Nodes (10): formatPeriodLabel(), IndicatorKindBadge(), MeasurementStatusChip(), STATUS_STYLES, ChartDataTable(), RunChart(), INDICATOR_KIND_LABELS, INDICATOR_STATUS_LABELS (+2 more)
...
Cohesion: 0.12
Nodes (17): 3.14 `forms.block_library_items`, 3.4 `forms.question_types`, 3.8 `forms.form_block_default_values`, 3. Form Definition Layer, Design Reasoning, Design Reasoning, Design Reasoning, Important Columns (+9 more)
...
Cohesion: 0.20
Nodes (17): AdminAuditPage(), metadata, CommissionAuditPage(), metadata, metadata, ADR-0051, AuditEmptyState(), AuditFiltersAsync() (+9 more)
...
Cohesion: 0.14
Nodes (17): DashboardCharts(), groupBySection(), SectionEntry, SectionGroupData, DashboardFilters(), DashboardForms(), FormPicker(), FreeTextSamples() (+9 more)
...
Cohesion: 0.22
Nodes (9): Findings, INFO-1: Migration comment contradicts ADR on DEFINER bypass (no action required), INFO-2: `cancel_meeting` RPC comment misleading (no action required), MINOR-1: Cancel button visible on `assinada` meetings despite state-machine prohibition, MINOR-2: Quorum `present_count` snapshot and live UI count include external guests, Phase 10 — Meetings: QA Review, Requirements Traceability, Summary (+1 more)

### Community 430 - "phase14d-capa.spec.ts"
Cohesion: 0.10
Nodes (19): BuilderShell(), ADR-0087, ADR-0089, ADR-0090, ADR-0091, ADR-0092, DeleteDraftButton(), EditLibraryEntryDialog() (+11 more)
...
Cohesion: 0.35
Nodes (8): CONTAINER_TYPES, addItem(), reconcileOptionRows(), resolveInsertPosition(), generateOptionCode(), resolveOptionCodes(), shortSuffix(), slugifyLabel()
...
Cohesion: 0.10
Nodes (17): Case Custom Fields (ADR 0083) — full task ledger, ✅ Case custom fields — COMPLETE + MERGED 2026-07-23 (ADR 0083), Archive — Test Run Summary (full history, Phases 0 → QO·A), FF-2 + FF-3 gate rows (rotated from PROGRESS.md 2026-07-28 at the FF-3 Record), FF-3 — final bar at `9557d1f` (2026-07-28), rotated 2026-07-28, MEM · Phase 16 gate · FF-4 · FF-5 · ad-hoc-batch rows (rotated from PROGRESS.md 2026-08-06), Phase 16 · FF-4 · ad-hoc-batch gate rows (rotated from PROGRESS.md 2026-08-04), Rotated 2026-08-07 at the QO·A Record (+15 rows — MIN · AFF · MEM follow-ups/BUG-AUTHZ-002 · PCI/TV) (+9 more)

### Community 439 - "ADR 0008 — GSAP as the animation dependency"
Cohesion: 0.11
Nodes (27): AssigneeAvatar(), BulkCreateAction, BulkMember, BulkTemplateOption, memberName(), PhaseScope, BulkChecklistItem, BulkCreateWizard() (+19 more)
...
Cohesion: 0.09
Nodes (46): ActionItemSatelliteSections(), ActionItemSatellitesPanel(), ChecklistItem(), ChecklistSection(), REMINDER_TYPE_ORDER, ReminderSection(), SatelliteConfirmDelete(), describeReminder() (+38 more)

### Community 449 - "Phase B — NSP-per-hospital + `nsp_org_admin` — completed phase record"
Cohesion: 0.03
Nodes (60): ADR-0021, createCaseAs(), rpcAs(), signInAs(), signOut(), ADR-0061, ADR-0078, ADR-0096 (+52 more)
...
Cohesion: 0.09
Nodes (40): ActionItemRow(), isItemOverdue(), CaseDocumentDelete(), UploadDialog(), ConfirmDeleteButton(), ACTION_ITEM_STATUSES, ActionState, advanceActionItem() (+32 more)
...
Cohesion: 0.07
Nodes (52): ADR-0069, approvalProgress(), deriveStatus(), DocumentsPage(), matchesView(), metadata, StepConfirm(), StepDocument() (+44 more)
...
Cohesion: 0.07
Nodes (36): BlockConditionNote(), CHOICE_OPS, CHOICE_TARGET_TYPES, ConditionBuilder(), DraftRow, isChoiceTarget(), isGroup(), isRowComplete() (+28 more)
...
Cohesion: 0.10
Nodes (27): HospitalIndicatorScorecard(), IndicatorsPanelAsync(), IndicatorsPanel(), DerivedConfig, DerivedDenominatorRef, DerivedNumeratorRef, HospitalIndicatorRollupRow, HybridDerivedConfig (+19 more)
...
Cohesion: 0.03
Nodes (49): ADR 0004 — Sign-off enforcement feature flag, Consequences, Context, Decision, Rationale, Update — flag flipped (Phase 6, 2026-06-13), ADR 0005 — `visible_when` condition shape (v1), Context (+41 more)

### Community 556 - "loading.tsx"
Cohesion: 0.03
Nodes (74): ADR 0030 — Patient-Safety PHI Posture Reversal & PQS/NSP Module Architecture (Phase 14), Consequences, Context, Decision, ADR 0031 — Event Custody Ledger, Access-Follows-Custody RLS & PHI Isolation (Phase 14a), Alternatives considered, Consequences, Context (+66 more)
...
Cohesion: 0.25
Nodes (8): 3. Evaluator reuse — no mirror drift, 5. RLS and SECURITY DEFINER hygiene (Architecture Rule 1), 6. Per-commission case number minting, 8. ADR coverage, 9. Coverage table — PHASES.md §Phase 7 acceptance bullets, Phase 7 QA Review — Multi-Phase Cases, Sign-off, Verdict summary
...
Cohesion: 0.21
Nodes (13): AffiliationActionState, endAffiliation(), lookupOrgPeople(), MESSAGES, parseBlockers(), PgErrorish, revalidateAffiliationSurfaces(), toState() (+5 more)

### Community 629 - "advanced-init-once.md"
Cohesion: 0.25
Nodes (8): 7.1 No inline supabase-js in components (Rule 9), 7.2 Server Components by default, 7.3 pt-BR strings, 7.4 PII warning, 7.5 `not_equals` footgun warning, 7.6 Staff_admin route gating, 7.7 Accessibility, 7. Frontend quality (Architecture Rules 9, §8)
...
Cohesion: 0.12
Nodes (22): CasePatientEditDialog(), ADR-0038, ADR-0078, BulkCaseCustomFieldValue, BulkCaseRow, bulkCreateCases(), mapError(), normalizeDeadline() (+14 more)
...
Cohesion: 0.12
Nodes (16): ADR-0101, metadata, Home(), ADR-0051, ADR-0052, ADR-0094, ADR-0100, appOrigin() (+8 more)
...
Cohesion: 0.07
Nodes (30): Archive — Follow-ups / Deferred Items (full snapshot incl. resolved), Closed 2026-07-05 (rotated out of PROGRESS live Follow-ups), Closed 2026-07-07 (rotated out of PROGRESS live Follow-ups), Closed 2026-07-15 (rotated out of PROGRESS live Follow-ups — E0/E1 now COMPLETE), Closed 2026-07-18 (rotated out of PROGRESS live Follow-ups — AUDIT-DOOR-BLINDNESS now COMPLETE), Closed 2026-08-04 (rotated out of PROGRESS live Follow-ups — Phase 16 items), Follow-ups / Deferred Items, ⬛ FUP-A11Y-1 — `useFieldIds` derives the DOM id from `useId()`. ✅ DONE 2026-08-05. (+22 more)
...
Cohesion: 0.26
Nodes (10): ADR-0009, updateSession(), AUTHED_REDIRECT_AWAY, config, isPublicPath(), proxy(), PUBLIC_PATHS, redirectPreservingCookies() (+2 more)

### Community 703 - "loading.tsx"
Cohesion: 0.07
Nodes (26): 0095 — Process/case integrity audit: remediation scope, corrections, and deferred remodels, Consequences, Context, Decision 1 — implemented as substrate changes (migrations `20260906000100`–`001100`), Decision 2 — three recommendations were WRONG and are NOT implemented, Decision 3 — deferred, each needing its own phase and human approval, PCI + Process-Template Versioning — phase detail (archived), ▶ TV — Process-Template Versioning (ADR [0096](docs/decisions/0096-process-template-versioning.md)) · `frontend` rows (+18 more)

### Community 705 - "0040 — Form Builder Enhancements: condition engine, per-item visibility, additive schema"
Cohesion: 0.10
Nodes (21): 4.10 `form_responses.form_answer_revisions`, 4.4 `form_responses.form_repeating_group_instances`, 4.5 `form_responses.form_answer_files`, 4.8 `form_responses.form_answer_risk_matrix`, 4. Answer Storage Layer, Design Reasoning, Design Reasoning, Design Reasoning (+13 more)
...
Cohesion: 0.11
Nodes (17): 0080 — Committee Charters & Cadence (S4·CH): delegate the regimento to the controlled-doc lifecycle, Consequences, Context, Decision, 0. Scope, 10. Task breakdown (contract-first; one Phase Gate), 11. Risks / open decisions, 1. Catalog reconciliation (spec §21 is stale — use these, verified 2026-07-20) (+9 more)
...
Cohesion: 0.22
Nodes (8): COMMISSION_ID, oversightOf(), WHY: refused vs. a silent no-op., renderedCaseLinks(), renderedOpenCaseCount(), signIn(), sqlOne(), ADR-0100

### Community 712 - "11.1 `interview_notes`"
Cohesion: 0.07
Nodes (29): 0040 — Form Builder Enhancements: condition engine, per-item visibility, additive schema, conditionTargets widening (supersedes a prior decision), Consequences, Context, Decisions, 0086 — Flexible-Forms feature phases FF-1…FF-5 pulled pre-pilot, Consequences, Context (+21 more)
...
Cohesion: 0.04
Nodes (57): Appendix A — Polymorphism dialects (three sanctioned; closes hardening D12; ADR 0065), Appendix B — Catalog-vs-enum + freeze conventions (ADR 0065), ARCHITECTURE.md — Hospital Commission Forms Platform, Architecture Rules, This is NOT the Next.js you know, ADR 0028 — Accreditation & Quality-Governance Roadmap (Phases 13–21), Consequences, Context (+49 more)

### Community 925 - "useClientNow"
Cohesion: 0.18
Nodes (7): AuditRow, auditRowsFor(), restGet(), signInAs(), ADR-0029, ADR-0075, ADR-0096
...
Cohesion: 0.06
Nodes (18): Archive — Increment: Case Narratives, Increment: Case Narratives (feature-flagged; plan `on-this-platform-a-zazzy-waterfall.md`), Archive — `case_patient` (third PHI module; ADR 0038), Feature — `case_patient` (THIRD PHI module; ADR 0038) — ✅ COMPLETE, Case-type assignment — ETH·E3a O-1 resolved (ADR 0088), Archive — Decisions (full verbose form), Collapsed index rows rotated out of PROGRESS.md 2026-08-04 (all decisions dated 2026-06-*), Deferred / Parked Backlog — full detail (+10 more)

### Community 937 - "ADR 0015 — Response-fill RPCs (atomic section save + get-or-resume)"
Cohesion: 0.08
Nodes (23): ADR 0098 — AFF substrate & doors: the shape decisions ADR 0097 left open, Consequence recorded, not discovered later, W2 — doors, visibility, dominance, W3 — product surfaces, person-level authority, provisioning, AFF — Hospital affiliation, person identity & the org people directory, Completion record — rotated from PROGRESS.md 2026-08-06 (§6 step 5), Open at close, by design (none blocking), The three lessons this workstream leaves behind (+15 more)

### Community 940 - "ADR 0017 — Multi-Phase Cases"
Cohesion: 0.18
Nodes (14): IndicatorDetailPage(), metadata, isPqsOperatorOfIndicatorHospital(), ADR-0057, formatTarget(), RunChart, RunChartLoader(), INDICATOR_DIRECTION_LABELS (+6 more)
...
Cohesion: 0.32
Nodes (11): allow_body(), blind_from_findings(), psql_admin(), psql_c(), run_arm_census(), run_arm_floor(), run_arm_policy(), p0-authz-invariant.sh script (+3 more)
...
Cohesion: 0.62
Nodes (5): run251(), run252(), run298(), run_case(), p0b-isolation-mutation-audit.sh script
...
Cohesion: 0.13
Nodes (16): ReadinessBar, ReadinessChart(), CHART_COLORS, DistributionChart(), fullDay(), shortDay(), VolumeTrend(), CHART_COLORS (+8 more)
...
Cohesion: 0.18
Nodes (11): ADR 0079 — AUTHZ door-blindness: the standing invariant + the write-policy keystone-isolation rule, Amendment 1 — the invariant becomes a PHASE STEP, scoped to the diff (2026-08-04), Amendment 2 — one mutation is not sufficient evidence of vacuity (2026-08-04), Amendment 3 — ARM 3, the census that stops the sixteenth (2026-08-04, extended 2026-08-05), Amendment 4 — ARM 1 gains a THIRD sweep: row-returning doors (2026-08-05), Amendment 5 — the census is blind to WRITE-PATH doors, and ARM 1's write sweep is a frozen list (2026-08-06), Amendment 5a — the diff-derivation command must be case-INSENSITIVE (2026-08-06), Consequences (+3 more)
...
Cohesion: 0.14
Nodes (16): deriveFlowMetrics(), metadata, NspReferralsDashboardPage(), ADR-0042, ADR-0094, ReferralDashboardFilters(), AGING_BUCKETS, CHART_COLORS (+8 more)
...
Cohesion: 0.25
Nodes (6): getSessionContext, insert, layoutRows, rpc, supabaseMock, update
...
Cohesion: 0.33
Nodes (6): 7.1 Page layout, 7.2 Stepper (wizard only), 7.3 The four sections, 7.4 Right rail — `ChecklistRail`, 7.5 Footer nav & validation, 7. Screen — Create / New-version flow · `docs-create.jsx` (PRIMARY SCREEN)
...
Cohesion: 0.10
Nodes (20): BlockLibraryEntriesContext, BlockLibraryEntriesProvider(), ADR-0092, useBlockLibraryEntries(), BlockLibraryPicker(), ActionState, CreateFormState, DeleteDraftState (+12 more)
...
Cohesion: 0.22
Nodes (8): from, inFilter, load(), remove, rpc, STALE, storageFrom, update
...
Cohesion: 0.23
Nodes (9): CommissionOversightToggle(), ADR-0100, Switch(), ActionState, mapOversightError(), MESSAGES, QualityOversight, setCommissionOversight() (+1 more)

### Community 1601 - "ARCHITECTURE.md — Hospital Commission Forms Platform"
Cohesion: 0.33
Nodes (6): 2. Backend workstream (contract-first — lands before FE), B0 · Enum-key anglicization (controlled-docs module only; lands FIRST, coupled with B1/B2 as one migration set), B1 · Migration — schema additions (next-dated), B2 · RPC updates (⚠ re-emit each DEFINER body from live `pg_get_functiondef`, not migration text — see Risks), B3 · New app-layer action (no new RPC) — the all-in-one create, B4 · Reads & filters
...
Cohesion: 0.33
Nodes (6): 10. Findings, INFO-1: Stale comment in E2E spec — HC022 mis-described as P0022 HTTP 500, INFO-2: `get_case_detail` RLS not separately tested in pgTAP, INFO-3: Phase 8 deploy-checklist carry-forwards unchanged, MINOR-1: pgTAP gap — `HC017` (snapshot rejects unpublished form) not directly tested, MINOR-2: `archive_process_template` lacks a status guard — allows archiving an already-archived template

### Community 1608 - "loading.tsx"
Cohesion: 0.40
...
Cohesion: 0.33
Nodes (6): 2.1 No live P00xx raisers remain for the custom range, 2.2 Standard codes unchanged, 2.3 Action constants match, 2.4 pgTAP expectations updated, 2.5 Stale comment in E2E spec (INFO, not blocking), 2. HC0xx remap completeness (ADR 0018)

### Community 1622 - "ADR 0059 — Coolify as the pre-Phase-9 dev/staging deployment target"
Cohesion: 0.33
Nodes (6): 4.1 Case state machine, 4.2 Case-phase state machine, 4.3 `sync_case_phase_on_submit` sets its own `app.in_case_rpc`, 4.4 `start_or_resume_phase` skips the published-only backstop, 4.5 Form-version snapshot pin, 4. State machine and immutability
...
Cohesion: 0.33
Nodes (6): Carried forward, non-blocking, Gates re-run after the `src/` edits, R1 — MAJOR · **CLOSED**, and closed better than asked, R2 — MINOR · closed in substance; **residual: the recut list is still short by three**, R3 — MINOR · half closed; **residual: the sweep covered `src/` only**, Round 2 — re-review of the `6b6f894` corrections

### Community 1626 - "MIN — Meeting audio → generated ata (`audio_minutes`) · Feature record"
Cohesion: 0.50
Nodes (4): MIN — Meeting audio → generated ata (`audio_minutes`) · Feature record, ▶ MIN — Meeting audio → generated ata (`audio_minutes`) · **IN PROGRESS, started 2026-08-06**, QA Verdicts rows (copy — live rows retained in PROGRESS.md for the current milestone), Test Run Summary rows (rotated verbatim)
...
### Community 1674 - "3.8 `forms.form_block_default_values`"
Cohesion: 0.40
...
### Community 1683 - "Session Handoff — 2026-07-10 (Pre-Pilot Foundations Program)"
Cohesion: 0.40
...
### Community 1688 - "ADR 0055 — CAPA tenant anchor: hospital-scope every CAPA, close the cross-hospital write hole"
Cohesion: 0.50
Nodes (3): MeetingSettingsView(), MeetingTypeManager(), CommissionMeetingSettings

### Community 1689 - "5.2 `referral_context_versions`"
Cohesion: 0.50
Nodes (4): 5.2 `referral_context_versions`, Columns, Constraints, Design rationale

### Community 1690 - "5.8 `referral_message_documents`"
Cohesion: 0.50
Nodes (4): ADR 0059 — Coolify as the pre-Phase-9 dev/staging deployment target, Consequences, Context, Decision

### Community 1691 - "14.1 `interview_findings`"
Cohesion: 0.50
...
### Community 1697 - "Pre-Pilot DB Hardening — Wave 1 (archived task detail)"
Cohesion: 0.50
...
### Community 1700 - "27. Example: Simple Action Item"
Cohesion: 0.67
...
## Knowledge Gaps
- **7567 isolated node(s):** `semi`, `singleQuote`, `trailingComma`, `plugins`, `$schema` (+7562 more)
...
- **Why does `Page` connect `Case Department Field` to `Loading`, `4.3 `form_responses.form_answer_options``, `F1 — Case-Participants E0 (Pre-Pilot Foundations Program) — COMPLETE`, `Staff Case Detail`, `QA Review — Phase B: NSP-per-hospital + `nsp_org_admin``, `Page`, `rendering-conditional-render.md`, `Architecture Rules (binding)`, `My Cases List`, `Referral Actions & Reply`, `markdown-renderer.tsx`, `OrgAuditPage`, `Submission Detail Blocks`, `5.11 `referral_resolutions``, `form-model-normalization.spec.ts`, `Interview badges`, `Phase B — NSP-per-hospital + `nsp_org_admin` — completed phase record`, `Case tags panel`, `Page`, `form-builder-enhancements.spec.ts`, `0013 — Fix form_versions INSERT RLS self-reference`, `AuditFeed`, `Case document delete`, `Page`, `ad-hoc-narratives.spec.ts`, `Page`, `Phase 10 — Meetings (archived task detail)`, `Phase 17 — Controlled-Document Lifecycle (Gestão de Documentos Controlados)`, `Loading`, `Phase 17 — Controlled-Document Lifecycle · QA Review`, `Loading`?**
  _High betweenness centrality (0.069) - this node is a cross-community bridge._
- **Why does `createClient()` connect `Forms & Process Templates` to `Case Lifecycle Actions`, `0066 — patient_xref case-module grain re-keyed to the patient participant`, `Shared UI & Phase Dialogs`, `Error & Not-Found Boundaries`, `Triage Disposition & Pathways`, `Case Documents`, `RCA Problem Stage`, `Form Builder Actions`, `Submission Detail (Answer Model)`, `NSP Event Pages`, `RCA Analysis Stage`, `Referral Detail & Formatting`, `Quality Indicators`, `NSP Patient Registry`, `My Cases List`, `Auth Callback & Meeting Settings`, `Phase 14b–14d — Patient-Safety / NSP: Triage, RCA & CAPA`, `Case & Phase Actions`, `CAPA Evidence & Cards`, `Form Item Editor & Tests`, `Submission Detail Blocks`, `Phase Responder & Submissions`, `Case Narrative Cards`, `Phase Result Actions`, `Narrative Templates`, `Layout`, `IsTerminalMeetingStatus`, `Page`, `TitleAssignControl`, `Condition builder`, `Page`, `CaseActionItemForm`, `VersionWithUrl`, `UploadDialog`, `validation-rules-editor.tsx`, `Case tags panel`, `Wizard runner`, `ActionItemRow`, `CaseActionItemsPanel`, `Page`, `Page`, `Referral patient fields`, `Page`, `Outcomes actions`, `2. Architectural Goals`, `advanced-event-handler-refs.md`, `Audit feed`, `ConfirmDeleteButton`, `Format`, `js-batch-dom-css.md`, `js-flatmap-filter.md`, `Meeting form dialog.test`, `Page`, `page.tsx`, `Page`, `Phase result options`, `Audit icon`, `Loading`, `Loading`, `Loading`, `Loading`, `Loading`, `Loading`, `Loading`, `PHASES.md — Hospital Commission Forms Platform`, `Quick Reference`, `case-narratives.spec.ts`, `dashboard-charts.tsx`, `form-builder-enhancements.spec.ts`, `3. Server-Side Performance`, `QA Review — Option A: Shared (non-PHI) `action_items` table`, `member-action-items-overview.spec.ts`, `Phase B — NSP-per-hospital — HANDOFF (machine switch, 2026-07-03)`, `cases-extras.spec.ts`, `Lead Playbook — orchestration protocol (lead only)`, `ADR 0017 — Multi-Phase Cases`, `ADR 0002 — Admin claim via custom access token hook`, `0013 — Fix form_versions INSERT RLS self-reference`, `ADR 0053 — Audit-access entitlement guard (C-4): dispatch to the entity's own read predicate, not a revoke`, `4. Answer Storage Layer`, `rca-team-panel.tsx`, `0012 — clone_form_version returns the existing draft (one draft per form)`, `17. Suggested Repository and Service Boundaries`, `Phase CH — Committee Charters & Meeting Cadence — QA Review`, `loading.tsx`?**
  _High betweenness centrality (0.058) - this node is a cross-community bridge._
- **Why does `cn()` connect `Loading` to `Case Lifecycle Actions`, `Admin & Auth Pages`, `Error & Not-Found Boundaries`, `Phase Answers & Assignments`, `Loading`, `Case Documents`, `Loading`, `Loading`, `RCA Problem Stage`, `Submission Detail (Answer Model)`, `CAPA Badges`, `NSP Event Pages`, `RCA Analysis Stage`, `Triage Disposition & Pathways`, `Referral Detail & Formatting`, `Quality Indicators`, `phase14b-triage.spec.ts`, `page.tsx`, `My Cases List`, `Meeting Detail & Agenda`, `NSP CAPA/RCA Pages`, `Submission Detail Blocks`, `Phase Responder & Submissions`, `Case Narrative Cards`, `loading.tsx`, `Lead Playbook — orchestration protocol (lead only)`, `Interview & Agenda Forms`, `phase7-cases.spec.ts`, `cases-outcomes-blockers.spec.ts`, `Narrative Templates`, `Layout`, `PHASES.md — Hospital Commission Forms Platform`, `Page`, `Page`, `UserLifecycleActions`, `Page`, `Page`, `Section signoff fields`, `ADR 0008 — GSAP as the animation dependency`, `Action Items Data Model Handoff`, `TitleAssignControl`, `Condition builder`, `0013 — Fix form_versions INSERT RLS self-reference`, `Page`, `VersionWithUrl`, `dashboard-charts.tsx`, `ADR 0053 — Audit-access entitlement guard (C-4): dispatch to the entity's own read predicate, not a revoke`, `UploadDialog`, `Case tags panel`, `0080 — Committee Charters & Cadence (S4·CH): delegate the regimento to the controlled-doc lifecycle`, `validation-rules-editor.tsx`, `AttachmentLinkForm`, `Route`, `CaseActionItemsPanel`, `4. Answer Storage Layer`, `8. Advanced Patterns`, `Page`, `17. Suggested Repository and Service Boundaries`, `Page`, `Phase CH — Committee Charters & Meeting Cadence — QA Review`, `Outcomes actions`, `DepartmentDefDialog`, `Audit feed`, `Phase B — NSP-per-hospital — HANDOFF (machine switch, 2026-07-03)`, `Loading`, `ConfirmDeleteButton`, `Format`, `Loading`, `phase14a-safety-events.spec.ts`?**
  _High betweenness centrality (0.032) - this node is a cross-community bridge._
- **What connects `semi`, `singleQuote`, `trailingComma` to the rest of the system?**
  _7734 weakly-connected nodes found - possible documentation gaps or missing edges._
- **Should `Case Lifecycle Actions` be split into smaller, more focused modules?**
  _Cohesion score 0.02818849058610786 - nodes in this community are weakly interconnected._
- **Should `Admin & Auth Pages` be split into smaller, more focused modules?**
  _Cohesion score 0.029472443265546714 - nodes in this community are weakly interconnected._
