...
- 🟡 **FUP-GATE-RESET-FLAKE** — two consecutive full gates each lost a whole batch to a transient mid-gate `db reset` whose stderr the harness discards (`e2e-prod-gate.sh:346`); also `gotenberg-pdf` has no restart policy — harness/infra
