...
- 🔴 **FUP-ETH-CPF-1** — ETH·E4's D5 widening also exposes `professional_profiles.cpf` (a national ID) org-wide; ADR 0108 D5's exposure argument does not name it. Latent (no door writes the column). PO decision, then backend → [body](docs/progress/follow-ups.md)
