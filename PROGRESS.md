...
| --- | --- | --- | --- |
| **AE4 / IA-F9** — statement-scoped permission resolution, `20261003007320` + ADR 0182, branch `authz-ae4-scope-reaches-fix` @ `9f7fa68d` | ⛔ **CHANGES REQUESTED** — over-grant claim **HOLDS** (0 violations / 520 cells, re-measured). Blocking: new DEFINER's `search_path` is one nonexistent schema **and 413:142 pins it** · DC3's spec ≠ the DC3 that ran · §14's ordering claim false for DC2 · E2E unrun · no approval recorded | 2026-09-03 | [review](docs/reviews/authz-ae4-if9-statement-scoped-review.md) |
