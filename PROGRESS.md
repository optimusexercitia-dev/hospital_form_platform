...
**▶ Active: CH-TEST (tester, `e2e/charters-cadence.spec.ts` — §9 acceptance + deferred round-trips + case_restricted absence + keyboard flow).**
