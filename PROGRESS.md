...
- **F-B new-version wizard** — assessing (detail retains restyled supersede/add-version/submit affordances as the functional new-version path). **F-D sign/queue + deep-links** — pending.
