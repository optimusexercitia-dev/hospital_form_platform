...
- 🟡 **FUP-DM4-PRODROW** — the 1 dangling frozen-snapshot PRODUCTION row + the 3 unreferenced controlled-doc objects: reconcile (re-freeze or explicit tombstone) at the push/deploy step, NOT during DM4 (PO ruling R2, 2026-08-14) — lead/backend
