...
| BE-4 | Mig: `ethics_notifications`/`ethics_hearings`/`ethics_appeals`; **`schedule_ethics_hearing` = `participants_only` meeting door** (D14→Stage C; roster-then-flip per `trg_meetings_roster`); "Audiência" seed | backend | **full** ✅ approved | 🏗️ building |
