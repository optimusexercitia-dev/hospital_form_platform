...
### 🏗️ Case Correction Lifecycle (`case-corrections` branch) — started 2026-07-24
...
| QA | Phase review (neutralization-oracle on new guard arms; `prosecdef` + `pg_policies` sweep) | qa | 🔜 |
