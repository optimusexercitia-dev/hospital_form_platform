...
| QA | Phase review (neutralization-oracle on new guard arms; `prosecdef` + `pg_policies` sweep) | qa | 🏗️ in progress — **TEST GATE CLOSED** (feature 7/7 green in full prod suite; full-run reds triaged = 107 ERR_CONNECTION infra + notifications/nsp baseline; T-2 clean-stack confirm 76/76 · 0 conn-err; stale AC-6 reconciled) |
