...
>
> The 18 open DM follow-ups were grouped and triaged. **Eight rulings** — § Decisions, the
> `DM-FUP TRIAGE #N` rows — and **four items built and gate-green**. ⚠ *There were 18, not 17:*
...
> (`20260928000700`). Gates: pgTAP **194f/6397** · lint 5/5 · tsc 0 · vitest **1305** · 4 authz ARMs
> HOLD. ⛔ **`e2e:prod` NOT run; nothing committed.**
>
> **⛔ Three things a next session must not trip over:**
> 1. **`20260928000600` may NOT be pushed** until the remote is censused for duplicate
>    `file_object_id`. Local was 0 rows and proves nothing about push-safety.
...
> it settles FIVE items and must precede any remote reset) → **PRODROW census** → **C1a** →
