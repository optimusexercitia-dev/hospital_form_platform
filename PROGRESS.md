...
| E2E | Acceptance §4 (minus the Stage-E `legal_privileged` item) + one keyboard flow | tester | — | 🏗️ **ACTIVE** (spawned 2026-07-18) — PRIORITY: drive Part-2 §4 writes as real Playwright round-trips (FE blocked in preview) + confirm case-detail routes hydrate under Playwright (if stuck there too → real bug, file it) |
