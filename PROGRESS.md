...
| 2026-09-03 | ⛔ **A HAND-TYPED EXPECTED VALUE CANNOT TELL A DEFECT FROM A DESIGN** — 413 pinned a malformed `search_path` copied from the broken catalog, so fixing it would have REDDENED the suite. Repaired **structurally**: the reference is the SIBLING, not a literal | ADR [0182](docs/decisions/0182-statement-scoped-authorized-scope-ids.md) § Corrections |
