...
| BE-5 | M2 retention-pin trigger + `redact_professional_profile` (`link_state`-aware, B7) `HC0J7` | backend | **full** (novel trigger) ✅ approved | 🏗️ building (verify `guard_professional_linkage` first; GUC exception if it blocks redaction) |
