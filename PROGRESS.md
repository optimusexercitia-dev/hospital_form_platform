...
**▶ Active: CH-QA (qa-reviewer) — requirements audit + RLS conformance via `set local role` (catalog-truth, spot-check the mutation-proven keystones) → `docs/reviews/phase-CH-review.md`.**
