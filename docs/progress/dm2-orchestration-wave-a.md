...
> [dm1-substrate-cutover.md](dm1-substrate-cutover.md).
...
[referral-detail-redesign.md](referral-detail-redesign.md) (⚠ its type-vocabulary
sections are **history**: REG·KIND deleted `referral_note_types`); ETH·E4 before that is in
[eth-e4-participant-seating.md](eth-e4-participant-seating.md). What is left before
