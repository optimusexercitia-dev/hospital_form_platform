...
| CPF display | **masked digits**, server-computed — reverses ADR 0133 D12 "presence only" (ADR [0147](../decisions/0147-masked-cpf-on-the-person-detail-rail.md)) |
...
**2. AFF3 — ADR [0148](../decisions/0148-ever-held-affiliation-read-visibility.md).** Person
...
**3. AUD1 — ADR [0149](../decisions/0149-org-admin-reads-hospital-tier-audit.md).** An
...
**4. AUD2 — ADR [0150](../decisions/0150-audit-org-derived-from-hospital.md)**, from QA B1.
