...
**FUP-AUTHZ-HARNESS-TRANSACTIONAL** in [follow-ups-open.md](../followups/follow-ups-open.md).
...
> and 🟡 **FUP-PGTAP-WORKER-DEADLOCK** in [follow-ups-open.md](../followups/follow-ups-open.md).
...
>
> Full text + why each matters: **[follow-ups-open.md](../followups/follow-ups-open.md)**; prioritised order
