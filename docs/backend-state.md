...
> Last updated: **2026-08-06 — MIN (meeting audio → generated ata; ADR 0099 + Amendment 1;
> migrations `20260910000100`–`…000400`; flag `audio_minutes` **OFF**, seed forces ON local/E2E;
> **301 files = 301 registered** on a fresh reset). See the **MIN** section immediately below.
