...
> Last updated: **2026-08-06 — AFF (hospital affiliation, CPF person identity, org people
> directory; ADR 0097 + 0098; migrations `20260909000100`–`…001300`; NO flag, structural;
> **298 files = 298 registered** on a fresh reset). See the **AFF** section immediately below.
