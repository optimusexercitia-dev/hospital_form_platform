...
> Last updated: **2026-08-05 (BUG-AUTHZ-002 + MEM follow-ups; migration `20260908000100`; NO flag;
...
> `MemberListItem.isActive` + `activeMembers()` mirror `app.is_active` for assignee pickers)** · prior:
