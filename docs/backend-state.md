...
writer proving the probe has eyes.
...
## MEM-W4 — Diretor Técnico, roles + appointment ONLY (2026-08-04; ADR 0094 Amendment 3; migration `20260905000400`; flag `technical_director` **DARK**)

⚠ **PARTIAL. The referral-plane submission channel (ADR 0094 decisions 9-10) is NOT
built.** The flag ships DARK on purpose and its enable migration (T4.9) has not landed,
so the roles cannot be handed out yet — the grant arms refuse while it is off.
