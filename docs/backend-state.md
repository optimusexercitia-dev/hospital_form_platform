...
> Last updated: **2026-08-06 — QO·A (quality-office oversight; ADR 0100 D1–D11; migrations
...
expiry-taking door. Two deferred seam limits (re-grant does not extend expiry;
commission-tier atomic-replace ignores it) → **FUP-QO-1**, pinned in `306` §4 —
Phase C break-glass (D14) rides this seam.
