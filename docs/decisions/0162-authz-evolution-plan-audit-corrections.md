...
> ⬅ **A later ADR changes this one** — it is **amended by** [0172](0172-ae4-catalog-substrate-match-full-binding-and-deferred-classification-columns.md), [0184](0184-c2-sweep-runs-against-the-current-branch-schema.md).
