...
> ⬅ **A later ADR changes this one** — it is **superseded by** [0064](0064-case-subject-generalization-participants.md), and **amended by** [0137](0137-mrn-erasure-key-and-case-referral-usability-batch.md).
