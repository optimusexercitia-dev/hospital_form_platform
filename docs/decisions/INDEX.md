...
**195 ADRs** · next free number: **0200** · 70 carry an inbound supersedes/amends edge

## ⚠ Anomalies

- **Missing numbers:** 0034, 0077, 0197, 0198 — a gap is not automatically a defect (0077 was withdrawn by the PO and its subject re-filed as 0078; 0034 was never used), but a gap nobody can explain usually means a lost file.
...
| 0196 | [The backend surface map splits on the MODULE SEAM axis, and a router replaces the readi…](0196-backend-state-split-on-the-module-seam-axis.md) | accepted | 2026-09-09 | amends 0186 | ⚠ amended by 0199 |
