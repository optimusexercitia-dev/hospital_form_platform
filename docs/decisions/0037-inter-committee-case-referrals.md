...
> ⬅ **A later ADR changes this one** — it is **superseded by** [0078](0078-authorization-capability-model.md), and **amended by** [0137](0137-mrn-erasure-key-and-case-referral-usability-batch.md).
