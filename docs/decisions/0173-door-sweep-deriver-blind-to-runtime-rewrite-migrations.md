...
> ⬅ **A later ADR changes this one** — it is **amended by** [0190](0190-the-door-sweep-deriver-selects-by-property-and-a-full-run-merges.md), [0191](0191-the-door-arms-domain-gains-a-schema-axis-a-targeted-home-and-a-fourth-outcome.md).
