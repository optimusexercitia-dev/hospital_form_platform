# 0112 — Deliberation & Voting Model (DLB): typed committee decisions with vote arithmetic the database owns
...
(oversight reads stay container-level), ADR 0109 (document model redesign — D14 dependency), ADR
