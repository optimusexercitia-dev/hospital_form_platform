...
> ⬅ **A later ADR changes this one** — it is **amended by** [0193](0193-the-enforcement-manifest-declares-what-it-measured.md), [0201](0201-the-keying-asymmetry-is-the-model.md), [0203](0203-the-seam-is-already-encoded-the-classification-columns-are-not.md).
