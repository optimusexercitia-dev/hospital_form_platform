...
> ⬅ **A later ADR changes this one** — it is **amended by** [0134](0134-case-surface-split-and-administrativo-case-read.md), [0153](0153-subset-sweeps-write-to-scratch-not-the-committed-baseline.md).
