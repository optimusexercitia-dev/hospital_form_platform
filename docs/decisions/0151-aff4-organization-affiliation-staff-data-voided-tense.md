...
> ⬅ **A later ADR changes this one** — it is **amended by** [0152](0152-postgrest-p-class-sqlstate-maps-to-500.md), [0154](0154-roster-predicate-is-the-query-filter-not-list-org-people.md), [0155](0155-post-aff4-tenancy-and-person-model-evolution-sequence.md), [0159](0159-invariant-backstops-run-as-definer.md).
