...
> ⬅ **A later ADR changes this one** — it is **amended by** [0160](0160-ae0-corrections-to-adr-0155-measured-figures.md), [0162](0162-authz-evolution-plan-audit-corrections.md), [0175](0175-ae4-po-batch-oracle-inputs-and-arm3-deferral.md), [0176](0176-authz-permission-layer-made-real.md), [0205](0205-per-object-grant-plane-convention.md).
