...
> ⬅ **A later ADR changes this one** — it is **superseded by** [0079](0079-authz-door-blindness-standing-invariant.md), and **amended by** [0134](0134-case-surface-split-and-administrativo-case-read.md), [0167](0167-commission-staff-admin-has-one-authority-on-both-sides.md).
