...
> ⬅ **A later ADR changes this one** — it is **superseded by** [0072](0072-ethics-access-spine.md), [0078](0078-authorization-capability-model.md), and **amended by** [0038](0038-case-patient-identifiers.md), [0134](0134-case-surface-split-and-administrativo-case-read.md).
