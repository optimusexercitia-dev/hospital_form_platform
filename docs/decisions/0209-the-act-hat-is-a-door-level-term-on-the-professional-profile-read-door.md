...
**Status:** Accepted (2026-09-11, at unit `ARM3-HAT-TERM-FIX`; D5 **ratified by the PO 2026-09-11** at the unit's approval — *"Approved. Proceed"* — together with the pre-merge comment-only edit disclosed in migration `20261003007400`'s header; the in-text "PO to ratify" marks below are dated history of the ask)
