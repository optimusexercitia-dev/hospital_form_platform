...
> ⬅ **A later ADR changes this one** — it is **amended by** [0133](0133-aff2-affiliation-scoped-administration-um-redesign.md), [0148](0148-ever-held-affiliation-read-visibility.md), [0151](0151-aff4-organization-affiliation-staff-data-voided-tense.md), [0157](0157-dominance-grid-population-bounded-by-schema.md).
