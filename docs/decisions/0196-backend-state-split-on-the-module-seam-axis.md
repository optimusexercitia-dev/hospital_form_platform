...
> ⬅ **A later ADR changes this one** — it is **amended by** [0197](0197-data-access-registries-are-generated-not-maintained.md), [0198](0198-backend-state-seams-get-a-replaceable-current-state-layer.md).
