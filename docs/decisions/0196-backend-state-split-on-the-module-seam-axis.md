...
> ⬅ **A later ADR changes this one** — it is **amended by** [0197](0197-data-access-registries-are-generated-not-maintained.md), [0198](0198-backend-state-seams-get-a-replaceable-current-state-layer.md), [0199](0199-a-frozen-archive-does-not-belong-on-the-retrieval-path.md), [0206](0206-the-service-role-dml-registry-gets-its-own-seam.md).
