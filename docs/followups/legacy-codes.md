...
| RULES | `.claude/rules/` governance — the standing-rules directory, its admission filter and its three volume bounds (added 2026-09-12; not a feature or phase — the namespace rule-file items were already being filed under) | [0127-standing-rules-home-and-staleness-gate.md](../decisions/0127-standing-rules-home-and-staleness-gate.md); `scripts/check-rules-staleness.mjs`, gate 8 |
