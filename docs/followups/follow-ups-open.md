...
### 🟢 FUP-VITEST-ROLE-SET-PIN-TEST-SUPPORT-MODULE-IS-APP-IMPORTABLE — a `docker exec` reader is now an exported function under `src/`, kept out of app code by prose only
