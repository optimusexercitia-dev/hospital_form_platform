...
**Status:** open — ⚠ the work-list is **pending the full run's merge**; until it is filed this entry states the MECHANISM and the BOUND (0 ≤ n ≤ 51), and must not be read as "no policy flipped". ⛔ A flipped row is never relabelled to keep it COVERED
