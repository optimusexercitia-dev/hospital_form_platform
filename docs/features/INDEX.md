...
**23 hubs** · in progress 1 · gated 3 · planned 2 · parked 0 · complete 17

| ID | Title | Status | Kind | Program | Branch | Hub |
|---|---|---|---|---|---|---|
| AE5-MATRIX-ARM3-CELLS | Arm-3 divergent cells enumerated — discharging ADR 0175 D3's forward promise, which is WORK and not a decision: 216 candidate rows carry zero divergence labels | 🟢 in progress | feature | AUTHZ | `authz-ae5-matrix-arm3-cells` | [ae5-matrix-arm3-cells.md](ae5-matrix-arm3-cells.md) |
